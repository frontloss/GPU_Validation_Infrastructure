...
dsi_input_select_PIPE_A = 0b000 
dsi_input_select_PIPE_B = 0b101 
dsi_input_select_PIPE_C = 0b110 
dsi_input_select_PIPE_D = 0b111 
dsi_input_select_RESERVED = 0b0 
...
high_tmds_char_rate_DISABLE = 0 
high_tmds_char_rate_ENABLE = 1 
mst_transport_select_DPTP_A = 0b00 
mst_transport_select_DPTP_B = 0b01 
mst_transport_select_DPTP_C = 0b10 
mst_transport_select_DPTP_D = 0b11 
...
trans_ddi_mode_select_128b_132b_mode = 0b100
...
class TRANS_DDI_FUNC_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("port_width_selection"          , ctypes.c_uint32, 3), # 3 to 1 
        ...
        ("mst_transport_select"          , ctypes.c_uint32, 2), # 11 to 10 
        ("dsi_input_select"              , ctypes.c_uint32, 3), # 14 to 12 
		("reserved_15"                 , ctypes.c_uint32, 1), # 15 to 15 
        ("sync_polarity"                 , ctypes.c_uint32, 2), # 17 to 16 
		("reserved_18"                 , ctypes.c_uint32, 2), # 18 to 19 
        ("bits_per_color"                , ctypes.c_uint32, 3), # 22 to 20 
		("reserved_23"                 , ctypes.c_uint32, 1), # 23 to 23 
        ("trans_ddi_mode_select"         , ctypes.c_uint32, 3), # 26 to 24 
        ("ddi_select"                    , ctypes.c_uint32, 4), # 30 to 27 
