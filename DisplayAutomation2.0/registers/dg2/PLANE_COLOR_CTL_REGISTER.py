...
color_correction_dithering_enable_DISABLED = 0b0 
color_correction_dithering_enable_ENABLED = 0b1 
pipe_csc_enable_DISABLE = 0b0 
pipe_csc_enable_ENABLE = 0b1 
pipe_gamma_enable_DISABLE = 0b0 
pipe_gamma_enable_ENABLE = 0b1 
plane_csc_enable_DISABLE = 0b0 
plane_csc_enable_ENABLE = 0b1 
plane_csc_mode_BYPASS = 0b000 
plane_csc_mode_RGB709_TO_RGB2020 = 0b100 
plane_csc_mode_YUV2020_TO_RGB2020 = 0b011 
plane_csc_mode_YUV601_TO_RGB601 = 0b001 
plane_csc_mode_YUV709_TO_RGB709 = 0b010 
plane_gamma_disable_DISABLE = 0b1 
plane_gamma_disable_ENABLE = 0b0 
plane_gamma_mode_DIRECT = 0b0 
plane_gamma_mode_MULTIPLY = 0b1 
plane_gamma_multiplier_precision_U0_24 = 0b0 
plane_gamma_multiplier_precision_U8_16 = 0b1 
plane_input_csc_enable_DISABLE = 0b0 
plane_input_csc_enable_ENABLE = 0b1 
plane_post_csc_gamma_multi_segment_enable_DISABLE = 0b0 
plane_post_csc_gamma_multi_segment_enable_ENABLE = 0b1 
plane_pre_csc_gamma_enable_DISABLE = 0b0 
plane_pre_csc_gamma_enable_ENABLE = 0b1 
remove_yuv_offset_PRESERVE = 0b0 
remove_yuv_offset_REMOVE = 0b0 
smooth_sync_dither_step_size_STEP_SIZE_OF_1 = 0b000 
smooth_sync_dither_step_size_STEP_SIZE_OF_16 = 0b100 
smooth_sync_dither_step_size_STEP_SIZE_OF_2 = 0b001 
smooth_sync_dither_step_size_STEP_SIZE_OF_4 = 0b010 
smooth_sync_dither_step_size_STEP_SIZE_OF_8 = 0b011 
yuv_range_correction_disable_DISABLE = 0b1 
yuv_range_correction_disable_ENABLE = 0b0 
yuv_range_correction_output_WITHOUT_OFFSET = 0b1 
yuv_range_correction_output_WITH_OFFSET = 0b0 
...
class PLANE_COLOR_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ("smooth_sync_dither_step_size"             , ctypes.c_uint32, 3), # 0 to 2 
        ("reserved"                                 , ctypes.c_uint32, 1), # 3 to 3 
        ("alpha_mode"                               , ctypes.c_uint32, 2), # 5 to 4 
        ("reserved"                                 , ctypes.c_uint32, 4), # 6 to 9 
        ("color_correction_dithering_enable"        , ctypes.c_uint32, 1), # 10 to 10 
        ("plane_gamma_multiplier_precision"         , ctypes.c_uint32, 1), # 11 to 11 
        ...
        ("plane_post_csc_gamma_multi_segment_enable" , ctypes.c_uint32, 1), # 15 to 15
		("reserved_16",                     ctypes.c_uint32,1), # 16 to 16 
        ("plane_csc_mode"                           , ctypes.c_uint32, 3), # 19 to 17 
