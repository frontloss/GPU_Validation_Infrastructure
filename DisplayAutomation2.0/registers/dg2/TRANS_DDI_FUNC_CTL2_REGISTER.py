...
class TRANS_DDI_FUNC_CTL2_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("cmtg_slave_mode", ctypes.c_uint32, 1),  # 3 to 3
        ("port_sync_mode_enable", ctypes.c_uint32, 1),  # 4 to 4
        ("dual_pipe_sync_enable", ctypes.c_uint32, 1),  # 5 to 5
        ("audio_mute_override", ctypes.c_uint32, 2),  # 6 to 7
        ("double_buffer_vactive", ctypes.c_uint32, 1),  # 8 to 8
        ("reserved_9", ctypes.c_uint32, 20),  # 9 to 28
        ("genlock_mode", ctypes.c_uint32, 2),  # 29 to 30
        ("genlock_enable", ctypes.c_uint32, 1),  # 31 to 31
    ]
