...
clear_color_disable_DISABLE = 0b1 
clear_color_disable_ENABLE = 0b0 
...
smooth_sync_plane_enable_SMOOTH_SYNC_DISABLED = 0b0 
smooth_sync_plane_enable_SMOOTH_SYNC_ENABLED = 0b1 
source_pixel_format_INDEXED_8_BIT = 0b11000 
source_pixel_format_RGB_16161616_FLOAT = 0b01100 
source_pixel_format_RGB_16161616_UINT = 0b10010 
...
tiled_surface_TILE_4_MEMORY = 0b101 
...
class PLANE_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ("plane_rotation",                      ctypes.c_uint32,2), # 1 to 0
        ...
        ("yuv_422_byte_order",                  ctypes.c_uint32,2), # 17 to 16
        ("smooth_sync_plane_enable",            ctypes.c_uint32,1), # 18 to 18
        ("planar_yuv420_component",             ctypes.c_uint32,1), # 19 to 19
        ("rgb_color_order",                     ctypes.c_uint32,1), # 20 to 20
        ("key_enable",                          ctypes.c_uint32,2), # 22 to 21
        ("source_pixel_format",                 ctypes.c_uint32,5), # 27 to 23
        ("pipe_slice_arbitration_slots",        ctypes.c_uint32,3), # 30 to 28
