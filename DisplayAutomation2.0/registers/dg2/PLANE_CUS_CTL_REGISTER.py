...
y_binding_PLANE_4 = 0b0
y_binding_PLANE_5 = 0b1
...
class PLANE_CUS_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("error injection flip bits",  ctypes.c_uint32, 2), #20 to 21
        ("reserved_22"              ,  ctypes.c_uint32, 1), # 22 to 22
        ("ecc error injection enable", ctypes.c_uint32, 1), #23 to 23
        ("reserved_24"            , ctypes.c_uint32, 6), # 24 to 29
