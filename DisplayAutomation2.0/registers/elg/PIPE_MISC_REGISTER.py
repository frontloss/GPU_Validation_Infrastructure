...
class PIPE_MISC_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("dithering_type"                  , ctypes.c_uint32, 2), # 3 to 2 
        ("dithering_enable"                , ctypes.c_uint32, 1), # 4 to 4 
        ("dithering_bpc"                   , ctypes.c_uint32, 3), # 7 to 5 
        ...
        ("rotation_info"                   , ctypes.c_uint32, 2), # 15 to 14 
        ...
        ("stereo_mask_pipe_render"         , ctypes.c_uint32, 2), # 29 to 28 
        ("stereo_mask_pipe_int"            , ctypes.c_uint32, 2), # 31 to 30 
    ]
