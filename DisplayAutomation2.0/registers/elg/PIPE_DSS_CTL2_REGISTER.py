...
class PIPE_DSS_CTL2_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("odd_pixel_removal_configuration", ctypes.c_uint32, 1), # 17 to 17
        ("odd_pixel_removal"              , ctypes.c_uint32, 1), # 18 to 18
        ("reserved_19"                    , ctypes.c_uint32, 4), # 19 to 22
        ("small_joiner_configuration"     , ctypes.c_uint32, 1), # 23 to 23
        ("spare_24"                       , ctypes.c_uint32, 1), # 24 to 24
        ("spare_25"                       , ctypes.c_uint32, 1), # 25 to 25
        ("spare_26"                       , ctypes.c_uint32, 1), # 26 to 26
        ("reserved_27"                    , ctypes.c_uint32, 3), # 27 to 29
        ("vdsc2_enable"                   , ctypes.c_uint32, 1), # 30 to 30
