...
flip_queue_done_interrupt_DO_NOT_INTERRUPT = 0b0 
flip_queue_done_interrupt_INTERRUPT_WHEN_FLIP_QUEUE_REACHES_THIS_ENTRY = 0b1 
flip_queue_empty_interrupt_DO_NOT_INTERRUPT = 0b0 
flip_queue_empty_interrupt_INTERRUPT_WHEN_FLIP_QUEUE_GOES_EMPTY_ON_THIS_ENTRY = 0b1 
flip_queue_iteration_ITERATE_1_FRAME = 0b00 
flip_queue_iteration_ITERATE_2_FRAMES = 0b01 
flip_queue_iteration_ITERATE_3_FRAMES = 0b10 
flip_queue_iteration_ITERATE_4_FRAMES = 0b11 
key_select_ID_1 = 0b001 
key_select_PAVP = 0b000 
key_select_RESERVED = 0b0 
queue_flip_DO_NOT_QUEUE = 0b0 
queue_flip_QUEUE = 0b1 
