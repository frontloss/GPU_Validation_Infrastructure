...
'''
DSI_DATA_TIMING_PARAM_DSI0 = 0x6B084 
DSI_DATA_TIMING_PARAM_DSI1 = 0x6B884 
...
'''
class DSI_DATA_TIMING_PARAM_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
...
class DSI_DATA_TIMING_PARAM_REGISTER( ctypes.Union ):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u",      DSI_DATA_TIMING_PARAM_REG ),
