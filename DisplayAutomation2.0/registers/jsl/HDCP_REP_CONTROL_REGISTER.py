...
'''
ddia_repeater_present_NOT_REPEATER = 0b0
ddia_repeater_present_REPEATER = 0b1
ddib_repeater_present_NOT_REPEATER = 0b0
ddib_repeater_present_REPEATER = 0b1
ddic_repeater_present_NOT_REPEATER = 0b0
ddic_repeater_present_REPEATER = 0b1
ddid_repeater_present_NOT_REPEATER = 0b0
ddid_repeater_present_REPEATER = 0b1
ddie_repeater_present_NOT_REPEATER = 0b0
ddie_repeater_present_REPEATER = 0b1
ddif_repeater_present_NOT_REPEATER = 0b0
ddif_repeater_present_REPEATER = 0b1
...
sha1_m0_select_DDI_A = 0b010
sha1_m0_select_DDI_B = 0b001
sha1_m0_select_DDI_C = 0b011
sha1_m0_select_DDI_D = 0b100
sha1_m0_select_DDI_E = 0b110
sha1_m0_select_DDI_F = 0b101
...
class HDCP_REP_CONTROL_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("ddie_repeater_present"        , ctypes.c_uint32, 1),  # 25 to 25
        ("ddif_repeater_present"        , ctypes.c_uint32, 1),  # 26 to 26
        ("ddid_repeater_present"        , ctypes.c_uint32, 1),  # 27 to 27
        ("ddic_repeater_present"        , ctypes.c_uint32, 1),  # 28 to 28
        ("ddia_repeater_present"        , ctypes.c_uint32, 1),  # 29 to 29
        ("ddib_repeater_present"        , ctypes.c_uint32, 1),  # 30 to 30
