...
class MBUS_CTL_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("translation_throttle_max", ctypes.c_uint32, 4),  # 8 to 11
        ("allow_b2b_aput", ctypes.c_uint32, 1),  # 12 to 12
        ("translation_throttle_min", ctypes.c_uint32, 3),  # 13 to 15
        ("translation_type_throttle_select", ctypes.c_uint32, 1),  # 16 to 16
        ("translation_type_throttle_value", ctypes.c_uint32, 3),  # 17 to 19
        ("Reserved", ctypes.c_uint32, 6), # 20 to 25
