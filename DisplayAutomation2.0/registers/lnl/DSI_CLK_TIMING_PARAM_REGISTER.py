...
'''
DSI_CLK_TIMING_PARAM_DSI0 = 0x6B080 
DSI_CLK_TIMING_PARAM_DSI1 = 0x6B880 
...
'''
class DSI_CLK_TIMING_PARAM_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
...
class DSI_CLK_TIMING_PARAM_REGISTER( ctypes.Union ):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u",      DSI_CLK_TIMING_PARAM_REG ),
