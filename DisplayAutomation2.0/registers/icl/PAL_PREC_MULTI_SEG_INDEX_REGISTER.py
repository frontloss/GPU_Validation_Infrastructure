...
PAL_PREC_MULTI_SEG_INDEX_C = 0x4BC08
...
'''
class PAL_PREC_MULTI_SEG_INDEX_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
...
class PAL_PREC_MULTI_SEG_INDEX_REGISTER( ctypes.Union ):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u",      PAL_PREC_MULTI_SEG_INDEX_REG ),
