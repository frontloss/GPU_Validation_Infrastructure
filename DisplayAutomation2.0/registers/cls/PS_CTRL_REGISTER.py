...
programmable_scale_factor_use_hw_scale_h_v = 0b0
programmable_scale_factor_use_sw_scale_v = 0b1
programmable_scale_factor_use_sw_scale_h = 0b10
programmable_scale_factor_use_sw_scale_h_v = 0b11
...
class PS_CTRL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("programmable_scale_factor"               , ctypes.c_uint32, 2), # 18 to 19
