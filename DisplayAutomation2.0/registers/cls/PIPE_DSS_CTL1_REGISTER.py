...
ultra_joiner_enable_ENABLE = 0b1
ultra_joiner_enable_DISABLE = 0b0
primary_ultra_joiner_enable_secondary = 0b0
primary_ultra_joiner_enable_primary = 0b1
...
class PIPE_DSS_CTL1_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("primary_ultra_joiner_enable",  ctypes.c_uint32, 1), # 22 to 22
        ("ultra_joiner_enable"        ,  ctypes.c_uint32, 1), # 23 to 23
