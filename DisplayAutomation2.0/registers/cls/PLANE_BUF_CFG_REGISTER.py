...
class PLANE_BUF_CFG_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ("buffer_start",    ctypes.c_uint32, 13),  # 0 to 12
        ("reserved_12",     ctypes.c_uint32, 3),   # 13 to 15
        ("buffer_end",      ctypes.c_uint32, 13),  # 16 to 28
        ("reserved_28",     ctypes.c_uint32, 3),   # 29 to 31
    ]
