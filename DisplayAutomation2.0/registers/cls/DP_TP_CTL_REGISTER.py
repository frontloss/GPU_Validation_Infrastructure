...
class DP_TP_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("dp_link_training_enable"  , ctypes.c_uint32, 3), # 10 to 8 
        ...
        ("training_pattern_4_select" , ctypes.c_uint32, 2), # 20 to 19 
