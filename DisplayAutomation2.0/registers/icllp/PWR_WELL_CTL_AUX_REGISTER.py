...
class PWR_WELL_CTL_AUX_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("reserved_1",             ctypes.c_uint32, 4),         # 12 to 15
        ("aux_tbt_1_io_power_state", ctypes.c_uint32, 1),       # 16 to 16
        ("aux_tbt_1_io_power_request", ctypes.c_uint32, 1),     # 17 to 17
        ("aux_tbt_2_io_power_state", ctypes.c_uint32, 1),       # 18 to 18
        ("aux_tbt_2_io_power_request", ctypes.c_uint32, 1),     # 19 to 19
        ("aux_tbt_3_io_power_state", ctypes.c_uint32, 1),       # 20 to 20
        ("aux_tbt_3_io_power_request", ctypes.c_uint32, 1),     # 21 to 21
        ("aux_tbt_4_io_power_state", ctypes.c_uint32, 1),       # 22 to 22
        ("aux_tbt_4_io_power_request", ctypes.c_uint32, 1),     # 23 to 23
        ("reserved_2", ctypes.c_uint32, 8),                     # 24 to 31
    ]
