...
DKLP_CMN_ANA_CMN_ANA_DWORD6_TC1 = 0x1680D8
DKLP_CMN_ANA_CMN_ANA_DWORD6_TC2 = 0x1690D8
DKLP_CMN_ANA_CMN_ANA_DWORD6_TC3 = 0x16A0D8
DKLP_CMN_ANA_CMN_ANA_DWORD6_TC4 = 0x16B0D8
...
class DKLP_CMN_ANA_CMN_ANA_DWORD6_REG(ctypes.LittleEndianStructure):
    _fields_ = [
...
class DKLP_CMN_ANA_CMN_ANA_DWORD6_REGISTER(ctypes.Union):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u", DKLP_CMN_ANA_CMN_ANA_DWORD6_REG),
