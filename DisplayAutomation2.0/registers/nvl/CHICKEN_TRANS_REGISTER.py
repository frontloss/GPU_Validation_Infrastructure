...
class CHICKEN_TRANS_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('send_sf', ctypes.c_uint32, 1),
        ('spare5', ctypes.c_uint32, 1),
        ('lobf_alpm_entry_check_enable', ctypes.c_uint32, 1),
        ...
        ('msa_pos', ctypes.c_uint32, 1),
        ('align_mtps', ctypes.c_uint32, 1),
        ('spare15', ctypes.c_uint32, 1),
        ('spare16', ctypes.c_uint32, 1),
        ('spare17', ctypes.c_uint32, 1),
        ('x_coordinate_base', ctypes.c_uint32, 1),
