...
class PWR_WELL_CTL_DDI_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("ddi_usb_c_3_io_power_state",    ctypes.c_uint32, 1),  # 10
        ("ddi_usb_c_3_io_power_request",  ctypes.c_uint32, 1),  # 11
        ("ddi_usb_c_4_io_power_state",    ctypes.c_uint32, 1),  # 12
        ("ddi_usb_c_4_io_power_request",  ctypes.c_uint32, 1),  # 13
        ("ddi_d_io_power_state", ctypes.c_uint32, 1),           # 14
        ("ddi_d_io_power_request", ctypes.c_uint32, 1),         # 15
        ("ddi_e_io_power_state", ctypes.c_uint32, 1),           # 16
        ("ddi_e_io_power_request", ctypes.c_uint32, 1),         # 17
