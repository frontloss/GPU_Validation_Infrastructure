...
'''
TRANS_CRC_CTL_A = 0x60080
TRANS_CRC_CTL_B = 0x61080
TRANS_CRC_CTL_C = 0x62080
TRANS_CRC_CTL_D = 0x63080
'''
...
class TRANS_CRC_CTL_REG(ctypes.LittleEndianStructure):
    _fields_ = [
...
class TRANS_CRC_CTL_REGISTER(ctypes.Union):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u", TRANS_CRC_CTL_REG),
