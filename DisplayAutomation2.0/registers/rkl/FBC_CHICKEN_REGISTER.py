...
class FBC_CHICKEN_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('decomp_bubble_fix_disable', ctypes.c_uint32, 1),  # BIT 2
        ('underrun2_ppc_fix_disable', ctypes.c_uint32, 1),  # BIT 3
        ('rc_nuke_for_psr_fix_disable', ctypes.c_uint32, 1),  # BIT 4
        ('modify_hang_fix_disable', ctypes.c_uint32, 1),  # BIT 5
        ('dst_comptag_offset', ctypes.c_uint32, 2),  # BIT 6 to BIT 7
        ('dis_dummy_0', ctypes.c_uint32, 1),  # BIT 8
        ('force_off', ctypes.c_uint32, 1),  # BIT 9
        ...
        ('disable_dummy_read_last_seg_fix', ctypes.c_uint32, 1),  # BIT 20
        ('dis_vtd_fault_nuke', ctypes.c_uint32, 1),  # BIT 21
        ('height_4096_fix_disable', ctypes.c_uint32, 1),  # BIT 22
        ('nuke_on_any_modification', ctypes.c_uint32, 1),  # BIT 23
        ...
        ('dis_rc_nuke', ctypes.c_uint32, 1),  # BIT 27
