...
PLANE_WM_6_A = 0x70740
PLANE_WM_6_B = 0x71740
PLANE_WM_6_C = 0x72740
PLANE_WM_6_D = 0x73740
PLANE_WM_7_A = 0x70840
PLANE_WM_7_B = 0x71840
PLANE_WM_7_C = 0x72840
PLANE_WM_7_D = 0x73840
...
PLANE_TRANS_WM_6_A = 0x70768
PLANE_TRANS_WM_6_B = 0x71768
PLANE_TRANS_WM_6_C = 0x72768
PLANE_TRANS_WM_6_D = 0x73768
PLANE_TRANS_WM_7_A = 0x70868
PLANE_TRANS_WM_7_B = 0x71868
PLANE_TRANS_WM_7_C = 0x72868
PLANE_TRANS_WM_7_D = 0x73868
...
class PLANE_WM_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ("blocks"      , ctypes.c_uint32, 11), # 0 to 10 
        ("reserved_11" , ctypes.c_uint32, 3), # 11 to 13 
        ("lines"       , ctypes.c_uint32, 5), # 14 to 18 
        ("reserved_19" , ctypes.c_uint32, 11), # 19 to 29 
