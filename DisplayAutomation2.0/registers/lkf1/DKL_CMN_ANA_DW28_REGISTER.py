...
DKL_CMN_ANA_DW28_NULL_D = 0x168130
DKL_CMN_ANA_DW28_NULL_E = 0x169130
...
class DKL_CMN_ANA_DW28_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("clktop2_id_vga_chpmp_ck_divratio", ctypes.c_uint32, 4),  # 24 to 27
        ("clktop2_id_vga_chpmp_div_en_h", ctypes.c_uint32, 1),  # 28 to 28
        ("reserved_29", ctypes.c_uint32, 3)  # 29 to 31
    ]


class DKL_CMN_ANA_DW28_REGISTER(ctypes.Union):
    _anonymous_ = ("u",)
    _fields_ = [
        ("u", DKL_CMN_ANA_DW28_REG),
