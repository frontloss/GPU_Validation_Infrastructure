...
class PS_CTRL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ("reserved_0"               , ctypes.c_uint32, 5), # 0 to 4 
        ("vadapt_mode"              , ctypes.c_uint32, 2), # 5 to 6 
        ("vadapt_en"                , ctypes.c_uint32, 1), # 7 to 7 
        ("v_filter_bypass"          , ctypes.c_uint32, 1), # 8 to 8 
        ("reserved_9"               , ctypes.c_uint32, 8), # 9 to 16 
        ...
        ("scaler_mode"              , ctypes.c_uint32, 2), # 28 to 29 
