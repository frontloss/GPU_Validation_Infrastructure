...
'''
pll_enable_DISABLE = b0 
pll_enable_ENABLE = b1 
pll_lock_LOCKED = b1 
pll_lock_NOT_LOCKED_OR_NOT_ENABLED = b0 
power_enable_DISABLE = b0 
power_enable_ENABLE = b1 
power_state_DISABLED = b0 
power_state_ENABLED = b1 
