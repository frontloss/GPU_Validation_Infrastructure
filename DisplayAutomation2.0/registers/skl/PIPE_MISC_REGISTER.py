...
class PIPE_MISC_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("reserved_13",                         ctypes.c_uint32,2), # 12 to 13
        ...
        ("reserved_24_25",                      ctypes.c_uint32,6), # 22 to 27
