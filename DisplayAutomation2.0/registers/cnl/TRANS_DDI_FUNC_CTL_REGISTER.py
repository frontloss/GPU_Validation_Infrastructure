...
ddi_select_DDI_B = 0b001 
ddi_select_DDI_C = 0b010 
ddi_select_DDI_D = 0b011 
ddi_select_DDI_E = 0b100 
ddi_select_DDI_F = 0b101 
ddi_select_NONE = 0b000 
ddi_select_RESERVED = 0b0 
dp_port_width_selection_RESERVED = 0b0 
...
trans_ddi_mode_select_FDI = 0b100 
...
class TRANS_DDI_FUNC_CTL_REG( ctypes.LittleEndianStructure ):
    _fields_ = [
        ...
        ("port_sync_mode_enable"         , ctypes.c_uint32, 1), # 15 to 15 
        ("sync_polarity"                 , ctypes.c_uint32, 2), # 16 to 17 
        ("port_sync_mode_master_select"  , ctypes.c_uint32, 2), # 18 to 19 
        ...
        ("ddi_select"                    , ctypes.c_uint32, 3), # 28 to 30 
