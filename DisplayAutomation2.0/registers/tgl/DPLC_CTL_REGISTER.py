...
class DPLC_CTL_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ("reserved_14"                       , ctypes.c_uint32, 5), # 14 to 18
        ("hist_disable_mode"                 , ctypes.c_uint32, 1), # 19 to 19
        ("arbitration_option"                , ctypes.c_uint32, 1), # 20 to 20
        ("mask_dmc_trigger"                  , ctypes.c_uint32, 1), # 21 to 21
        ("histogram_ram_readback_return"     , ctypes.c_uint32, 1), # 22 to 22 
        ("fast_access_mode_enable"           , ctypes.c_uint32, 1), # 23 to 23 
