######################################################################################
# @file         gen15_dbuf_table.py
# @addtogroup   PyLibs_DisplayWatermark
# @brief        Gen15 DBuf distribution table
...
##
# DBuf distribution across different slices for Gen15
# LNL BSpec: https://gfxspecs.intel.com/Predator/Home/Index/68907

# Gen15 DBuf distribution dictionary
...
##
# LNL DBuf distribution dictionary
gen15_lnl_dbuf_distribution = {
