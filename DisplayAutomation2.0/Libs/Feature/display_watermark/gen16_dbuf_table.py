######################################################################################
# @file         gen16_dbuf_table.py
# @addtogroup   PyLibs_DisplayWatermark
# @brief        Gen16 DBuf distribution table
...
##
# DBuf distribution across different slices for Gen16
# PTL BSpec: https://gfxspecs.intel.com/Predator/Home/Index/68907

# Gen16 DBuf distribution dictionary
...
##
# PTL DBuf distribution dictionary
gen16_ptl_dbuf_distribution = {
