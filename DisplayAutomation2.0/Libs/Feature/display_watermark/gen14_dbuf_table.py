######################################################################################
# @file         gen14_dbuf_table.py
# @addtogroup   PyLibs_DisplayWatermark
# @brief        Gen14 DBuf distribution table
...
##
# DBuf distribution across different slices for Gen14
# MTL BSpec: https://gfxspecs.intel.com/Predator/Home/Index/49255?dstFilter=MTL&mode=Filter

# Gen14 DBuf distribution dictionary
...
##
# MTL DBuf distribution dictionary
gen14_mtl_dbuf_distribution = {
