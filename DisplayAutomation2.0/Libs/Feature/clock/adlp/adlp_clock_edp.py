##
# @file adlp_clock_edp.py
# @brief This tests EDP PLLS are programmed correctly for platform ADLP.
...
##
# @brief ADLP edp port clock verification class
class AdlpClockEdp():
    ...
    # Mapping dictionary of the listed Reference Frequencies
    ...
    def verify_clock(self, display_port, gfx_index='gfx_0'):
        ...
        if ret is True:
            if self.verify_edp_pll(pll_values, display_port, gfx_index) is True:
                ...
                gdhm.report_bug(
                    title="[Interfaces][Display_Engine]ADLP_Clock_EDP: PLL Register values {0} not programmed as "
            ...
            gdhm.report_bug(
                title="[Interfaces][Display_Engine]ADLP_Clock_EDP:Failed getting reference pll values"
    ...
    def verify_edp_pll(self, pll_values, display_port, gfx_index='gfx_0'):
        ...
        if reg_read_CFGCR1.CENTRAL_FREQ != 8400:
            ...
            ret &= clock_helper.verify_port_clock_programming_ex(feature='{}'.format(ClockRegister.DPLL_CFGCR1),
                                                                 ...
                                                                 expected=['8400'],
                                                                 actual=[str(reg_read_CFGCR1.CENTRAL_FREQ)])
