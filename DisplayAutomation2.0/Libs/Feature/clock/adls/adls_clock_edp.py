##
# @file   adls_clock_edp.py
# @brief  This tests EDP PLLS are programmed correctly for platform ADLS. Can be used in EDP tests.
...
##
# @brief ADLS edp clock verification class
class AdlsClockEdp():
    ...
    def verify_clock(self, display_port, gfx_index='gfx_0'):
        ...
        reg_value_DPCLKA_CFGCR0 = clock_helper.clock_register_read('DPCLKA_CFGCR0_REGISTER', 'DPCLKA_CFGCR0', gfx_index)
        reg_value_DPCLKA_CFGCR1 = clock_helper.clock_register_read('DPCLKA_CFGCR1_REGISTER', 'DPCLKA_CFGCR1', gfx_index)
        if str(display_port).upper().__contains__('_A'):
            dpllValue = clock_helper.get_value_by_range(reg_value_DPCLKA_CFGCR0, 0, 1, self.ddi_pll_map, 'DPLL')
        elif str(display_port).upper().__contains__('_B'):
            dpllValue = clock_helper.get_value_by_range(reg_value_DPCLKA_CFGCR0, 2, 3, self.ddi_pll_map, 'DPLL')
        elif str(display_port).upper().__contains__('_C'):
            dpllValue = clock_helper.get_value_by_range(reg_value_DPCLKA_CFGCR0, 4, 5, self.ddi_pll_map, 'DPLL')
        elif str(display_port).upper().__contains__('_D'):
            dpllValue = clock_helper.get_value_by_range(reg_value_DPCLKA_CFGCR1, 0, 1, self.ddi_pll_map, 'DPLL')
        else:
            dpllValue = clock_helper.get_value_by_range(reg_value_DPCLKA_CFGCR1, 2, 3, self.ddi_pll_map, 'DPLL')

        logging.info("PLL value is : {0}".format(dpllValue))
        ...
        if (ret is True):
            if (True == self.verify_edp_pll(pll_values, display_port, gfx_index)):
                ...
                gdhm.report_bug(
                    title="[Interfaces][Display_Engine]ADLS_Clock_EDP: PLL Register values {0} not programmed as "
            ...
            gdhm.report_bug(
                title="[Interfaces][Display_Engine]ADLS_Clock_EDP:Failed getting reference pll values"
    ...
    def verify_edp_pll(self, pll_values, display_port, gfx_index='gfx_0'):
        ...
        ret &= clock_helper.verify_port_clock_programming_ex(feature='{}'.format(ClockRegister.DPLL_SSC),
                                                             ...
                                                             expected=[ssc_enable],
                                                             actual=[reg_read_CFGCR0.SSC_ENABLE])
    ...
    def get_edp_pll_ref_values(self, link_bw, ref_clk):
        ...
        if ref_clk == 24:
            if link_bw == 5.4:
                pll_values = {"dco_integer": 0x151, "dco_fraction": 0x4000, "pdiv": 0b0010,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 2.7:
                pll_values = {"dco_integer": 0x151, "dco_fraction": 0x4000, "pdiv": 0b0010,
                              "kdiv": 0b010, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 1.62:
                pll_values = {"dco_integer": 0x151, "dco_fraction": 0x4000, "pdiv": 0b0100,
                              "kdiv": 0b010, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 3.24:
                pll_values = {"dco_integer": 0x151, "dco_fraction": 0x4000, "pdiv": 0b0100,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
                ...
                pll_values = {"dco_integer": 0x168, "dco_fraction": 0x0000, "pdiv": 0b0001,
                              "kdiv": 0b010, "qdiv_mode": 0b1, "qdiv_ratio": 0x02}
            elif link_bw == 4.32:
                pll_values = {"dco_integer": 0x168, "dco_fraction": 0x0000, "pdiv": 0b0001,
                              "kdiv": 0b010, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 6.48:
                pll_values = {"dco_integer": 0x195, "dco_fraction": 0x0000, "pdiv": 0b0010,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 8.1:
                pll_values = {"dco_integer": 0x151, "dco_fraction": 0x4000, "pdiv": 0b0001,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            else:
                ret = False
        elif ref_clk == 19.2:
            if link_bw == 5.4:
                ...
                ret = False
        else:  # 38.4Mhz case , there is a WA to divide DCO fraction by 2 from what is there in bspec
            if link_bw == 5.4:
                pll_values = {"dco_integer": 0x1A5, "dco_fraction": 0x3800, "pdiv": 0b0010,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 2.7:
                pll_values = {"dco_integer": 0x1A5, "dco_fraction": 0x3800, "pdiv": 0b0010,
                              "kdiv": 0b010, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 1.62:
                pll_values = {"dco_integer": 0x1A5, "dco_fraction": 0x3800, "pdiv": 0b0100,
                              "kdiv": 0b010, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 3.24:
                pll_values = {"dco_integer": 0x1A5, "dco_fraction": 0x3800, "pdiv": 0b0100,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
                ...
                pll_values = {"dco_integer": 0x1FA, "dco_fraction": 0x1000, "pdiv": 0b0010,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            elif link_bw == 8.1:
                pll_values = {"dco_integer": 0x1A5, "dco_fraction": 0x3800, "pdiv": 0b0001,
                              "kdiv": 0b001, "qdiv_mode": 0b0, "qdiv_ratio": 0x00}
            else:
                ret = False
