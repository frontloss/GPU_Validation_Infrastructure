######################################################################################
# @file         lnl_clock_hdmi_snps_phy.py
# @brief        Contains HDMI specific part of LNL Synopsys PHY (both C10 and C20) verification and HDMI algorithms.
# @details      Bspec references:
#               PHY page: https://gfxspecs.intel.com/Predator/Home/Index/68963
#               Clock page: https://gfxspecs.intel.com/Predator/Home/Index/68862
# @author       Goutham N
######################################################################################
...
# (https://gfxspecs.intel.com/Predator/Home/Index/68862). Values are in decimals.
...
##
# @brief        This is the class containing LNL HDMI Snps Phy related verifications
class LnlClockHdmiSnpsPhy:
    ...
    def verify_clock(self, display_port, gfx_index: str):
        ret = True
        ...
        if ret is True:
            ...
            gdhm.report_test_bug_di('[Interfaces][Display_Engine]LNL_Clock_HDMI_Snps_Phy: PLL Register values not '
    ...
    def calculate_hdmi_c10_phy_values(self, display_port, gfx_index):
        ...
        hdmi_symbol_freq_MHz = clock_helper_.calculate_hdmi_symbol_freq(display_port, gfx_index)
        ...
        if link_rate_Gbps in HDMI_C10_STANDARD_LINK_RATES:
            for attribute, value in vars(C10Phy).items():
        ...
        refclk = int(clock_helper_.get_reference_clock_from_register(gfx_index) * (10 ** 6))
        ...
        for j in range(8)[::2] :
            if vco_clk <= curve_freq_hz[c][j+1] :
                ...
                ana_freq_vco = 3 - (a >> 1)
                break
        C10Phy.ana_frq_vco = ana_freq_vco
    ...
    def calculate_hdmi_c20_phy_values(self, display_port, gfx_index):
        ...
        if not clock_helper_.is_hdmi_2_1(display_port, gfx_index) and not datarate <= 6 * (10**9):
    ...
    def verify_hdmi_snps_phy(self, display_port, gfx_index):
        ...
        display_port_name = lnl_clock_helper.ddi_to_bspec_name_map[port_name.upper()]
    ...
    def __verify_hdmi_snps_c20_phy(self, display_port, gfx_index):
        ...
        ret = True
        lnl_clock_helper = LnlClockHelper()
        is_hdmi_2p1_frl = clock_helper_.is_hdmi_2_1(display_port, gfx_index)
        ...
        value = lnl_clock_helper.read_c10_phy_vdr_register(gfx_index, display_port, offset)
        ...
        snps = lnl_clock_helper.read_all_c20_sram_mpll_registers_helper(gfx_index, display_port, current_context, 'MPLLB')
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_6 '
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_4 '
                                                                     f'(of CONTEXT_{current_context})',
                                                              parameter=f'ssc_peak',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_5 '
                                                                     f'(of CONTEXT_{current_context})',
                                                              parameter=f'ssc_stepsize',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_9 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_8 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_7 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_1 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_0 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_10 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_2 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'SRAM_GENERIC_MPLLB_CNTX_CFG_3 '
                                                                     f'(of CONTEXT_{current_context})',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'PHY_VDR_CUSTOM_WIDTH',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'PHY_C20_VDR_CUSTOM_SERDES_RATE',
        ...
        offset = LnlSnpsPhyRegisters.OFFSET_PHY_C10_VDR_HDMI_RATE.offset
        value = lnl_clock_helper.read_c10_phy_vdr_register(gfx_index, display_port, offset)
        vdr_hdmi_rate = LnlSnpsPhyRegisters.REG_PHY_C10_VDR_HDMI_RATE(offset, value)

        if not is_hdmi_2p1_frl:
            ret &= clock_helper_.verify_port_clock_programming_ex(feature=f'PHY_C20_VDR_HDMI_RATE',
    ...
    def __verify_hdmi_snps_c10_phy(self, display_port, gfx_index):
        ...
        snps = lnl_clock_helper.read_all_c10_vdr_registers_helper(display_port, gfx_index)
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL15',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL8',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL3',
                                                              parameter='mpll_ssc_peak',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_ssc_peak, 3, 0)],
                                                              actual=[snps.phy_c10_vdr_pll3.SscPeak])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL4',
                                                              parameter='mpll_ssc_peak',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_ssc_peak, 11, 4)],
                                                              actual=[snps.phy_c10_vdr_pll4.SscPeak])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL5',
                                                              parameter='mpll_ssc_peak',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL6',
                                                              parameter='mpll_ssc_step_size',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_ssc_stepsize, 7, 0)],
                                                              actual=[snps.phy_c10_vdr_pll6.SscStepsize])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL7',
                                                              parameter='mpll_ssc_step_size',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL0',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL9',
                                                              parameter='mpll_frac_den',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_fracn_den, 7, 0)],
                                                              actual=[snps.phy_c10_vdr_pll9.FracnDen])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL10',
                                                              parameter='mpll_frac_den',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL11',
                                                              parameter='mpll_frac_quot',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_fracn_quot, 7, 0)],
                                                              actual=[snps.phy_c10_vdr_pll11.FracnQuot])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL12',
                                                              parameter='mpll_frac_quot',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL13',
                                                              parameter='mpll_frac_rem',
                                                              expected=[self.extract_bits_from_int32(
                                                                 C10Phy.mpll_fracn_rem, 7, 0)],
                                                              actual=[snps.phy_c10_vdr_pll13.FracnRem])
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL14',
                                                              parameter='mpll_frac_rem',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL1',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL2',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL16',
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL17',
                                                              parameter='mpll_cp_int_gs',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL18',
                                                              parameter='mpll_cp_prop',
                                                              expected=[self.extract_bits_from_int32(
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_PLL19',
                                                              parameter='mpll_cp_prop_gs',
                                                              expected=[self.extract_bits_from_int32(
        ...
        phy_c10_vdr_control1_value = lnl_clock_helper.read_c10_phy_vdr_register(gfx_index, display_port, offset)
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_CONTROL1',
                                                              parameter='reg_value',
                                                              expected=[0x6],
        ...
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_VDR_CUSTOM_WIDTH',
                                                              parameter='CUSTOM_WIDTH',
                                                              expected=[0],
                                                              actual=[vdr_custom_width.CustomWidth])

        # ref_range -> PHY_C10_VDR_CMN0[4:0]
        ret &= clock_helper_.verify_port_clock_programming_ex(feature='PHY_C10_VDR_CMN0',
                                                              parameter='ref_range',
