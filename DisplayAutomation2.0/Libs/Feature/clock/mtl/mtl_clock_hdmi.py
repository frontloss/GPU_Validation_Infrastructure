...
##
# @brief    This class is the base class for MTL HDMI Clock Verifications
...
class MtlClockHdmi:
    ...
    def calculate_symbol_freq(self, port_name: str, gfx_index: str) -> float:
        ...
        mapped_bit_per_color = (
            _clock_helper.map_reg_value_to_dict(bit_per_color_value, self.bit_per_color, "Bits Per Color"))
        ...
        mapped_color_format_value = (_clock_helper.map_reg_value_to_dict(
