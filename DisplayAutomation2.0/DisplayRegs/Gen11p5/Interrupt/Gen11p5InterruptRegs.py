...
# --------------------------------------------------------------------------
#
# @file Gen11p5InterruptRegs.py
# @brief contains Gen11p5InterruptRegs.py related register definitions
...
class _GRAPHICS_MASTER_INTERRUPT(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Reserved17', ctypes.c_uint32, 12),
        ('Gu_Misc', ctypes.c_uint32, 1),
        ('Pcu', ctypes.c_uint32, 1),
        ('MasterInterrupt', ctypes.c_uint32, 1),
    ]
...
class REG_GRAPHICS_MASTER_INTERRUPT(ctypes.Union):
    ...
    Reserved17 = 0  # bit 17 to 29
    Gu_Misc = 0  # bit 29 to 30
    Pcu = 0  # bit 30 to 31
    MasterInterrupt = 0  # bit 31 to 32
...
class _DE_PORT_INTERRUPT_DEFINITION(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('AuxUsbc5', ctypes.c_uint32, 1),
        ('AuxUsbc6', ctypes.c_uint32, 1),
        ('Reserved14', ctypes.c_uint32, 3),
        ('Reserved17', ctypes.c_uint32, 6),
...
class REG_DE_PORT_INTERRUPT_DEFINITION(ctypes.Union):
    ...
    AuxUsbc5 = 0  # bit 12 to 13
    AuxUsbc6 = 0  # bit 13 to 14
