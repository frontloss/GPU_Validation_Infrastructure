...
# --------------------------------------------------------------------------
#
# @file Gen11p5PllRegs.py
# @brief contains Gen11p5PllRegs.py related register definitions
...
class OFFSET_MG_PLL_DIV0:
    MG_PLL_DIV0_PLL1_PORT1 = 0x168A00
    MG_PLL_DIV0_PLL1_PORT2 = 0x169A00
    MG_PLL_DIV0_PLL1_PORT3 = 0x16AA00
    MG_PLL_DIV0_PLL1_PORT4 = 0x16BA00
    MG_PLL_DIV0_PLL1_PORT5 = 0x16CA00
    MG_PLL_DIV0_PLL1_PORT6 = 0x16DA00
...
class OFFSET_MG_PLL_DIV1:
    MG_PLL_DIV1_PLL1_PORT1 = 0x168A04
    MG_PLL_DIV1_PLL1_PORT2 = 0x169A04
    MG_PLL_DIV1_PLL1_PORT3 = 0x16AA04
    MG_PLL_DIV1_PLL1_PORT4 = 0x16BA04
    MG_PLL_DIV1_PLL1_PORT5 = 0x16CA04
    MG_PLL_DIV1_PLL1_PORT6 = 0x16DA04
...
class OFFSET_MG_PLL_FRAC_LOCK:
    MG_PLL_FRAC_LOCK_PLL1_PORT1 = 0x168A0C
    MG_PLL_FRAC_LOCK_PLL1_PORT2 = 0x169A0C
    MG_PLL_FRAC_LOCK_PLL1_PORT3 = 0x16AA0C
    MG_PLL_FRAC_LOCK_PLL1_PORT4 = 0x16BA0C
    MG_PLL_FRAC_LOCK_PLL1_PORT5 = 0x16CA0C
    MG_PLL_FRAC_LOCK_PLL1_PORT6 = 0x16DA0C
...
class OFFSET_MG_PLL_LF:
    MG_PLL_LF_PLL1_PORT1 = 0x168A08
    MG_PLL_LF_PLL1_PORT2 = 0x169A08
    MG_PLL_LF_PLL1_PORT3 = 0x16AA08
    MG_PLL_LF_PLL1_PORT4 = 0x16BA08
    MG_PLL_LF_PLL1_PORT5 = 0x16CA08
    MG_PLL_LF_PLL1_PORT6 = 0x16DA08
...
class OFFSET_MG_CLKTOP_CORECLKCTL1:
    ...
    MG_CLKTOP2_CORECLKCTL1_PORT5 = 0x16C8D8
    MG_CLKTOP2_CORECLKCTL1_PORT6 = 0x16D8D8
...
class OFFSET_MG_CLKTOP_HSCLKCTL:
    ...
    MG_CLKTOP2_HSCLKCTL_PORT5 = 0x16C8D4
    MG_CLKTOP2_HSCLKCTL_PORT6 = 0x16D8D4
...
class OFFSET_MG_REFCLKIN_CTL:
    ...
    MG_REFCLKIN_CTL_PORT5 = 0x16C92C
    MG_REFCLKIN_CTL_PORT6 = 0x16D92C
...
class OFFSET_MG_PLL_SSC:
    MG_PLL_SSC_PLL1_PORT1 = 0x168A10
    MG_PLL_SSC_PLL1_PORT2 = 0x169A10
    MG_PLL_SSC_PLL1_PORT3 = 0x16AA10
    MG_PLL_SSC_PLL1_PORT4 = 0x16BA10
    MG_PLL_SSC_PLL1_PORT5 = 0x16CA10
    MG_PLL_SSC_PLL1_PORT6 = 0x16DA10
...
class OFFSET_MG_PLL_TDC_COLDST_BIAS:
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT1 = 0x168A18
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT2 = 0x169A18
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT3 = 0x16AA18
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT4 = 0x16BA18
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT5 = 0x16CA18
    MG_PLL_TDC_COLDST_BIAS_PLL1_PORT6 = 0x16DA18
...
class OFFSET_MG_PLL_BIAS:
    MG_PLL_BIAS_PLL1_PORT1 = 0x168A14
    MG_PLL_BIAS_PLL1_PORT2 = 0x169A14
    MG_PLL_BIAS_PLL1_PORT3 = 0x16AA14
    MG_PLL_BIAS_PLL1_PORT4 = 0x16BA14
    MG_PLL_BIAS_PLL1_PORT5 = 0x16CA14
    MG_PLL_BIAS_PLL1_PORT6 = 0x16DA14
