...
# --------------------------------------------------------------------------
#
# @file Gen11p5PlaneRegs.py
# @brief contains Gen11p5PlaneRegs.py related register definitions
...
class ENUM_LAST_CL_WRITE_FIX_DISABLE(Enum):
    LAST_CL_WRITE_FIX_ENABLE = 0x0
    LAST_CL_WRITE_FIX_DISABLE = 0x1
...
class _FBC_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('LastClWriteFixDisable', ctypes.c_uint32, 1),
...
class REG_FBC_CHICKEN(ctypes.Union):
    ...
    LastClWriteFixDisable = 0  # bit 16 to 17
