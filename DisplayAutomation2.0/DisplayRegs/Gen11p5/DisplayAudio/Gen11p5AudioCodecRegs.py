...
# --------------------------------------------------------------------------
#
# @file Gen11p5AudioCodecRegs.py
# @brief contains Gen11p5AudioCodecRegs.py related register definitions
...
class _AUD_CHICKENBIT_REG_2(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('DacfeExtraChickens', ctypes.c_uint32, 4),
...
class REG_AUD_CHICKENBIT_REG_2(ctypes.Union):
    ...
    DacfeExtraChickens = 0  # bit 24 to 28
...
class ENUM_HBLANK_EARLY_ENABLE_FOR_PIPED(Enum):
    ...
    HBLANK_EARLY_ENABLE_FOR_PIPED_HBLANK_EARLY_ENABLE = 0x1  # The early hblank programmed by fields ‘hblank_start coun
                                                             # t for Pipe D’ will be used to trigger samplecount
