...
# --------------------------------------------------------------------------
#
# @file Gen11p5TranscoderRegs.py
# @brief contains Gen11p5TranscoderRegs.py related register definitions
...
class ENUM_BLOCK_COUNT_NUMBER(Enum):
    BLOCK_COUNT_NUMBER_2_BLOCKS = 0x0  # 8 lines
    BLOCK_COUNT_NUMBER_3_BLOCKS = 0x1  # 12 lines
