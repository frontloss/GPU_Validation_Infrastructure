...
# --------------------------------------------------------------------------
#
# @file Gen13TranscoderRegs.py
# @brief contains Gen13TranscoderRegs.py related register definitions
...
class OFFSET_GTC_PORT_CTL:
    ...
    GTC_PORT_CTL_D = 0x64770
    GTC_PORT_CTL_E = 0x64870
...
class OFFSET_GTC_PORT_MISC:
    ...
    GTC_PORT_MISC_D = 0x64794
    GTC_PORT_MISC_E = 0x64894
...
class ENUM_DISABLE_DISPLAY_PAGE_TABLES(Enum):
    DISABLE_DISPLAY_PAGE_TABLES_PAGE_TABLES_ENABLED = 0x0
    DISABLE_DISPLAY_PAGE_TABLES_PAGE_TABLES_DISABLED = 0x1
...
class _CHICKEN_MISC_2(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Spare29', ctypes.c_uint32, 1),
        ('DisableDisplayPageTables', ctypes.c_uint32, 1),
        ('Spare31', ctypes.c_uint32, 1),
    ]
...
class REG_CHICKEN_MISC_2(ctypes.Union):
    ...
    Spare29 = 0  # bit 29 to 30
    DisableDisplayPageTables = 0  # bit 30 to 31
    Spare31 = 0  # bit 31 to 32
