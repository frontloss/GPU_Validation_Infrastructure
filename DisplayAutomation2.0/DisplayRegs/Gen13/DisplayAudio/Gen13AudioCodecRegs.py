...
# --------------------------------------------------------------------------
#
# @file Gen13AudioCodecRegs.py
# @brief contains Gen13AudioCodecRegs.py related register definitions
...
class _AUD_CHICKENBIT_REG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Chicken1Spare13', ctypes.c_uint32, 1),
...
class REG_AUD_CHICKENBIT_REG(ctypes.Union):
    ...
    Chicken1Spare13 = 0  # bit 13 to 14
