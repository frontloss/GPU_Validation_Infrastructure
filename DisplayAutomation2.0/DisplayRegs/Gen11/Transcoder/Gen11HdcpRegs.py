...
# --------------------------------------------------------------------------
#
# @file Gen11HdcpRegs.py
# @brief contains Gen11HdcpRegs.py related register definitions
...
class OFFSET_HDCP_CONF:
    HDCP_CONF_DDIB = 0x66500
    HDCP_CONF_DDIC = 0x66600
    HDCP_CONF_DDID = 0x66700
    HDCP_CONF_DDIA = 0x66800
    HDCP_CONF_DDIF = 0x66900
    HDCP_CONF_DDIE = 0x66A00
...
class OFFSET_HDCP_ANINIT:
    HDCP_ANINIT_DDIB = 0x66504
    HDCP_ANINIT_DDIC = 0x66604
    HDCP_ANINIT_DDID = 0x66704
    HDCP_ANINIT_DDIA = 0x66804
    HDCP_ANINIT_DDIF = 0x66904
    HDCP_ANINIT_DDIE = 0x66A04
...
class OFFSET_HDCP_ANLO:
    HDCP_ANLO_DDIB = 0x66508
    HDCP_ANLO_DDIC = 0x66608
    HDCP_ANLO_DDID = 0x66708
    HDCP_ANLO_DDIA = 0x66808
    HDCP_ANLO_DDIF = 0x66908
    HDCP_ANLO_DDIE = 0x66A08
...
class OFFSET_HDCP_ANHI:
    HDCP_ANHI_DDIB = 0x6650C
    HDCP_ANHI_DDIC = 0x6660C
    HDCP_ANHI_DDID = 0x6670C
    HDCP_ANHI_DDIA = 0x6680C
    HDCP_ANHI_DDIF = 0x6690C
    HDCP_ANHI_DDIE = 0x66A0C
...
class OFFSET_HDCP_BKSVLO:
    HDCP_BKSVLO_DDIB = 0x66510
    HDCP_BKSVLO_DDIC = 0x66610
    HDCP_BKSVLO_DDID = 0x66710
    HDCP_BKSVLO_DDIA = 0x66810
    HDCP_BKSVLO_DDIF = 0x66910
    HDCP_BKSVLO_DDIE = 0x66A10
...
class OFFSET_HDCP_BKSVHI:
    HDCP_BKSVHI_DDIB = 0x66514
    HDCP_BKSVHI_DDIC = 0x66614
    HDCP_BKSVHI_DDID = 0x66714
    HDCP_BKSVHI_DDIA = 0x66814
    HDCP_BKSVHI_DDIF = 0x66914
    HDCP_BKSVHI_DDIE = 0x66A14
...
class OFFSET_HDCP_RPRIME:
    HDCP_RPRIME_DDIB = 0x66518
    HDCP_RPRIME_DDIC = 0x66618
    HDCP_RPRIME_DDID = 0x66718
    HDCP_RPRIME_DDIA = 0x66818
    HDCP_RPRIME_DDIF = 0x66918
    HDCP_RPRIME_DDIE = 0x66A18
...
class ENUM_DDIE_REPEATER_PRESENT(Enum):
    DDIE_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDIE_REPEATER_PRESENT_REPEATER = 0x1


class ENUM_DDIF_REPEATER_PRESENT(Enum):
    DDIF_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDIF_REPEATER_PRESENT_REPEATER = 0x1


class ENUM_DDID_REPEATER_PRESENT(Enum):
    DDID_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDID_REPEATER_PRESENT_REPEATER = 0x1


class ENUM_DDIC_REPEATER_PRESENT(Enum):
    DDIC_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDIC_REPEATER_PRESENT_REPEATER = 0x1


class ENUM_DDIA_REPEATER_PRESENT(Enum):
    DDIA_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDIA_REPEATER_PRESENT_REPEATER = 0x1


class ENUM_DDIB_REPEATER_PRESENT(Enum):
    DDIB_REPEATER_PRESENT_NOT_REPEATER = 0x0
    DDIB_REPEATER_PRESENT_REPEATER = 0x1


class OFFSET_HDCP_REP_CONTROL:
    HDCP_REP_CONTROL_ = 0x66D00
...
class _HDCP_REP_CONTROL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('DdieRepeaterPresent', ctypes.c_uint32, 1),
        ('DdifRepeaterPresent', ctypes.c_uint32, 1),
        ('DdidRepeaterPresent', ctypes.c_uint32, 1),
        ('DdicRepeaterPresent', ctypes.c_uint32, 1),
        ('DdiaRepeaterPresent', ctypes.c_uint32, 1),
        ('DdibRepeaterPresent', ctypes.c_uint32, 1),
...
class REG_HDCP_REP_CONTROL(ctypes.Union):
    ...
    DdieRepeaterPresent = 0  # bit 25 to 26
    DdifRepeaterPresent = 0  # bit 26 to 27
    DdidRepeaterPresent = 0  # bit 27 to 28
    DdicRepeaterPresent = 0  # bit 28 to 29
    DdiaRepeaterPresent = 0  # bit 29 to 30
    DdibRepeaterPresent = 0  # bit 30 to 31
...
class OFFSET_HDCP2_CTL:
    HDCP2_CTL_DDIB = 0x665B0
    HDCP2_CTL_DDIC = 0x666B0
    HDCP2_CTL_DDID = 0x667B0
    HDCP2_CTL_DDIA = 0x668B0
    HDCP2_CTL_DDIF = 0x669B0
    HDCP2_CTL_DDIE = 0x66AB0
...
class OFFSET_HDCP2_AUTH:
    HDCP2_AUTH_DDIB = 0x66598
    HDCP2_AUTH_DDIC = 0x66698
    HDCP2_AUTH_DDID = 0x66798
    HDCP2_AUTH_DDIA = 0x66898
    HDCP2_AUTH_DDIF = 0x66998
    HDCP2_AUTH_DDIE = 0x66A98
...
class OFFSET_HDCP2_INPUTCTR:
    HDCP2_INPUTCTR_DDIB_ = 0x665B8
    HDCP2_INPUTCTR_DDIC_ = 0x666B8
    HDCP2_INPUTCTR_DDID_ = 0x667B8
    HDCP2_INPUTCTR_DDIA_ = 0x668B8
    HDCP2_INPUTCTR_DDIF_ = 0x669B8
    HDCP2_INPUTCTR_DDIE_ = 0x66AB8
...
class OFFSET_HDCP2_RIV:
    HDCP2_RIV_DDIB_ = 0x66590
    HDCP2_RIV_DDIC_ = 0x66690
    HDCP2_RIV_DDID_ = 0x66790
    HDCP2_RIV_DDIA_ = 0x66890
    HDCP2_RIV_DDIF_ = 0x66990
    HDCP2_RIV_DDIE_ = 0x66A90
...
class OFFSET_HDCP2_SKEY:
    HDCP2_SKEY_DDIB_ = 0x66580
    HDCP2_SKEY_DDIC_ = 0x66680
    HDCP2_SKEY_DDID_ = 0x66780
    HDCP2_SKEY_DDIA_ = 0x66880
    HDCP2_SKEY_DDIF_ = 0x66980
    HDCP2_SKEY_DDIE_ = 0x66A80
...
class OFFSET_HDCP2_STREAM_STATUS:
    HDCP2_STREAM_STATUS_B = 0x665C0
    HDCP2_STREAM_STATUS_C = 0x666C0
    HDCP2_STREAM_STATUS_D = 0x667C0
    HDCP2_STREAM_STATUS_A = 0x668C0
