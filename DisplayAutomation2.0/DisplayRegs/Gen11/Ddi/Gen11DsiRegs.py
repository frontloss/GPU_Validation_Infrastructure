...
# --------------------------------------------------------------------------
#
# @file Gen11DsiRegs.py
# @brief contains Gen11DsiRegs.py related register definitions
...
class OFFSET_DPHY_TRIG_EXT:
    DPHY_TRIG_EXT_1 = 0x6C18C
    DPHY_TRIG_EXT_0 = 0x16218C


class _DPHY_TRIG_EXT(ctypes.LittleEndianStructure):
    _fields_ = [
        ('TriggerExtension', ctypes.c_uint32, 16),
        ('Reserved16', ctypes.c_uint32, 16),
    ]


class REG_DPHY_TRIG_EXT(ctypes.Union):
    value = 0
    offset = 0

    TriggerExtension = 0  # bit 0 to 16
    Reserved16 = 0  # bit 16 to 32

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DPHY_TRIG_EXT),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPHY_TRIG_EXT, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_DSI_CHKN_REG0(ctypes.Union):
    ...
    UlpsActive = 0  # bit 12 to 13
    AfeUlpsOverride = 0  # bit 13 to 14
...
class ENUM_AFE_UNLOCKED_STATE_DATA_LANES(Enum):
    AFE_UNLOCKED_STATE_DATA_LANES_AFE_DATA_LANES_ARE_LOCKED = 0x0
    AFE_UNLOCKED_STATE_DATA_LANES_AFE_DATA_LANES_ARE_UNLOCKED = 0x1


class ENUM_AFE_UNLOCKED_STATE_CLOCK_LANE(Enum):
    AFE_UNLOCKED_STATE_CLOCK_LANE_AFE_CLOCK_LANE_IS_LOCKED = 0x0
    AFE_UNLOCKED_STATE_CLOCK_LANE_AFE_CLOCK_LANE_IS_UNLOCKED = 0x1
...
class ENUM_DPHY_TOGGLE_LOCK_REQUEST_DATA_LANES(Enum):
    DPHY_TOGGLE_LOCK_REQUEST_DATA_LANES_NO_TOGGLE_LOCK_REQUEST_IS_PRESENT = 0x0
    DPHY_TOGGLE_LOCK_REQUEST_DATA_LANES_A_TOGGLE_LOCK_REQUEST_IS_PRESENT = 0x1


class ENUM_DPHY_TOGGLE_LOCK_REQUEST_CLOCK_LANE(Enum):
    DPHY_TOGGLE_LOCK_REQUEST_CLOCK_LANE_NO_TOGGLE_LOCK_REQUEST_IS_PRESENT = 0x0
    DPHY_TOGGLE_LOCK_REQUEST_CLOCK_LANE_A_TOGGLE_LOCK_REQUEST_IS_PRESENT = 0x1


class ENUM_AFE_LP_LOOPBACK(Enum):
    AFE_LP_LOOPBACK_AFE_LP_LOOPBACK_DISABLED = 0x0
    AFE_LP_LOOPBACK_AFE_LP_LOOPBACK_ENABLED = 0x1
...
class ENUM_COMBOPHY_ISOLATION_MODE_ENABLE(Enum):
    COMBOPHY_ISOLATION_MODE_ENABLE_ISOLATION_MODE_DISABLED = 0x0
    COMBOPHY_ISOLATION_MODE_ENABLE_ISOLATION_MODE_ENABLED = 0x1
...
class _DSI_DFX_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('AfeUnlockedStateDataLanes', ctypes.c_uint32, 1),
        ('AfeUnlockedStateClockLane', ctypes.c_uint32, 1),
        ...
        ('DPhyToggleLockRequestDataLanes', ctypes.c_uint32, 1),
        ('DPhyToggleLockRequestClockLane', ctypes.c_uint32, 1),
        ('Reserved19', ctypes.c_uint32, 10),
        ('AfeLpLoopback', ctypes.c_uint32, 1),
        ('TeIsolationModeEnable', ctypes.c_uint32, 1),
        ('ComboPhyIsolationModeEnable', ctypes.c_uint32, 1),
    ]
...
class REG_DSI_DFX_CTL(ctypes.Union):
    ...
    AfeUnlockedStateDataLanes = 0  # bit 1 to 2
    AfeUnlockedStateClockLane = 0  # bit 2 to 3
    ...
    DPhyToggleLockRequestDataLanes = 0  # bit 17 to 18
    DPhyToggleLockRequestClockLane = 0  # bit 18 to 19
    Reserved19 = 0  # bit 19 to 29
    AfeLpLoopback = 0  # bit 29 to 30
    TeIsolationModeEnable = 0  # bit 30 to 31
    ComboPhyIsolationModeEnable = 0  # bit 31 to 32
...
class OFFSET_DSI_TA_TIMING_PARAM:
    DSI_TA_TIMING_PARAM_0 = 0x6B098
    DSI_TA_TIMING_PARAM_1 = 0x6B898


class _DSI_TA_TIMING_PARAM(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Ta_Get', ctypes.c_uint32, 4),
        ('Reserved4', ctypes.c_uint32, 3),
        ('Ta_GetOverride', ctypes.c_uint32, 1),
...
class REG_DSI_TA_TIMING_PARAM(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DSI_TA_TIMING_PARAM),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DSI_TA_TIMING_PARAM, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DSI_TRIG_EXT:
    DSI_TRIG_EXT_0 = 0x6B09C
    DSI_TRIG_EXT_1 = 0x6B89C


class _DSI_TRIG_EXT(ctypes.LittleEndianStructure):
    _fields_ = [
        ('TriggerExtension', ctypes.c_uint32, 16),
        ('Reserved16', ctypes.c_uint32, 16),
    ]
...
class REG_DSI_TRIG_EXT(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DSI_TRIG_EXT),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DSI_TRIG_EXT, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
