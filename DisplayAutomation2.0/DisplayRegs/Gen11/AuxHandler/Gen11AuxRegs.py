...
# --------------------------------------------------------------------------
#
# @file Gen11AuxRegs.py
# @brief contains Gen11AuxRegs.py related register definitions
...
class OFFSET_DDI_AUX_CTL:
    ...
    DDI_AUX_CTL_D = 0x64310
    DDI_AUX_CTL_E = 0x64410
    DDI_AUX_CTL_F = 0x64510
...
class OFFSET_DDI_AUX_DATA:
    DDI_AUX_DATA_A_0 = 0x64014
    DDI_AUX_DATA_A_1 = 0x64018
    DDI_AUX_DATA_A_2 = 0x6401C
    DDI_AUX_DATA_A_3 = 0x64020
    DDI_AUX_DATA_A_4 = 0x64024
    DDI_AUX_DATA_B_0 = 0x64114
    DDI_AUX_DATA_B_1 = 0x64118
    DDI_AUX_DATA_B_2 = 0x6411C
    DDI_AUX_DATA_B_3 = 0x64120
    DDI_AUX_DATA_B_4 = 0x64124
    DDI_AUX_DATA_C_0 = 0x64214
    DDI_AUX_DATA_C_1 = 0x64218
    DDI_AUX_DATA_C_2 = 0x6421C
    DDI_AUX_DATA_C_3 = 0x64220
    DDI_AUX_DATA_C_4 = 0x64224
    DDI_AUX_DATA_D_0 = 0x64314
    DDI_AUX_DATA_D_1 = 0x64318
    DDI_AUX_DATA_D_2 = 0x6431C
    DDI_AUX_DATA_D_3 = 0x64320
    DDI_AUX_DATA_D_4 = 0x64324
    DDI_AUX_DATA_E_0 = 0x64414
    DDI_AUX_DATA_E_1 = 0x64418
    DDI_AUX_DATA_E_2 = 0x6441C
    DDI_AUX_DATA_E_3 = 0x64420
    DDI_AUX_DATA_E_4 = 0x64424
    DDI_AUX_DATA_F_0 = 0x64514
    DDI_AUX_DATA_F_1 = 0x64518
    DDI_AUX_DATA_F_2 = 0x6451C
    DDI_AUX_DATA_F_3 = 0x64520
    DDI_AUX_DATA_F_4 = 0x64524
