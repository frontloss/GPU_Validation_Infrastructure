...
# --------------------------------------------------------------------------
#
# @file Gen11PlaneRegs.py
# @brief contains Gen11PlaneRegs.py related register definitions
...
class ENUM_TRICKLE_FEED_ENABLE(Enum):
    TRICKLE_FEED_ENABLE = 0x0
    TRICKLE_FEED_DISABLE = 0x1
...
class _PLANE_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('TrickleFeedEnable', ctypes.c_uint32, 1),
...
class REG_PLANE_CTL(ctypes.Union):
    ...
    TrickleFeedEnable = 0  # bit 14 to 15
...
class ENUM_CPU_FENCE_ENABLE(Enum):
    CPU_FENCE_ENABLE_NO_CPU_DISP_BUF = 0x0  # Display Buffer is not in a CPU fence. No modifications are allowed from C
                                            # PU to the Display Buffer.
    CPU_FENCE_ENABLE_CPU_DISP_BUF = 0x1  # Display Buffer exists in a CPU fence.
...
class ENUM_DPFC_CTRL_CHICKEN(Enum):
    DPFC_CTRL_CHICKEN_WRITE_BACK_COMPRESSED_DATA_USING_DCPR_FILL_SIGNAL_AND_DPFC_INTERNAL_WATERMARK = 0x0
    DPFC_CTRL_CHICKEN_WRITE_BACK_COMPRESSED_DATA_IGNORING_DCPR_FILL_SIGNAL_AND_DPFC_INTERNAL_WATERMARK = 0x1
...
class _FBC_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('DpfcCtrlChicken', ctypes.c_uint32, 1),
...
class REG_FBC_CHICKEN(ctypes.Union):
    ...
    DpfcCtrlChicken = 0  # bit 25 to 26
...
class _FBC_STRIDE(ctypes.LittleEndianStructure):
    _fields_ = [
        ('OverrideStride', ctypes.c_uint32, 13),
