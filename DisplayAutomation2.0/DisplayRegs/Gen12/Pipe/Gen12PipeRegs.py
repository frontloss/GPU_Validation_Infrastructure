...
# --------------------------------------------------------------------------
#
# @file Gen12PipeRegs.py
# @brief contains Gen12PipeRegs.py related register definitions
...
class _PIPE_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('NotUsed26', ctypes.c_uint32, 1),
        ('NotUsed27', ctypes.c_uint32, 1),
        ('NotUsed28', ctypes.c_uint32, 1),
...
class REG_PIPE_STATUS(ctypes.Union):
    ...
    NotUsed26 = 0  # bit 26 to 27
    NotUsed27 = 0  # bit 27 to 28
    NotUsed28 = 0  # bit 28 to 29
...
class REG_DSC_PICTURE_PARAMETER_SET_0(ctypes.Union):
    ...
    AllowDoubleBufferUpdateDisable = 0  # bit 31 to 32
...
class OFFSET_ARB_CTL2:
    ARB_CTL2 = 0x45004
    ARB_CTL2_ABOX1 = 0x45804
    ARB_CTL2_ABOX2 = 0x4580C
...
class REG_ARB_CTL2(ctypes.Union):
    ...
    DsbLpWriteRequestLimit = 0  # bit 26 to 28
