...
# --------------------------------------------------------------------------
#
# @file TglPchInterruptRegs.py
# @brief contains TglPchInterruptRegs.py related register definitions
...
class ENUM_TC2_HPD_OUTPUT_DATA(Enum):
    TC2_HPD_OUTPUT_DATA_DRIVE_0 = 0x0
    TC2_HPD_OUTPUT_DATA_DRIVE_1 = 0x1
...
class ENUM_TC3_HPD_OUTPUT_DATA(Enum):
    TC3_HPD_OUTPUT_DATA_DRIVE_0 = 0x0
    TC3_HPD_OUTPUT_DATA_DRIVE_1 = 0x1
...
class ENUM_TC4_HPD_OUTPUT_DATA(Enum):
    TC4_HPD_OUTPUT_DATA_DRIVE_0 = 0x0
    TC4_HPD_OUTPUT_DATA_DRIVE_1 = 0x1
...
class ENUM_TC5_HPD_STATUS(Enum):
    TC5_HPD_STATUS_HOT_PLUG_EVENT_NOT_DETECTED = 0x0
    TC5_HPD_STATUS_SHORT_PULSE_DETECTED = 0x1
    TC5_HPD_STATUS_LONG_PULSE_DETECTED = 0x2
    TC5_HPD_STATUS_SHORT_AND_LONG_PULSES_DETECTED = 0x3


class ENUM_TC5_HPD_OUTPUT_DATA(Enum):
    TC5_HPD_OUTPUT_DATA_DRIVE_0 = 0x0
    TC5_HPD_OUTPUT_DATA_DRIVE_1 = 0x1


class ENUM_TC5_HPD_ENABLE(Enum):
    TC5_HPD_DISABLE = 0x0
    TC5_HPD_ENABLE = 0x1


class ENUM_TC6_HPD_STATUS(Enum):
    TC6_HPD_STATUS_HOT_PLUG_EVENT_NOT_DETECTED = 0x0
    TC6_HPD_STATUS_SHORT_PULSE_DETECTED = 0x1
    TC6_HPD_STATUS_LONG_PULSE_DETECTED = 0x2
    TC6_HPD_STATUS_SHORT_AND_LONG_PULSES_DETECTED = 0x3


class ENUM_TC6_HPD_OUTPUT_DATA(Enum):
    TC6_HPD_OUTPUT_DATA_DRIVE_0 = 0x0
    TC6_HPD_OUTPUT_DATA_DRIVE_1 = 0x1


class ENUM_TC6_HPD_ENABLE(Enum):
    TC6_HPD_DISABLE = 0x0
    TC6_HPD_ENABLE = 0x1
...
class _SHOTPLUG_CTL_TC(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Tc2HpdOutputData', ctypes.c_uint32, 1),
        ('Tc2HpdEnable', ctypes.c_uint32, 1),
        ('Tc3HpdStatus', ctypes.c_uint32, 2),
        ('Tc3HpdOutputData', ctypes.c_uint32, 1),
        ('Tc3HpdEnable', ctypes.c_uint32, 1),
        ('Tc4HpdStatus', ctypes.c_uint32, 2),
        ('Tc4HpdOutputData', ctypes.c_uint32, 1),
        ('Tc4HpdEnable', ctypes.c_uint32, 1),
        ('Tc5HpdStatus', ctypes.c_uint32, 2),
        ('Tc5HpdOutputData', ctypes.c_uint32, 1),
        ('Tc5HpdEnable', ctypes.c_uint32, 1),
        ('Tc6HpdStatus', ctypes.c_uint32, 2),
        ('Tc6HpdOutputData', ctypes.c_uint32, 1),
        ('Tc6HpdEnable', ctypes.c_uint32, 1),
...
class REG_SHOTPLUG_CTL_TC(ctypes.Union):
    ...
    Tc2HpdOutputData = 0  # bit 6 to 7
    Tc2HpdEnable = 0  # bit 7 to 8
    Tc3HpdStatus = 0  # bit 8 to 10
    Tc3HpdOutputData = 0  # bit 10 to 11
    Tc3HpdEnable = 0  # bit 11 to 12
    Tc4HpdStatus = 0  # bit 12 to 14
    Tc4HpdOutputData = 0  # bit 14 to 15
    Tc4HpdEnable = 0  # bit 15 to 16
    Tc5HpdStatus = 0  # bit 16 to 18
    Tc5HpdOutputData = 0  # bit 18 to 19
    Tc5HpdEnable = 0  # bit 19 to 20
    Tc6HpdStatus = 0  # bit 20 to 22
    Tc6HpdOutputData = 0  # bit 22 to 23
    Tc6HpdEnable = 0  # bit 23 to 24
...
class ENUM_HPD_FILTER_COUNT(Enum):
    ...
    HPD_FILTER_COUNT_500_MICROSECONDS_ADJUSTED = 0x1D9
