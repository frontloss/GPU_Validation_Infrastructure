...
# --------------------------------------------------------------------------
#
# @file Gen12DdiRegs.py
# @brief contains Gen12DdiRegs.py related register definitions
...
class ENUM_CURSOR_COEFF_0(Enum):
    CURSOR_COEFF_0_DEFAULT_CURSOR_COEFF = 0x34


class ENUM_MIPI_EQ_OVERRIDE_ENABLE(Enum):
    MIPI_EQ_OVERRIDE_ENABLE_PPI_INPUTS_DRIVE_EQ_LOGIC = 0x0
    MIPI_EQ_OVERRIDE_ENABLE_THIS_REGISTER_DRIVES_EQ_LOGIC = 0x1


class ENUM_POST_CURSOR_COEFF_0(Enum):
    POST_CURSOR_COEFF_0_DEFAULT_POST_CURSOR_COEFF = 0xB


class ENUM_MIPI_EQ_ENABLE(Enum):
    MIPI_EQ_ENABLE_TX_EQUALIZATION_DISABLED = 0x0
    MIPI_EQ_ENABLE_TX_EQUALIZATION_ENABLED = 0x1


class ENUM_MIPI_EQ_SELECT(Enum):
    MIPI_EQ_SELECT_LOW_LEVLEL_EQUALIZATION_3_5_DB = 0x0
    MIPI_EQ_SELECT_HIGH_LEVEL_EQUALIZATION_7_DB = 0x1


class OFFSET_PORT_TX_DW0:
    PORT_TX_DW0_AUX_B = 0x6C380
    PORT_TX_DW0_GRP_B = 0x6C680
    PORT_TX_DW0_LN0_B = 0x6C880
    PORT_TX_DW0_LN1_B = 0x6C980
    PORT_TX_DW0_LN2_B = 0x6CA80
    PORT_TX_DW0_LN3_B = 0x6CB80
    PORT_TX_DW0_AUX_C = 0x160380
    PORT_TX_DW0_GRP_C = 0x160680
    PORT_TX_DW0_LN0_C = 0x160880
    PORT_TX_DW0_LN1_C = 0x160980
    PORT_TX_DW0_LN2_C = 0x160A80
    PORT_TX_DW0_LN3_C = 0x160B80
    PORT_TX_DW0_AUX_A = 0x162380
    PORT_TX_DW0_GRP_A = 0x162680
    PORT_TX_DW0_LN0_A = 0x162880
    PORT_TX_DW0_LN1_A = 0x162980
    PORT_TX_DW0_LN2_A = 0x162A80
    PORT_TX_DW0_LN3_A = 0x162B80


class _PORT_TX_DW0(ctypes.LittleEndianStructure):
    _fields_ = [
        ('CursorCoeff0', ctypes.c_uint32, 6),
        ('Reserved6', ctypes.c_uint32, 17),
        ('MipiEqOverrideEnable', ctypes.c_uint32, 1),
        ('PostCursorCoeff0', ctypes.c_uint32, 6),
        ('MipiEqEnable', ctypes.c_uint32, 1),
        ('MipiEqSelect', ctypes.c_uint32, 1),
    ]


class REG_PORT_TX_DW0(ctypes.Union):
    value = 0
    offset = 0

    CursorCoeff0 = 0  # bit 0 to 6
    Reserved6 = 0  # bit 6 to 23
    MipiEqOverrideEnable = 0  # bit 23 to 24
    PostCursorCoeff0 = 0  # bit 24 to 30
    MipiEqEnable = 0  # bit 30 to 31
    MipiEqSelect = 0  # bit 31 to 32
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PORT_TX_DW0, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DKL_TX_DPCNTL0:
    DKL_TX_DPCTRL0_TX1LN0 = 0x2C0


class _DKL_TX_DPCNTL0(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_DKL_TX_DPCNTL0(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DKL_TX_DPCNTL0),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DKL_TX_DPCNTL0, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DKL_TX_DPCNTL1:
    DKL_TX_DPCNTL1_TX2LN0 = 0x2C4


class _DKL_TX_DPCNTL1(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_DKL_TX_DPCNTL1(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DKL_TX_DPCNTL1),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DKL_TX_DPCNTL1, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_DP_2UI_4UI_MODE_EN(Enum):
    DP_2UI_4UI_MODE_EN_4UI = 0x0
    DP_2UI_4UI_MODE_EN_2UI = 0x1
...
class _DKL_TX_DPCNTL2(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Dp_2Ui_4Ui_Mode_En', ctypes.c_uint32, 1),
        ('Dp_Fifo_Depth_Tx2', ctypes.c_uint32, 1),
        ('Dp_Fifo_Depth_Tx1', ctypes.c_uint32, 1),
        ('Reserved_Dp3', ctypes.c_uint32, 13),
...
class REG_DKL_TX_DPCNTL2(ctypes.Union):
    ...
    Dp_2Ui_4Ui_Mode_En = 0  # bit 7 to 8
    Dp_Fifo_Depth_Tx2 = 0  # bit 8 to 9
    Dp_Fifo_Depth_Tx1 = 0  # bit 9 to 10
    Reserved_Dp3 = 0  # bit 10 to 23
...
class OFFSET_DKL_CMN_UC_DW27:
    DKL_CMN_UC_DW27 = 0x36C


class _DKL_CMN_UC_DW27(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_DKL_CMN_UC_DW27(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DKL_CMN_UC_DW27),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DKL_CMN_UC_DW27, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
