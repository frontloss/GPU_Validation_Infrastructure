########################################################################################################################
# @file         Gen12DisplayRegsInterface.py
# @brief        Contains DisplayRegsService implementation for Gen12 platforms
#
# @author       Rohit Kumar
########################################################################################################################
from DisplayRegs.DisplayRegsInterface import *
from DisplayRegs.Gen12.Plane.Gen12PlaneRegs import *
from DisplayRegs.Gen12.Pipe.Gen12PipeRegs import *
from DisplayRegs.Gen11p5.Plane.Gen11p5PlaneRegs import *
from DisplayRegs.Gen12.Transcoder.Gen12TranscoderRegs import *
from DisplayRegs.Gen12.DisplayPowerHandler.Gen12DisplayPowerRegs import *


class Gen12DisplayRegsService(DisplayRegsService):
    ...
    def get_dcstate_info(self, data: DCStateOffsetsValues = None) -> DcStateInfo:
        ...
        return DcStateInfo(dc_state_en.Dc9Allow, dc_state_en.DynamicDcStateEnable == 2,
                           dc_state_en.DynamicDcStateEnable == 1, 0, dc_state_en.DisplayClockOffEnable, 0, 0)
