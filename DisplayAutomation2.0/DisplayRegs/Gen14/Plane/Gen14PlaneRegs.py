...
# --------------------------------------------------------------------------
#
# @file Gen14PlaneRegs.py
# @brief contains Gen14PlaneRegs.py related register definitions
...
class REG_PLANE_STRIDE(ctypes.Union):
    ...
    AsyncFlippedLine = 0  # bit 18 to 32
...
class REG_PLANE_COLOR_CTL(ctypes.Union):
    ...
    Spare7 = 0  # bit 7 to 8
    Spare8 = 0  # bit 8 to 9
    DisallowCcValAsyncUpdate = 0  # bit 9 to 10
...
class ENUM_FIFO_EMPTY_WAKE(Enum):
    FIFO_EMPTY_WAKE_SEND_WAKE_WHEN_DUMMY_READ_HAS_RETURNED = 0x0
    FIFO_EMPTY_WAKE_SEND_WAKE_WHEN_FIFO_IS_EMPTY = 0x1
...
class _FBC_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('FifoEmptyWake', ctypes.c_uint32, 1),
