...
# --------------------------------------------------------------------------
#
# @file Gen14AudioCodecRegs.py
# @brief contains Gen14AudioCodecRegs.py related register definitions
...
class REG_AUD_CHICKENBIT_REG(ctypes.Union):
    ...
    Chicken1Spare11 = 0  # bit 11 to 12
    Chicken1Spare12 = 0  # bit 12 to 13
    CodecSleepOverwriteToDacfeunit = 0  # bit 13 to 14
    ...
    EnableDp1_2Features = 0  # bit 31 to 32
...
class REG_AUD_CHICKENBIT_REG_2(ctypes.Union):
    ...
    DacfpCdclockDelayToStartSilentStreamGeneration = 0  # bit 8 to 10
    DacfpDisableFakeFrameSyncGeneration = 0  # bit 10 to 11
    DacfpDisableKeepAliveD3Generation = 0  # bit 11 to 12
    DacfpIgnoreKeepAliveSetting = 0  # bit 12 to 13
    DacfpEnableKeepAliveForStreamId0 = 0  # bit 13 to 14
    DacfpExtraChickens = 0  # bit 14 to 16
    ...
    TimestampProgrammableDpSpecVersionFix = 0  # bit 20 to 21
    DacbeExtraChickenBit = 0  # bit 21 to 22
    TimestampDpEccFix = 0  # bit 22 to 23
    SilentStreamDpModeChangeFix = 0  # bit 23 to 24
    Disable8TModeFix = 0  # bit 24 to 25
    DacfeExtraChickens = 0  # bit 25 to 27
    LowerCdclocksSupport = 0  # bit 27 to 28
...
class REG_AUD_DP_2DOT0_CTRL(ctypes.Union):
    ...
    HblankEarlyClocks = 0  # bit 0 to 8
    GuardbandForHblankEnd = 0  # bit 8 to 24
    PauseGenerationAfterLineWrap = 0  # bit 24 to 26
    Spare26 = 0  # bit 26 to 27
    DisableGenerationOfNewHblanks = 0  # bit 27 to 28
    Spare30To28 = 0  # bit 28 to 31
    EnableSdpSplit = 0  # bit 31 to 32
