...
# --------------------------------------------------------------------------
#
# @file Dg3PchInterruptRegs.py
# @brief contains Dg3PchInterruptRegs.py related register definitions
...
class OFFSET_SHPD_PULSE_CNT:
    ...
    SHPD_PULSE_CNT_TC1 = 0xC4070
    SHPD_PULSE_CNT_TC2 = 0xC4074
    SHPD_PULSE_CNT_TC3 = 0xC4078
    SHPD_PULSE_CNT_TC4 = 0xC407C
    SHPD_PULSE_CNT_TC5 = 0xC4080
    SHPD_PULSE_CNT_DDID = 0xC4080
    SHPD_PULSE_CNT_TC6 = 0xC4084
    SHPD_PULSE_CNT_DDIE = 0xC4084
