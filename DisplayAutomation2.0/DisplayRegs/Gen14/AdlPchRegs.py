...
#
# @file AdlPchRegs.py
# @brief contains AdlPchRegs.py related register definitions
...
class ENUM_GMBUS_NUMERATOR_ADDER(Enum):
    GMBUS_NUMERATOR_ADDER_0 = 0x0
    GMBUS_NUMERATOR_ADDER_1 = 0x1
    GMBUS_NUMERATOR_ADDER_2 = 0x2
    GMBUS_NUMERATOR_ADDER_3 = 0x3
...
class _RAWCLK_FREQ(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('GmbusNumeratorAdder', ctypes.c_uint32, 2),
...
class REG_RAWCLK_FREQ(ctypes.Union):
    ...
    GmbusNumeratorAdder = 0  # bit 14 to 16
