...
# --------------------------------------------------------------------------
#
# @file Gen15HdcpRegs.py
# @brief contains Gen15HdcpRegs.py related register definitions
...
class REG_HDCP_KEY_CONF(ctypes.Union):
    ...
    DebugSelect = 0  # bit 2 to 3
    Reserved4 = 0  # bit 4 to 7
    KeyLoad = 0  # bit 8 to 8
    Reserved9 = 0  # bit 9 to 29
    ClearKeysTrigger = 0  # bit 30 to 30
    AksvSendTrigger = 0  # bit 31 to 31
...
class REG_HDCP_KEY_STATUS(ctypes.Union):
    ...
    KeyLoadDone = 0  # bit 0 to 0
    KeyLoadStatus = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 4
    FuseDone = 0  # bit 5 to 5
    FuseError = 0  # bit 6 to 6
    FuseInProgress = 0  # bit 7 to 7
...
class REG_HDCP_ANINIT(ctypes.Union):
    ...
    AnInitializationVector = 0  # bit 0 to 31
...
class REG_HDCP_STATUS(ctypes.Union):
    ...
    FrameCount = 0  # bit 8 to 15
    CipherStatus = 0  # bit 16 to 16
    AnReadyStatus = 0  # bit 17 to 17
    R0ReadyStatus = 0  # bit 18 to 18
    RiPrimeMatchStatus = 0  # bit 19 to 19
    LinkEncryptionStatus = 0  # bit 20 to 20
    AuthenticationStatus = 0  # bit 21 to 21
    Reserved22 = 0  # bit 22 to 27
    StreamEncryptionStatusD = 0  # bit 28 to 28
    StreamEncryptionStatusC = 0  # bit 29 to 29
    StreamEncryptionStatusB = 0  # bit 30 to 30
    StreamEncryptionStatusA = 0  # bit 31 to 31
...
class REG_HDCP_REP_CONTROL(ctypes.Union):
    ...
    Sha1Control = 0  # bit 1 to 3
    Reserved4 = 0  # bit 4 to 15
    Sha1Status = 0  # bit 16 to 19
    Sha1M0Select = 0  # bit 20 to 22
    Reserved23 = 0  # bit 23 to 27
    TranscoderDRepeaterPresent = 0  # bit 28 to 28
    TranscoderCRepeaterPresent = 0  # bit 29 to 29
    TranscoderBRepeaterPresent = 0  # bit 30 to 30
    TranscoderARepeaterPresent = 0  # bit 31 to 31
...
class REG_HDCP_SHA_VPRIME(ctypes.Union):
    ...
    VPrime0 = 0  # bit 0 to 31
    VPrime1 = 0  # bit 32 to 63
    VPrime2 = 0  # bit 64 to 95
    VPrime3 = 0  # bit 96 to 127
    VPrime4 = 0  # bit 128 to 159
...
class REG_HDCP2_CTL(ctypes.Union):
    ...
    VbidTypeSelect = 0  # bit 29 to 30
    LinkEncryptionRequest = 0  # bit 31 to 31
...
class REG_HDCP2_STATUS(ctypes.Union):
    ...
    LinkEncryptionStatus = 0  # bit 20 to 20
    LinkAuthenticationStatus = 0  # bit 21 to 21
    LinkTypeStatus = 0  # bit 22 to 22
...
class REG_HDCP2_AUTH(ctypes.Union):
    ...
    ClearKeys = 0  # bit 18 to 18
    ForceClearInputctr = 0  # bit 19 to 19
    Reserved20 = 0  # bit 20 to 29
    LinkType = 0  # bit 30 to 30
    LinkAuthenticated = 0  # bit 31 to 31
...
class ENUM_TYPE(Enum):
    TYPE_TYPE_0 = 0x0  # Type 0 content may be transmitted to any HDCP receiver.
    TYPE_TYPE_1 = 0x1  # Type 1 content must not be transmitted to HDCP 1.x or HDCP 2.0 receivers.


class OFFSET_HDCP2_AUTH_STREAM:
    HDCP2_AUTH_STREAM_TCA = 0x66F00
    HDCP2_AUTH_STREAM_TCB = 0x66F04
    HDCP2_AUTH_STREAM_TCC = 0x66F08
    HDCP2_AUTH_STREAM_TCD = 0x66F0C

class _HDCP2_AUTH_STREAM(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 31),
        ('Type', ctypes.c_uint32, 1),
    ]


class REG_HDCP2_AUTH_STREAM(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _HDCP2_AUTH_STREAM),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_HDCP2_AUTH_STREAM, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_HDCP2_SKEY(ctypes.Union):
    ...
    SessionKeyDword0 = 0  # bit 0 to 31
    SessionKeyDword1 = 0  # bit 32 to 63
    SessionKeyDword2 = 0  # bit 64 to 95
    SessionKeyDword3 = 0  # bit 96 to 127
...
class REG_HDCP2_STREAM_STATUS(ctypes.Union):
    ...
    StreamTypeStatus = 0  # bit 30 to 30
    StreamEncryptionStatus = 0  # bit 31 to 31
