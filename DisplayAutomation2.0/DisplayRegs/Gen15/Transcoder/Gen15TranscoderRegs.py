...
# --------------------------------------------------------------------------
#
# @file Gen15TranscoderRegs.py
# @brief contains Gen15TranscoderRegs.py related register definitions
...
class REG_TRANS_DDI_FUNC_CTL(ctypes.Union):
    ...
    HdmiScramblingEnabled = 0  # bit 0 to 0
    PortWidthSelection = 0  # bit 1 to 3
    HighTmdsCharRate = 0  # bit 4 to 4
    MultistreamHdcpSelect = 0  # bit 5 to 5
    HdmiScramblerResetFrequency = 0  # bit 6 to 6
    HdmiScramblerCtsEnable = 0  # bit 7 to 7
    DpVcPayloadAllocate = 0  # bit 8 to 8
    HdmiDviHdcpSignaling = 0  # bit 9 to 9
    MstTransportSelect = 0  # bit 10 to 11
    DsiInputSelect = 0  # bit 12 to 14
    Reserved15 = 0  # bit 15 to 15
    SyncPolarity = 0  # bit 16 to 17
    Reserved18 = 0  # bit 18 to 19
    BitsPerColor = 0  # bit 20 to 22
    Reserved23 = 0  # bit 23 to 23
    TransDdiModeSelect = 0  # bit 24 to 26
    DdiSelect = 0  # bit 27 to 30
    TransDdiFunctionEnable = 0  # bit 31 to 31
...
class REG_TRANS_DDI_FUNC_CTL2(ctypes.Union):
    ...
    PortSyncModeMasterSelect = 0  # bit 0 to 2
    CmtgSlaveMode = 0  # bit 3 to 3
    PortSyncModeEnable = 0  # bit 4 to 4
    DualPipeSyncEnable = 0  # bit 5 to 5
    AudioMuteOverride = 0  # bit 6 to 7
    DoubleBufferVactive = 0  # bit 8 to 8
    Reserved9 = 0  # bit 9 to 28
    GenlockMode = 0  # bit 29 to 30
    GenlockEnable = 0  # bit 31 to 31
...
class REG_TRANS_CONF(ctypes.Union):
    ...
    EarlyPixelCountScaling = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 6
    StopFrameEnable = 0  # bit 7 to 7
    StopFrameCount = 0  # bit 8 to 11
    Reserved12 = 0  # bit 12 to 20
    InterlacedMode = 0  # bit 21 to 22
    Reserved23 = 0  # bit 23 to 29
    TranscoderState = 0  # bit 30 to 30
    TranscoderEnable = 0  # bit 31 to 31
...
class REG_TRANS_CLK_SEL(ctypes.Union):
    ...
    TransClockSelect = 0  # bit 28 to 31
...
class REG_TRANS_MSA_MISC(ctypes.Union):
    ...
    MsaMisc0 = 0  # bit 0 to 7
    MsaMisc1 = 0  # bit 8 to 15
    MsaUnused = 0  # bit 16 to 31
...
class REG_DATAM(ctypes.Union):
    ...
    DataMValue = 0  # bit 0 to 23
    Reserved24 = 0  # bit 24 to 24
    TuOrVcpayloadSize = 0  # bit 25 to 30
...
class OFFSET_LINKM:
    ...
    TRANS_LINKM1_CMTG0 = 0x6F040
    TRANS_LINKM1_CMTG1 = 0x6F140
...
class REG_LINKM(ctypes.Union):
    ...
    LinkMValue = 0  # bit 0 to 23
    ExtendedLinkMValue = 0  # bit 24 to 31
...
class REG_LINKN(ctypes.Union):
    ...
    LinkNValue = 0  # bit 0 to 23
    ExtendedLinkNValue = 0  # bit 24 to 31
...
class REG_TRANS_HTOTAL(ctypes.Union):
    ...
    HorizontalActive = 0  # bit 0 to 13
    Reserved14 = 0  # bit 14 to 15
    HorizontalTotal = 0  # bit 16 to 29
...
class OFFSET_TRANS_HBLANK:
    ...
    TRANS_HBLANK_CMTG0 = 0x6F004
    TRANS_HBLANK_CMTG1 = 0x6F104
...
class REG_TRANS_HBLANK(ctypes.Union):
    ...
    HorizontalBlankStart = 0  # bit 0 to 13
    Reserved14 = 0  # bit 14 to 15
    HorizontalBlankEnd = 0  # bit 16 to 29
    Reserved30 = 0  # bit 30 to 31
...
class REG_TRANS_HSYNC(ctypes.Union):
    ...
    HorizontalSyncStart = 0  # bit 0 to 13
    Reserved14 = 0  # bit 14 to 15
    HorizontalSyncEnd = 0  # bit 16 to 29
    Reserved30 = 0  # bit 30 to 31
...
class OFFSET_TRANS_VTOTAL:
    ...
    TRANS_VTOTAL_CMTG0 = 0x6F00C
    TRANS_VTOTAL_CMTG1 = 0x6F10C
...
class REG_TRANS_VTOTAL(ctypes.Union):
    ...
    VerticalActive = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    VerticalTotal = 0  # bit 16 to 28
...
class REG_TRANS_VBLANK(ctypes.Union):
    ...
    VerticalBlankStart = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    VerticalBlankEnd = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 31
...
class OFFSET_TRANS_VSYNC:
    ...
    TRANS_VSYNC_CMTG0 = 0x6F014
    TRANS_VSYNC_CMTG1 = 0x6F114
...
class REG_TRANS_VSYNC(ctypes.Union):
    ...
    VerticalSyncStart = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    VerticalSyncEnd = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_TRANS_VSYNCSHIFT(ctypes.Union):
    ...
    SecondFieldVsyncShift = 0  # bit 0 to 12
...
class REG_TRANS_MULT(ctypes.Union):
    ...
    Multiplier = 0  # bit 0 to 2
    Reserved3 = 0  # bit 3 to 31
...
class REG_TRANS_SPACE(ctypes.Union):
    ...
    VerticalActiveSpace = 0  # bit 0 to 11
...
class ENUM_VSC_SELECT(Enum):
    VSC_SELECT_HEADER_AND_DATA = 0x0  # Hardware controls all headers bytes. Hardware controls data bytes 0-13. Softwar
                                      # e controls data bytes 14+. Recommended for use when PSR is enabled and software
                                      # is not using VSC for other types of data.
    VSC_SELECT_HEADER_ONLY = 0x1  # Hardware controls all headers bytes. Software controls all data bytes. Not recommen
                                  # ded for use.
    VSC_SELECT_DATA_ONLY = 0x2  # Software controls all headers bytes. Hardware controls data bytes 0-13. Software cont
                                # rols data bytes 14+. Recommended for use when software is sending data with VSC. If
                                # PSR is enabled, software must configure the header to include the PSR revision and
                                # byte count.
    VSC_SELECT_NONE = 0x3  # Software controls all headers bytes. Software controls all data bytes. Not recommended for
                           #  use.
...
class   REG_VIDEO_DIP_CTL(ctypes.Union):
    ...
    VdipEnableSpd = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 3
    VdipEnableGmp = 0  # bit 4 to 4
    Reserved5 = 0  # bit 5 to 7
    VdipEnableVs = 0  # bit 8 to 8
    Reserved9 = 0  # bit 9 to 11
    VdipEnableAvi = 0  # bit 12 to 12
    Reserved13 = 0  # bit 13 to 15
    VdipEnableGcp = 0  # bit 16 to 16
    Reserved17 = 0  # bit 17 to 19
    VdipEnableVsc = 0  # bit 20 to 20
    Reserved21 = 0  # bit 21 to 21
    Enable16BitCrcResultInSdp = 0  # bit 22 to 22
    AdaptiveSyncSdpEnable = 0  # bit 23 to 23
    VdipEnablePps = 0  # bit 24 to 24
    VscSelect = 0  # bit 25 to 26
    PsrPsr2VscBit7 = 0  # bit 27 to 27
    DrmDipEnable = 0  # bit 28 to 28
    GmpVscAviDrmDoubleBufferDisable = 0  # bit 29 to 29
    AllowDbStall = 0  # bit 30 to 30
    DisableSdpCrc = 0  # bit 31 to 31
...
class REG_VIDEO_DIP_GCP(ctypes.Union):
    ...
    GcpAvMute = 0  # bit 0 to 0
    GcpDefaultPhaseEnable = 0  # bit 1 to 1
    GcpColorIndication = 0  # bit 2 to 2
    Reserved3 = 0  # bit 3 to 31
...
class OFFSET_TRANS_VRR_VMIN:
    ...
    TRANS_VRR_VMIN_CMTG0 = 0x6F434
    TRANS_VRR_VMIN_CMTG1 = 0x6F534
...
class OFFSET_TRANS_VRR_VMAX:
    ...
    TRANS_VRR_VMAX_CMTG0 = 0x6F424
    TRANS_VRR_VMAX_CMTG1 = 0x6F524
...
class ENUM_ADAPTIVE_SYNC_CFG_SELECT(Enum):
    ADAPTIVE_SYNC_CFG_SELECT_STATIC = 0x0
    ADAPTIVE_SYNC_CFG_SELECT_DYNAMIC = 0x1
...
class ENUM_CMRR_ENABLE(Enum):
    CMRR_DISABLE = 0x0
    CMRR_ENABLE = 0x1


class ENUM_DCB_ADJ_ENABLE(Enum):
    DCB_ADJ_DISABLE = 0x0
    DCB_ADJ_ENABLE = 0x1
...
class _TRANS_VRR_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('AdaptiveSyncCfgSelect', ctypes.c_uint32, 1),
        ('AdaptiveSyncStatus', ctypes.c_uint32, 1),
        ('Cmrr_Enable', ctypes.c_uint32, 1),
        ('Dcb_Adj_Enable', ctypes.c_uint32, 1),
...
class REG_TRANS_VRR_CTL(ctypes.Union):
    ...
    VrrGuardband = 0  # bit 0 to 15
    Reserved16 = 0  # bit 16 to 24
    AdaptiveSyncCfgSelect = 0  # bit 25 to 25
    AdaptiveSyncStatus = 0  # bit 26 to 26
    Cmrr_Enable = 0  # bit 27 to 27
    Dcb_Adj_Enable = 0  # bit 28 to 28
    FlipLineEnable = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 30
    VrrEnable = 0  # bit 31 to 31
...
class REG_TRANS_VRR_STATUS(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 19
    CurrentRegionInVblank = 0  # bit 20 to 22
    Reserved23 = 0  # bit 23 to 26
    VrrEnableLive = 0  # bit 27 to 27
    Reserved28 = 0  # bit 28 to 30
    VmaxReached = 0  # bit 31 to 31
...
class OFFSET_TRANS_VRR_VTOTAL_PREV:
    ...
    TRANS_VRR_VTOTAL_PREV_CMTG0 = 0x6F480
    TRANS_VRR_VTOTAL_PREV_CMTG1 = 0x6F580
...
class OFFSET_TRANS_VRR_FLIPLINE_DCB:
    TRANS_VRR_FLIPLINE_DCB_A = 0x60418
    TRANS_VRR_FLIPLINE_DCB_B = 0x61418
    TRANS_VRR_FLIPLINE_DCB_C = 0x62418
    TRANS_VRR_FLIPLINE_DCB_D = 0x63418
    TRANS_VRR_FLIPLINE_DCB_CMTG0 = 0x6F474
    TRANS_VRR_FLIPLINE_DCB_CMTG1 = 0x6F574

class _TRANS_VRR_FLIPLINE_DCB(ctypes.LittleEndianStructure):
    _fields_ = [
        ('VrrDcbFlipline', ctypes.c_uint32, 20),
        ('Reserved20', ctypes.c_uint32, 12),
    ]

class REG_TRANS_VRR_FLIPLINE_DCB(ctypes.Union):
    value = 0
    offset = 0

    VrrDcbFlipline = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_VRR_FLIPLINE_DCB),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_VRR_FLIPLINE_DCB, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value

class OFFSET_TRANS_VRR_VMAX_DCB:
    TRANS_VRR_VMAX_DCB_A = 0x60414
    TRANS_VRR_VMAX_DCB_B = 0x61414
    TRANS_VRR_VMAX_DCB_C = 0x62414
    TRANS_VRR_VMAX_DCB_D = 0x63414
    TRANS_VRR_VMAX_DCB_E = 0x6B414
    TRANS_VRR_VMAX_DCB_F = 0x6C414
    TRANS_VRR_VMAX_DCB_CMTG0 = 0x6F470
    TRANS_VRR_VMAX_DCB_CMTG1 = 0x6F570

class _TRANS_VRR_VMAX_DCB(ctypes.LittleEndianStructure):
    _fields_ = [
        ('VrrDcbVmax', ctypes.c_uint32, 20),
        ('Reserved20', ctypes.c_uint32, 12),
    ]

class REG_TRANS_VRR_VMAX_DCB(ctypes.Union):
    value = 0
    offset = 0

    VrrDcbVmax = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_VRR_VMAX_DCB),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_VRR_VMAX_DCB, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_TRANS_VRR_STATUS2:
    ...
    TRANS_VRR_STATUS2_CMTG0 = 0x6F43C
    TRANS_VRR_STATUS2_CMTG1 = 0x6F53C
...
class REG_TRANS_VRR_STATUS2(ctypes.Union):
    ...
    VerticalLineCounterStatus = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 31
...
class OFFSET_TRANS_CMRR_M_HI:
    TRANS_CMRR_M_HI_A = 0x604F4
    TRANS_CMRR_M_HI_B = 0x614F4
    TRANS_CMRR_M_HI_C = 0x624F4
    TRANS_CMRR_M_HI_D = 0x634F4
    TRANS_CMRR_M_HI_CMTG0 = 0x6F4F4
    TRANS_CMRR_M_HI_CMTG1 = 0x6F5F4

class _TRANS_CMRR_M_HI(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Cmrr_M_High', ctypes.c_uint32, 32),
    ]


class REG_TRANS_CMRR_M_HI(ctypes.Union):
    value = 0
    offset = 0

    Cmrr_M_High = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_CMRR_M_HI),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_CMRR_M_HI, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_TRANS_CMRR_N_HI:
    TRANS_CMRR_N_HI_A = 0x604FC
    TRANS_CMRR_N_HI_B = 0x614FC
    TRANS_CMRR_N_HI_C = 0x624FC
    TRANS_CMRR_N_HI_D = 0x634FC
    TRANS_CMRR_N_HI_CMTG0 = 0x6F4FC
    TRANS_CMRR_N_HI_CMTG1 = 0x6F5FC

class _TRANS_CMRR_N_HI(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Cmrr_N_High', ctypes.c_uint32, 32),
    ]


class REG_TRANS_CMRR_N_HI(ctypes.Union):
    value = 0
    offset = 0

    Cmrr_N_High = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_CMRR_N_HI),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_CMRR_N_HI, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_TRANS_CMRR_M_LO:
    TRANS_CMRR_M_LO_A = 0x604F0
    TRANS_CMRR_M_LO_B = 0x614F0
    TRANS_CMRR_M_LO_C = 0x624F0
    TRANS_CMRR_M_LO_D = 0x634F0
    TRANS_CMRR_M_LO_CMTG0 = 0x6F4F0
    TRANS_CMRR_M_LO_CMTG1 = 0x6F5F0

class _TRANS_CMRR_M_LO(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Cmrr_M_Low', ctypes.c_uint32, 32),
    ]


class REG_TRANS_CMRR_M_LO(ctypes.Union):
    value = 0
    offset = 0

    Cmrr_M_Low = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_CMRR_M_LO),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_CMRR_M_LO, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_CMTG_CONFIGURATION(Enum):
    CMTG_CONFIGURATION_PRIMARY = 0x0
    CMTG_CONFIGURATION_SECONDARY = 0x1
...
class REG_TRANS_CMTG_CTL(ctypes.Union):
    ...
    DbVactive = 0  # bit 0 to 0
    HoldPllConfig = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 22
    CmtgState = 0  # bit 23 to 23
    Reserved24 = 0  # bit 24 to 29
    CmtgConfiguration = 0  # bit 30 to 30
    CmtgEnable = 0  # bit 31 to 31
...
class ENUM_ENABLE_IDLE_DETECTION_FOR_CMTG_CLOCK(Enum):
    ENABLE_IDLE_DETECTION_FOR_CMTG_CLOCK_DISABLE = 0x0
    ENABLE_IDLE_DETECTION_FOR_CMTG_CLOCK_ENABLE = 0x1


class ENUM_REF_ON_CMTG_CLOCK_ENABLE(Enum):
    REF_ON_CMTG_CLOCK_DISABLE = 0x0
    REF_ON_CMTG_CLOCK_ENABLE = 0x1


class OFFSET_TRANS_CMTG_CHICKEN:
    TRANS_CMTG_CHICKEN_CMTG0 = 0x6FA90
    TRANS_CMTG_CHICKEN_CMTG1 = 0x6FB90

class _TRANS_CMTG_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Spare0', ctypes.c_uint32, 1),
        ('Spare1', ctypes.c_uint32, 1),
        ('EnableIdleDetectionForCmtgClock', ctypes.c_uint32, 1),
        ('RefOnCmtgClockEnable', ctypes.c_uint32, 1),
...
class REG_TRANS_CMTG_CHICKEN(ctypes.Union):
    ...
    Spare0 = 0  # bit 0 to 0
    Spare1 = 0  # bit 1 to 1
    EnableIdleDetectionForCmtgClock = 0  # bit 2 to 2
    RefOnCmtgClockEnable = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
    Spare6 = 0  # bit 6 to 6
    Spare7 = 0  # bit 7 to 7
...
class REG_TRANS_PUSH(ctypes.Union):
    ...
    SendPush = 0  # bit 30 to 30
    PushEnable = 0  # bit 31 to 31
...
class REG_TRANS_ADAPTIVE_SYNC_DCB_CTL(ctypes.Union):
    ...
    EvenLineCounterOverflow = 0  # bit 12 to 12
    OddLineCounterOverflow = 0  # bit 13 to 13
    EvenFrameCounterOverflow = 0  # bit 14 to 14
    OddFrameCounterOverflow = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 29
    AdaptiveSyncCounterReset = 0  # bit 30 to 30
    AdaptiveSyncCounterEnable = 0  # bit 31 to 31
...
class REG_TRANS_ADAPTIVE_SYNC_DCB_EVEN_COUNT(ctypes.Union):
    ...
    AdaptiveSyncDcBalanceEvenFrameLineCount = 0  # bit 0 to 23
    AdaptiveSyncDcBalanceEvenFrameCount = 0  # bit 24 to 31
...
class REG_TRANS_ADAPTIVE_SYNC_DCB_ODD_COUNT(ctypes.Union):
    ...
    AdaptiveSyncDcBalanceOddFrameLineCount = 0  # bit 0 to 23
    AdaptiveSyncDcBalanceOddFrameCount = 0  # bit 24 to 31
...
class REG_TRANS_ADAPTIVE_SYNC_DCB_EVEN_COUNT_LIVE(ctypes.Union):
    ...
    AdaptiveSyncDcBalanceEvenLineCountLive = 0  # bit 0 to 23
    AdaptiveSyncDcBalanceEvenFrameCountLive = 0  # bit 24 to 31
...
class REG_TRANS_ADAPTIVE_SYNC_DCB_ODD_COUNT_LIVE(ctypes.Union):
    ...
    AdaptiveSyncDcBalanceOddLineCountLive = 0  # bit 0 to 23
    AdaptiveSyncDcBalanceOddFrameCountLive = 0  # bit 24 to 31
...
class OFFSET_TRANS_VRR_DCB_ADJ_FLIPLINE_CFG:
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_A = 0x604D4
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_B = 0x614D4
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_C = 0x624D4
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_D = 0x634D4
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_CMTG0 = 0x6F4D4
    TRANS_VRR_DCB_ADJ_FLIPLINE_CFG_CMTG1 = 0x6F5D4

class _TRANS_VRR_DCB_ADJ_FLIPLINE_CFG(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Trans_Vrr_Dcb_Adj_Flipline', ctypes.c_uint32, 20),
        ('Reserved20', ctypes.c_uint32, 4),
        ('Trans_Vrr_Dcb_Adj_Flipline_Cnt', ctypes.c_uint32, 8),
    ]


class REG_TRANS_VRR_DCB_ADJ_FLIPLINE_CFG(ctypes.Union):
    value = 0
    offset = 0

    Trans_Vrr_Dcb_Adj_Flipline = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 23
    Trans_Vrr_Dcb_Adj_Flipline_Cnt = 0  # bit 24 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_VRR_DCB_ADJ_FLIPLINE_CFG),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_VRR_DCB_ADJ_FLIPLINE_CFG, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_TRANS_VRR_DCB_ADJ_VMAX_CFG:
    TRANS_VRR_DCB_ADJ_VMAX_CFG_A = 0x604D8
    TRANS_VRR_DCB_ADJ_VMAX_CFG_B = 0x614D8
    TRANS_VRR_DCB_ADJ_VMAX_CFG_C = 0x624D8
    TRANS_VRR_DCB_ADJ_VMAX_CFG_D = 0x634D8
    TRANS_VRR_DCB_ADJ_VMAX_CFG_CMTG0 = 0x6F4D8
    TRANS_VRR_DCB_ADJ_VMAX_CFG_CMTG1 = 0x6F5D8

class _TRANS_VRR_DCB_ADJ_VMAX_CFG(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Trans_Vrr_Dcb_Adj_Vmax', ctypes.c_uint32, 20),
        ('Reserved20', ctypes.c_uint32, 4),
        ('Trans_Vrr_Dcb_Adj_Vmax_Cnt', ctypes.c_uint32, 8),
    ]


class REG_TRANS_VRR_DCB_ADJ_VMAX_CFG(ctypes.Union):
    value = 0
    offset = 0

    Trans_Vrr_Dcb_Adj_Vmax = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 23
    Trans_Vrr_Dcb_Adj_Vmax_Cnt = 0  # bit 24 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_VRR_DCB_ADJ_VMAX_CFG),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_VRR_DCB_ADJ_VMAX_CFG, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_TRANS_DP2_CTL(ctypes.Union):
    ...
    Dp2Debug = 0  # bit 23 to 23
    Reserved24 = 0  # bit 24 to 29
    PanelReplayEnable = 0  # bit 30 to 30
    _128B_132B_Channel_Coding = 0  # bit 31 to 31
...
class OFFSET_TRANS_DCSTATE_STATUS:
    TRANS_DCSTATE_STATUS_A = 0x60914
    TRANS_DCSTATE_STATUS_B = 0x61914

class _TRANS_DCSTATE_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ('TranscoderDcIdle', ctypes.c_uint32, 1),
        ('Reserved1', ctypes.c_uint32, 3),
        ('IdleNotAllowed', ctypes.c_uint32, 1),
        ('AsSdpTransmissionInPrActiveEnabled', ctypes.c_uint32, 1),
        ('Reserved6', ctypes.c_uint32, 10),
        ('PsrEnabled', ctypes.c_uint32, 1),
        ('Psr2Enabled', ctypes.c_uint32, 1),
        ('PrWithAlpmEnabled', ctypes.c_uint32, 1),
        ('LobfEnabled', ctypes.c_uint32, 1),
        ('Reserved20', ctypes.c_uint32, 9),
        ('Dc6Enabled', ctypes.c_uint32, 1),
        ('Dc6VEnabled', ctypes.c_uint32, 1),
        ('DcClockOffEnabled', ctypes.c_uint32, 1),
    ]


class REG_TRANS_DCSTATE_STATUS(ctypes.Union):
    value = 0
    offset = 0

    TranscoderDcIdle = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 3
    IdleNotAllowed = 0  # bit 4 to 4
    AsSdpTransmissionInPrActiveEnabled = 0  # bit 5 to 5
    Reserved6 = 0  # bit 6 to 15
    PsrEnabled = 0  # bit 16 to 16
    Psr2Enabled = 0  # bit 17 to 17
    PrWithAlpmEnabled = 0  # bit 18 to 18
    LobfEnabled = 0  # bit 19 to 19
    Reserved20 = 0  # bit 20 to 28
    Dc6Enabled = 0  # bit 29 to 29
    Dc6VEnabled = 0  # bit 30 to 30
    DcClockOffEnabled = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TRANS_DCSTATE_STATUS),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TRANS_DCSTATE_STATUS, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_DP_TP_CTL(ctypes.Union):
    ...
    AlternateSrEnable = 0  # bit 6 to 6
    ScramblingDisable = 0  # bit 7 to 7
    DpLinkTrainingEnable = 0  # bit 8 to 10
    Reserved11 = 0  # bit 11 to 17
    EnhancedFramingEnable = 0  # bit 18 to 18
    TrainingPattern4Select = 0  # bit 19 to 20
    Reserved21 = 0  # bit 21 to 24
    ForceAct = 0  # bit 25 to 25
    Reserved26 = 0  # bit 26 to 26
    TransportModeSelect = 0  # bit 27 to 27
    Reserved28 = 0  # bit 28 to 29
    FecEnable = 0  # bit 30 to 30
    TransportEnable = 0  # bit 31 to 31
...
class REG_DP_TP_STATUS(ctypes.Union):
    ...
    PayloadMappingVc0 = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 3
    PayloadMappingVc1 = 0  # bit 4 to 5
    Reserved6 = 0  # bit 6 to 7
    PayloadMappingVc2 = 0  # bit 8 to 9
    Reserved10 = 0  # bit 10 to 11
    PayloadMappingVc3 = 0  # bit 12 to 13
    Reserved14 = 0  # bit 14 to 15
    StreamsEnabled = 0  # bit 16 to 18
    DpInitStatus = 0  # bit 19 to 21
    DpStreamStatus = 0  # bit 22 to 22
    ModeStatus = 0  # bit 23 to 23
    ActSentStatus = 0  # bit 24 to 24
    MinIdlesSent = 0  # bit 25 to 25
    ActiveLinkFrameStatus = 0  # bit 26 to 26
    IdleLinkFrameStatus = 0  # bit 27 to 27
    FecEnableLiveStatus = 0  # bit 28 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_DP_COMP_CTL(ctypes.Union):
    ...
    Hbr2ScramblerReset = 0  # bit 0 to 15
    Reserved16 = 0  # bit 16 to 27
    LinkQualPatternSet = 0  # bit 28 to 30
    TestPatternEnable = 0  # bit 31 to 31
...
class REG_DP_COMP_PAT(ctypes.Union):
    ...
    CompliancePattern310 = 0  # bit 0 to 31
    CompliancePattern6332 = 0  # bit 32 to 63
    CompliancePattern7964 = 0  # bit 64 to 79
    Reserved80 = 0  # bit 80 to 95
...
class REG_SRD_CTL(ctypes.Union):
    ...
    IdleFrames = 0  # bit 0 to 3
    Tp1Time = 0  # bit 4 to 5
    Tp4Time = 0  # bit 6 to 7
    Tp2Tp3Time = 0  # bit 8 to 9
    CrcEnable = 0  # bit 10 to 10
    Tp2Tp3Select = 0  # bit 11 to 11
    SkipAuxOnExit = 0  # bit 12 to 12
    Tps4Control = 0  # bit 13 to 13
    Reserved14 = 0  # bit 14 to 19
    MaxSleepTime = 0  # bit 20 to 24
    Reserved25 = 0  # bit 25 to 26
    LinkCtrl = 0  # bit 27 to 27
    Reserved28 = 0  # bit 28 to 28
    ContextRestoreToPsrActive = 0  # bit 29 to 29
    SingleFrameUpdateEnable = 0  # bit 30 to 30
    SrdEnable = 0  # bit 31 to 31
...
class REG_SRD_STATUS(ctypes.Union):
    ...
    IdleFrameCounter = 0  # bit 0 to 3
    SendingTp1 = 0  # bit 4 to 4
    Reserved5 = 0  # bit 5 to 6
    SendingTp4 = 0  # bit 7 to 7
    SendingTp2Tp3 = 0  # bit 8 to 8
    SendingIdle = 0  # bit 9 to 9
    Reserved10 = 0  # bit 10 to 11
    Reserved12 = 0  # bit 12 to 12
    Reserved13 = 0  # bit 13 to 14
    Reserved15 = 0  # bit 15 to 15
    SrdEntryCount = 0  # bit 16 to 19
    MaxSleepTimeCounter = 0  # bit 20 to 24
    Reserved25 = 0  # bit 25 to 25
    LinkStatus = 0  # bit 26 to 27
    Reserved28 = 0  # bit 28 to 28
    SrdState = 0  # bit 29 to 31
...
class REG_PSR_DEBUG(ctypes.Union):
    ...
    PsrReduceCount = 0  # bit 0 to 0
    SrdEntryCompletion = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 6
    IdleCount = 0  # bit 7 to 7
    Reserved8 = 0  # bit 8 to 16
    CsrDelayTime = 0  # bit 17 to 26
    CsrDelayEnable = 0  # bit 27 to 27
    ResetIdleFrameCount = 0  # bit 28 to 28
    EntryHint = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 31
...
class REG_PSR_EVENT(ctypes.Union):
    ...
    SrdDisable = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 1
    VbiEnable = 0  # bit 2 to 2
    KvmrSessionEnable = 0  # bit 3 to 3
    HdcpEnable = 0  # bit 4 to 4
    Reserved5 = 0  # bit 5 to 5
    PipeRegistersUpdate = 0  # bit 6 to 6
    Reserved7 = 0  # bit 7 to 7
    WatchDogTimerExpire = 0  # bit 8 to 8
    Reserved9 = 0  # bit 9 to 9
    MemoryUp = 0  # bit 10 to 10
    PchInterrupt = 0  # bit 11 to 11
    GraphicsReset = 0  # bit 12 to 12
    Reserved13 = 0  # bit 13 to 14
    Reserved15 = 0  # bit 15 to 15
    Psr2Disable = 0  # bit 16 to 16
...
class REG_PSR_MASK(ctypes.Union):
    ...
    Reserved1 = 0  # bit 1 to 14
    ExitOnPixelUnderrun = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 23
    Reserved24 = 0  # bit 24 to 24
    MaskHotplug = 0  # bit 25 to 25
    MaskMemup = 0  # bit 26 to 26
    Reserved27 = 0  # bit 27 to 27
    MaskMaxSleep = 0  # bit 28 to 28
    Reserved29 = 0  # bit 29 to 29
    IdleFrameOverride = 0  # bit 30 to 31
...
class ENUM_ENABLE_EARLY_TRANSPORT(Enum):
    ENABLE_EARLY_TRANSPORT_ENABLE = 0x1
    ENABLE_EARLY_TRANSPORT_DISABLE = 0x0
...
class REG_PSR2_CTL(ctypes.Union):
    ...
    IdleFrames = 0  # bit 0 to 3
    FramesBeforeSuEntry = 0  # bit 4 to 7
    Tp2Time = 0  # bit 8 to 9
    FastWake = 0  # bit 10 to 12
    IoBufferWake = 0  # bit 13 to 18
    Reserved19 = 0  # bit 19 to 19
    MaxSuDisableTime = 0  # bit 20 to 24
    SuSdpScanlineIndication = 0  # bit 25 to 25
    Reserved26 = 0  # bit 26 to 26
    EnableEarlyTransport = 0  # bit 27 to 27
    Reserved28 = 0  # bit 28 to 28
    ContextRestoreToPsr2DeepSleepState = 0  # bit 29 to 29
    RestoreToSleep = 0  # bit 30 to 30
    Psr2Enable = 0  # bit 31 to 31
...
class REG_PSR2_MAN_TRK_CTL(ctypes.Union):
    ...
    SuRegionEndAddress = 0  # bit 0 to 12
    SfContinuousFullFrame = 0  # bit 13 to 13
    SfSingleFullFrame = 0  # bit 14 to 14
    Reserved15 = 0  # bit 15 to 15
    SuRegionStartAddress = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 29
    AllowDbStall = 0  # bit 30 to 30
    SfPartialFrameEnable = 0  # bit 31 to 31
...
class REG_PSR2_STATUS(ctypes.Union):
    ...
    IdleFrameCounter = 0  # bit 0 to 3
    Psr2SuEntryCompletion = 0  # bit 4 to 4
    Psr2DeepSleepEntryCompletion = 0  # bit 5 to 5
    Reserved6 = 0  # bit 6 to 7
    SendingTp2 = 0  # bit 8 to 8
    Psr2IdleFrameIndication = 0  # bit 9 to 9
    IdleNotAllowed = 0  # bit 10 to 10
    Psr2NotAllowed = 0  # bit 11 to 11
    Reserved12 = 0  # bit 12 to 15
    Psr2DeepSleepEntryCount = 0  # bit 16 to 19
    MaxSleepTimeCounter = 0  # bit 20 to 24
    Reserved25 = 0  # bit 25 to 25
    LinkStatus = 0  # bit 26 to 27
    Psr2State = 0  # bit 28 to 31
...
class REG_PSR_IMR(ctypes.Union):
    ...
    MaskPsrPrewarn = 0  # bit 0 to 0
    MaskPsrExit = 0  # bit 1 to 1
    MaskPsrAuxError = 0  # bit 2 to 2
    MaskPushDone = 0  # bit 3 to 3
...
class REG_PSR_IIR(ctypes.Union):
    ...
    PsrPrewarn = 0  # bit 0 to 0
    PsrExit = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 2
    PushDone = 0  # bit 3 to 3
    Reserved4 = 0  # bit 4 to 31
...
class ENUM_EXTENDED_FAST_WAKE_TIME(Enum):
    EXTENDED_FAST_WAKE_TIME_7_LINES = 0x2


class ENUM_AUX_WAKE_SLEEP_HOLD_ENABLE(Enum):
    AUX_WAKE_SLEEP_HOLD_DISABLED = 0x0  # Transcoder will only transmit ML_PHY_SLEEP sequences
    AUX_WAKE_SLEEP_HOLD_ENABLED = 0x1  # Transcoder will transmit zeroes after 4 ML_PHY_SLEEP sequences


class ENUM_AUX_LESS_SLEEP_HOLD_TIME(Enum):
    AUX_LESS_SLEEP_HOLD_TIME_50_SYMBOLS = 0x0  # Minimum per eDP 1.5 specification
    AUX_LESS_SLEEP_HOLD_TIME_128_SYMBOLS = 0x1
    AUX_LESS_SLEEP_HOLD_TIME_256_SYMBOLS = 0x2
    AUX_LESS_SLEEP_HOLD_TIME_512_SYMBOLS = 0x3


class ENUM_RESTORE_TO_DEEP_SLEEP(Enum):
    RESTORE_TO_DEEP_SLEEP_NO_DEEP_SLEEP_RESTORE = 0x0
    RESTORE_TO_DEEP_SLEEP_DEEP_SLEEP_RESTORE = 0x1


class ENUM_EXTENDED_FAST_WAKE_ENABLE(Enum):
    EXTENDED_FAST_WAKE_DISABLED = 0x0  # PSR2_CTL[ Fast Wake ] used for non-PSR1 AUX-Wake flows
    EXTENDED_FAST_WAKE_ENABLED = 0x1  # ALPM_CTL[ Extended Fast Wake Time ] used fornon-PSR1 AUX-Wake flows
...
class ENUM_ALPM_ENABLE(Enum):
    ALPM_DISABLED = 0x0  # PR on DP
    ALPM_ENABLED = 0x1  # PR on eDP


class OFFSET_ALPM_CTL:
    ALPM_CTL_A = 0x60950
    ALPM_CTL_B = 0x61950

class _ALPM_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AuxLessWakeTime', ctypes.c_uint32, 6),
        ('Reserved6', ctypes.c_uint32, 2),
        ('ExtendedFastWakeTime', ctypes.c_uint32, 6),
        ('Reserved14', ctypes.c_uint32, 2),
        ('AlpmEntryCheck', ctypes.c_uint32, 4),
        ('AuxWakeSleepHoldEnable', ctypes.c_uint32, 1),
        ('AuxLessSleepHoldTime', ctypes.c_uint32, 3),
        ('RestoreToDeepSleep', ctypes.c_uint32, 1),
        ('RestoreToSleep', ctypes.c_uint32, 1),
        ('Reserved26', ctypes.c_uint32, 2),
        ('ExtendedFastWakeEnable', ctypes.c_uint32, 1),
        ('LinkOffBetweenFramesEnable', ctypes.c_uint32, 1),
        ('AlpmAuxLessEnable', ctypes.c_uint32, 1),
        ('AlpmEnable', ctypes.c_uint32, 1),
    ]


class REG_ALPM_CTL(ctypes.Union):
    value = 0
    offset = 0

    AuxLessWakeTime = 0  # bit 0 to 5
    Reserved6 = 0  # bit 6 to 7
    ExtendedFastWakeTime = 0  # bit 8 to 13
    Reserved14 = 0  # bit 14 to 15
    AlpmEntryCheck = 0  # bit 16 to 19
    AuxWakeSleepHoldEnable = 0  # bit 20 to 20
    AuxLessSleepHoldTime = 0  # bit 21 to 23
    RestoreToDeepSleep = 0  # bit 24 to 24
    RestoreToSleep = 0  # bit 25 to 25
    Reserved26 = 0  # bit 26 to 27
    ExtendedFastWakeEnable = 0  # bit 28 to 28
    LinkOffBetweenFramesEnable = 0  # bit 29 to 29
    AlpmAuxLessEnable = 0  # bit 30 to 30
    AlpmEnable = 0  # bit 31 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_ALPM_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_ADAPTIVE_SYNC_SDP_POSITION(Enum):
    ADAPTIVE_SYNC_SDP_POSITION_T1_OR_T2 = 0x0  # Position based off of AS SDP DB0[1:0] programming
    ADAPTIVE_SYNC_SDP_POSITION_T1_ALWAYS = 0x1
    ADAPTIVE_SYNC_SDP_POSITION_T2_ALWAYS = 0x2


class ENUM_AS_SDP_TRANSMISSION_DISABLED_IN_ACTIVE(Enum):
    AS_SDP_TRANSMISSION_DISABLED_IN_ACTIVE_ENABLED = 0x0
    AS_SDP_TRANSMISSION_DISABLED_IN_ACTIVE_DISABLED = 0x1


class ENUM_RFB_UPDATE_CONTROL(Enum):
    RFB_UPDATE_CONTROL_SOFTWARE_CONTROLS = 0x0
    RFB_UPDATE_CONTROL_HARDWARE_CONTROLS = 0x1


class OFFSET_PR_ALPM_CTL:
    PR_ALPM_CTL_A = 0x60948
    PR_ALPM_CTL_B = 0x61948

class _PR_ALPM_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AdaptiveSyncSdpPosition', ctypes.c_uint32, 2),
        ('Reserved2', ctypes.c_uint32, 2),
        ('AsSdpTransmissionDisabledInActive', ctypes.c_uint32, 1),
        ('RfbUpdateControl', ctypes.c_uint32, 1),
        ('Reserved6', ctypes.c_uint32, 26),
    ]


class REG_PR_ALPM_CTL(ctypes.Union):
    value = 0
    offset = 0

    AdaptiveSyncSdpPosition = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 3
    AsSdpTransmissionDisabledInActive = 0  # bit 4 to 4
    RfbUpdateControl = 0  # bit 5 to 5
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PR_ALPM_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_TRANS_STEREO3D_CTL(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 21
    FsMsaMisc1DriveInvert = 0  # bit 22 to 22
    FsMsaMisc1DriveEn = 0  # bit 23 to 23
    S3DCurrentField = 0  # bit 24 to 24
    Reserved25 = 0  # bit 25 to 25
    FsFieldCtl = 0  # bit 26 to 26
    S3DMode = 0  # bit 27 to 28
    Reserved29 = 0  # bit 29 to 30
    TranscoderS3DEnable = 0  # bit 31 to 31
...
class REG_VSC_EXT_SDP_CONF(ctypes.Union):
    ...
    PacketsPerChain = 0  # bit 0 to 9
    HblankEarlyIndication = 0  # bit 10 to 21
    BlockMode = 0  # bit 22 to 22
    SdpActiveError = 0  # bit 23 to 23
    BufferReplay = 0  # bit 24 to 24
    Reserved25 = 0  # bit 25 to 30
    ChainDone = 0  # bit 31 to 31
...
class REG_VSC_EXT_SDP_HEADER(ctypes.Union):
    ...
    SdpId = 0  # bit 0 to 7
    SdpType = 0  # bit 8 to 15
    VscExtVesaSdpFrameworkVer0 = 0  # bit 16 to 17
    VscExtVesaSdpFrameworkVer1 = 0  # bit 18 to 21
    VariablePacketSequenceNumber = 0  # bit 22 to 22
    MiddleOfChaining = 0  # bit 23 to 23
    PacketSequence = 0  # bit 24 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_VSC_EXT_SDP_CTL(ctypes.Union):
    ...
    Reserved8 = 0  # bit 8 to 13
    IndexAutoIncrement = 0  # bit 14 to 14
    BufferClearStatus = 0  # bit 15 to 15
    BufferReady = 0  # bit 16 to 16
    Reserved17 = 0  # bit 17 to 23
    BufferEmpty = 0  # bit 24 to 24
    Reserved25 = 0  # bit 25 to 30
    VscExtensionSdpMetadataEnable = 0  # bit 31 to 31
...
class REG_HDMI_EMP_CTL(ctypes.Union):
    ...
    ExtendedMetadataPacketType = 0  # bit 0 to 3
    Reserved4 = 0  # bit 4 to 31
...
class REG_HDMI_EMP_HEADER(ctypes.Union):
    ...
    Hb0_Spare = 0  # bit 0 to 7
    Hb1_Spare = 0  # bit 8 to 15
    NumberOfPackets = 0  # bit 16 to 23
    DataSetType = 0  # bit 24 to 25
    End = 0  # bit 26 to 26
    Hb3_Spare = 0  # bit 27 to 31
...
class REG_WD_TAIL_CFG(ctypes.Union):
    ...
    TailUpdatePeriod = 0  # bit 4 to 11
    Reserved12 = 0  # bit 12 to 15
    TailInitialUpdateDelay = 0  # bit 16 to 27
...
class REG_WD_SURF(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 11
    WdSurfaceBaseAddress = 0  # bit 12 to 31
...
class REG_TRANS_WD_FUNC_CTL(ctypes.Union):
    ...
    FrameNumber = 0  # bit 0 to 3
    MaximumDifferenceToEnableWriteCaching = 0  # bit 4 to 11
    WdInputSelect = 0  # bit 12 to 14
    Reserved15 = 0  # bit 15 to 15
    VdencSessionSelect = 0  # bit 16 to 17
    ControlPointers = 0  # bit 18 to 19
    WdColorMode = 0  # bit 20 to 22
    Reserved23 = 0  # bit 23 to 25
    ChromaFilteringEnable = 0  # bit 26 to 26
    EnableWriteCaching = 0  # bit 27 to 27
    StopTriggerFrame = 0  # bit 28 to 28
    StartTriggerFrame = 0  # bit 29 to 29
    TriggeredCaptureModeEnable = 0  # bit 30 to 30
    WdFunctionEnable = 0  # bit 31 to 31
...
class REG_TRANS_EXITLINE(ctypes.Union):
    ...
    ExitLine = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 30
    EnableExitLine = 0  # bit 31 to 31
...
class REG_CHICKEN_DCPR_1(ctypes.Union):
    ...
    SwResetLength = 0  # bit 0 to 4
    Spare5 = 0  # bit 5 to 5
    Spare6 = 0  # bit 6 to 6
    DdiClockRegAccess = 0  # bit 7 to 7
    PortRegAccessOverride = 0  # bit 8 to 8
    Spare9 = 0  # bit 9 to 9
    Spare10 = 0  # bit 10 to 10
    IdleThreshold = 0  # bit 11 to 12
    IdleWakememMask = 0  # bit 13 to 13
    MemupResponseWait = 0  # bit 14 to 14
    Spare15 = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    DisplayClockGatingOverride = 0  # bit 19 to 19
    BlockBlockFillResponseOverride = 0  # bit 20 to 20
    DgEmptyDe_WakeOverwrite = 0  # bit 21 to 21
...
class REG_CHICKEN_MISC_1(ctypes.Union):
    ...
    Spare1 = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    SingleDpstVblankAnchor = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
    Spare6 = 0  # bit 6 to 6
    Spare7 = 0  # bit 7 to 7
    Spare8 = 0  # bit 8 to 8
    Spare9 = 0  # bit 9 to 9
    MessageRequestWakeDisable = 0  # bit 10 to 10
    Spare11 = 0  # bit 11 to 11
    ForceArbIdleAudio = 0  # bit 12 to 12
    ForceArbIdleFbc = 0  # bit 13 to 13
    Spare14 = 0  # bit 14 to 14
    DisableE2EHotspotAvoidance = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    ...
    Spare22 = 0  # bit 22 to 22
    Spare23 = 0  # bit 23 to 23
    KvmOverflowBlockRevert = 0  # bit 24 to 24
    KvmConfigChangeNotificationSelect = 0  # bit 25 to 25
    Spare26 = 0  # bit 26 to 26
    Spare27 = 0  # bit 27 to 27
    Spare28 = 0  # bit 28 to 28
    ScalerEccBypass = 0  # bit 29 to 29
    Spare30 = 0  # bit 30 to 30
    SkipSendingAksvToPica = 0  # bit 31 to 31
...
class ENUM_DECOMP_CCS_PAVP_ENC(Enum):
    DECOMP_CCS_PAVP_ENC_DISABLE = 0x0
    DECOMP_CCS_PAVP_ENC_ENABLE = 0x1
...
class _CHICKEN_MISC_2(ctypes.LittleEndianStructure):
    _fields_ = [
        ('PsrGlobalMask', ctypes.c_uint32, 1),
        ('Spare1', ctypes.c_uint32, 1),
        ('Spare2', ctypes.c_uint32, 1),
...
class REG_CHICKEN_MISC_2(ctypes.Union):
    ...
    Spare7 = 0  # bit 7 to 7
    Spare8 = 0  # bit 8 to 8
    DcmpBypassEnable = 0  # bit 9 to 9
    MaskFbcWakeReq = 0  # bit 10 to 10
    Spare11 = 0  # bit 11 to 11
    Spare12 = 0  # bit 12 to 12
    Spare13 = 0  # bit 13 to 13
    Spare14 = 0  # bit 14 to 14
    DisableLpfsmCmdgetReset = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    Spare19 = 0  # bit 19 to 19
    KvmrcapRegDoubleBuffer = 0  # bit 20 to 20
    Spare21 = 0  # bit 21 to 21
    Spare22 = 0  # bit 22 to 22
    Spare23 = 0  # bit 23 to 23
    Spare24 = 0  # bit 24 to 24
    FbcWatermarkDisable = 0  # bit 25 to 25
    DecompCcsPavpEnc = 0  # bit 26 to 26
    Spare27 = 0  # bit 27 to 27
    TransEnableAlignment = 0  # bit 28 to 28
    DarbaCounterClear = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 30
    Spare31 = 0  # bit 31 to 31
...
class REG_CHICKEN_MISC_5(ctypes.Union):
    ...
    SkipRegisterAck = 0  # bit 0 to 0
    FakeAckDisable = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    Spare3 = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
...
class ENUM_LOBF_ALPM_ENTRY_CHECK_ENABLE(Enum):
    LOBF_ALPM_ENTRY_CHECK_DISABLED = 0x0
    LOBF_ALPM_ENTRY_CHECK_ENABLED = 0x1
...
class ENUM_ALIGN_MTPS(Enum):
    ALIGN_MTPS_DISABLE = 0x0
    ALIGN_MTPS_ENABLE = 0x1
...
class _CHICKEN_TRANS(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Spare4', ctypes.c_uint32, 1),
        ('Spare5', ctypes.c_uint32, 1),
        ('LobfAlpmEntryCheckEnable', ctypes.c_uint32, 1),
        ('Spare7', ctypes.c_uint32, 1),
        ('Spare8', ctypes.c_uint32, 1),
...
class REG_CHICKEN_TRANS(ctypes.Union):
    ...
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
    LobfAlpmEntryCheckEnable = 0  # bit 6 to 6
    Spare7 = 0  # bit 7 to 7
    Spare8 = 0  # bit 8 to 8
    AuxFrameSyncEventTiming = 0  # bit 9 to 10
    Spare11 = 0  # bit 11 to 11
    Spare12 = 0  # bit 12 to 12
    Spare13 = 0  # bit 13 to 13
    AlignMtps = 0  # bit 14 to 14
    Spare15 = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    YCoordinateBase = 0  # bit 18 to 18
    Spare19 = 0  # bit 19 to 19
    Spare20 = 0  # bit 20 to 20
    Spare21 = 0  # bit 21 to 21
    Spare22 = 0  # bit 22 to 22
    Spare23 = 0  # bit 23 to 23
    HdmiVbiWhilePortOff = 0  # bit 24 to 24
    Spare25 = 0  # bit 25 to 25
    DdaAccumulateCountUpdate = 0  # bit 26 to 26
    FrameStartDelay = 0  # bit 27 to 28
    DpActiveVideoDisable = 0  # bit 29 to 29
    Spare30 = 0  # bit 30 to 30
    Spare31 = 0  # bit 31 to 31
...
class REG_UTIL_PIN_CTL(ctypes.Union):
    ...
    UtilPinInputData = 0  # bit 16 to 16
    Reserved17 = 0  # bit 17 to 18
    Reserved19 = 0  # bit 19 to 19
    Reserved20 = 0  # bit 20 to 21
    UtilPinOutputPolarity = 0  # bit 22 to 22
    UtilPinOutputData = 0  # bit 23 to 23
    UtilPinMode = 0  # bit 24 to 27
    Reserved28 = 0  # bit 28 to 28
    PipeSelect = 0  # bit 29 to 30
    Reserved31 = 0  # bit 31 to 31
...
class ENUM_RC_COMPRESSION_THROTTLING_DISABLE(Enum):
    RC_COMPRESSION_THROTTLING_ENABLED = 0x0
    RC_COMPRESSION_THROTTLING_DISABLED = 0x1
...
class _TRANS_HDMI_FIXED_RATE_CFG(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('RcCompressionThrottlingDisable', ctypes.c_uint32, 1),
...
class REG_TRANS_HDMI_FIXED_RATE_CFG(ctypes.Union):
    ...
    MaximumFrlPacketPayloadAllowed = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 11
    MinimumNumberBlankCharacters = 0  # bit 12 to 15
    ActiveCharacterBufferingThreshold = 0  # bit 16 to 18
    ResourceBasedSchedulingEnable = 0  # bit 19 to 19
    DisableDfmAdjustmentMasking = 0  # bit 20 to 20
    RcCompressionThrottlingDisable = 0  # bit 21 to 21
    Reserved22 = 0  # bit 22 to 27
    FrlTrainingComplete = 0  # bit 28 to 28
    Reserved29 = 0  # bit 29 to 30
    FrlFunctionEnable = 0  # bit 31 to 31
...
class REG_TRANS_HDMI_LINK_TRAINING(ctypes.Union):
    ...
    Lane0LtpCode = 0  # bit 0 to 3
    Reserved4 = 0  # bit 4 to 7
    Lane1LtpCode = 0  # bit 8 to 11
    Reserved12 = 0  # bit 12 to 15
    Lane2LtpCode = 0  # bit 16 to 19
    Reserved20 = 0  # bit 20 to 23
    Lane3LtpCode = 0  # bit 24 to 27
    Reserved28 = 0  # bit 28 to 31
...
class REG_TRANS_HDMI_FRL_DFMRDCTL(ctypes.Union):
    ...
    TbDifferenceMaxOffset = 0  # bit 0 to 8
...
class REG_TRANS_HDMI_FRL_DFMTHRSH(ctypes.Union):
    ...
    MinimumTbThreshold = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 11
    MaximumTbThreshold = 0  # bit 12 to 21
    Reserved22 = 0  # bit 22 to 23
    RunLengthThreshold = 0  # bit 24 to 31
...
class REG_TRANS_HDMI_HCTOTAL(ctypes.Union):
    ...
    HorizontalCompressedActive = 0  # bit 0 to 13
    Reserved14 = 0  # bit 14 to 15
    HorizontalCompressedTotal = 0  # bit 16 to 29
    Reserved30 = 0  # bit 30 to 31
...
class REG_WD_FRAME_STATUS(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 19
    KeySelect = 0  # bit 20 to 20
    Reserved21 = 0  # bit 21 to 22
    Encryption = 0  # bit 23 to 23
    WdState = 0  # bit 24 to 26
    Reserved27 = 0  # bit 27 to 30
    FrameComplete = 0  # bit 31 to 31
...
class OFFSET_TRANS_SET_CONTEXT_LATENCY:
    ...
    TRANS_SET_CONTEXT_LATENCY_CMTG0 = 0x6F07C
    TRANS_SET_CONTEXT_LATENCY_CMTG1 = 0x6F17C
