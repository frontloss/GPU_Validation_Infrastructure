...
# --------------------------------------------------------------------------
#
# @file Gen15PlaneRegs.py
# @brief contains Gen15PlaneRegs.py related register definitions
...
class _PLANE_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('DecompEnable', ctypes.c_uint32, 1),
...
class REG_PLANE_CTL(ctypes.Union):
    ...
    PlaneRotation = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 2
    AllowDbStall = 0  # bit 3 to 3
    Reserved4 = 0  # bit 4 to 5
    StereoSurfaceVblankMask = 0  # bit 6 to 7
    HorizontalFlip = 0  # bit 8 to 8
    AsyncAddressUpdateEnable = 0  # bit 9 to 9
    TiledSurface = 0  # bit 10 to 12
    Reserved13 = 0  # bit 13 to 14
    DecompEnable = 0  # bit 15 to 15
    Yuv422ByteOrder = 0  # bit 16 to 17
    SmoothSyncPlaneEnable = 0  # bit 18 to 18
    PlanarYuv420Component = 0  # bit 19 to 19
    RgbColorOrder = 0  # bit 20 to 20
    KeyEnable = 0  # bit 21 to 22
    SourcePixelFormat = 0  # bit 23 to 27
    PipeSliceArbitrationSlots = 0  # bit 28 to 30
    PlaneEnable = 0  # bit 31 to 31
...
class ENUM_SECOND_WINDOW_SEGMENTS(Enum):
    SECOND_WINDOW_SEGMENTS_1 = 0x1


class ENUM_FIRST_WINDOW_SEGMENTS(Enum):
    FIRST_WINDOW_SEGMENTS_6 = 0x6


class ENUM_ASYNC_FLIP_WINDOW_DISABLE(Enum):
    ASYNC_FLIP_WINDOW_ENABLE = 0x0
    ASYNC_FLIP_WINDOW_DISABLE = 0x1


class OFFSET_PLANE_AFLIP_WIN_CTL:
    PLANE_AFLIP_WIN_CTL_1_A = 0x70184
    PLANE_AFLIP_WIN_CTL_2_A = 0x70284
    PLANE_AFLIP_WIN_CTL_3_A = 0x70384
    PLANE_AFLIP_WIN_CTL_4_A = 0x70484
    PLANE_AFLIP_WIN_CTL_5_A = 0x70584
    PLANE_AFLIP_WIN_CTL_1_B = 0x71184
    PLANE_AFLIP_WIN_CTL_2_B = 0x71284
    PLANE_AFLIP_WIN_CTL_3_B = 0x71384
    PLANE_AFLIP_WIN_CTL_4_B = 0x71484
    PLANE_AFLIP_WIN_CTL_5_B = 0x71584
    PLANE_AFLIP_WIN_CTL_1_C = 0x72184
    PLANE_AFLIP_WIN_CTL_2_C = 0x72284
    PLANE_AFLIP_WIN_CTL_3_C = 0x72384
    PLANE_AFLIP_WIN_CTL_4_C = 0x72484
    PLANE_AFLIP_WIN_CTL_5_C = 0x72584
    PLANE_AFLIP_WIN_CTL_1_D = 0x73184
    PLANE_AFLIP_WIN_CTL_2_D = 0x73284
    PLANE_AFLIP_WIN_CTL_3_D = 0x73384
    PLANE_AFLIP_WIN_CTL_4_D = 0x73484
    PLANE_AFLIP_WIN_CTL_5_D = 0x73584

class _PLANE_AFLIP_WIN_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('SecondWindowSegments', ctypes.c_uint32, 5),
        ('Reserved5', ctypes.c_uint32, 11),
        ('FirstWindowSegments', ctypes.c_uint32, 5),
        ('Reserved21', ctypes.c_uint32, 8),
        ('IllegalAflipWindow', ctypes.c_uint32, 1),
        ('FetchNotCompleted', ctypes.c_uint32, 1),
        ('AsyncFlipWindowDisable', ctypes.c_uint32, 1),
    ]


class REG_PLANE_AFLIP_WIN_CTL(ctypes.Union):
    value = 0
    offset = 0

    SecondWindowSegments = 0  # bit 0 to 4
    Reserved5 = 0  # bit 5 to 15
    FirstWindowSegments = 0  # bit 16 to 20
    Reserved21 = 0  # bit 21 to 28
    IllegalAflipWindow = 0  # bit 29 to 29
    FetchNotCompleted = 0  # bit 30 to 30
    AsyncFlipWindowDisable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PLANE_AFLIP_WIN_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PLANE_AFLIP_WIN_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class _PLANE_STRIDE(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('AsyncFlippedLine', ctypes.c_uint32, 14),
    ]
...
class REG_PLANE_STRIDE(ctypes.Union):
    ...
    AsyncFlippedLine = 0  # bit 18 to 31
...
class REG_PLANE_POS(ctypes.Union):
    ...
    XPosition = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    YPosition = 0  # bit 16 to 28
...
class REG_PLANE_KEYVAL(ctypes.Union):
    ...
    UMinOrBKeyValue = 0  # bit 0 to 7
    YMinOrGKeyValue = 0  # bit 8 to 15
    VMinOrRKeyValue = 0  # bit 16 to 23
...
class REG_PLANE_KEYMSK(ctypes.Union):
    ...
    BKeyMaskValue = 0  # bit 0 to 7
    GKeyMaskValue = 0  # bit 8 to 15
    RKeyMaskValue = 0  # bit 16 to 23
    UOrBKeyChannelEnable = 0  # bit 24 to 24
    YOrGKeyChannelEnable = 0  # bit 25 to 25
    VOrRKeyChannelEnable = 0  # bit 26 to 26
    Reserved27 = 0  # bit 27 to 30
    PlaneAlphaEnable = 0  # bit 31 to 31
...
class ENUM_DECRYPTION_REQUEST(Enum):
    DECRYPTION_REQUEST_NOT_REQUESTED = 0x0
    DECRYPTION_REQUEST_REQUESTED = 0x1
...
class REG_PLANE_SURF(ctypes.Union):
    ...
    DecryptionRequest = 0  # bit 2 to 2
    RingFlipSource = 0  # bit 3 to 3
    KeySelect = 0  # bit 4 to 6
...
class REG_PLANE_KEYMAX(ctypes.Union):
    ...
    UKeyMaxValue = 0  # bit 0 to 7
    YKeyMaxValue = 0  # bit 8 to 15
    VKeyMaxValue = 0  # bit 16 to 23
    PlaneAlphaValue = 0  # bit 24 to 31
...
class REG_PLANE_OFFSET(ctypes.Union):
    ...
    StartXPosition = 0  # bit 0 to 15
    StartYPosition = 0  # bit 16 to 31
...
class REG_PLANE_SURFLIVE(ctypes.Union):
    ...
    CurrentFrameCounterEntry = 0  # bit 9 to 10
    Reserved11 = 0  # bit 11 to 11
    LiveSurfaceBaseAddress = 0  # bit 12 to 31
...
class REG_PLANE_LEFT_SURF(ctypes.Union):
    ...
    LeftSurfaceBaseAddress = 0  # bit 12 to 31
...
class ENUM_AFLIP_CUTOFF_LINE_ENABLE(Enum):
    AFLIP_CUTOFF_LINE_DISABLED = 0x0
    AFLIP_CUTOFF_LINE_ENABLED = 0x1


class OFFSET_PLANE_AFLIP_LINE_CTL:
    PLANE_AFLIP_LINE_CTL_1_A = 0x701C4
    PLANE_AFLIP_LINE_CTL_2_A = 0x702C4
    PLANE_AFLIP_LINE_CTL_3_A = 0x703C4
    PLANE_AFLIP_LINE_CTL_4_A = 0x704C4
    PLANE_AFLIP_LINE_CTL_5_A = 0x705C4
    PLANE_AFLIP_LINE_CTL_1_B = 0x711C4
    PLANE_AFLIP_LINE_CTL_2_B = 0x712C4
    PLANE_AFLIP_LINE_CTL_3_B = 0x713C4
    PLANE_AFLIP_LINE_CTL_4_B = 0x714C4
    PLANE_AFLIP_LINE_CTL_5_B = 0x715C4
    PLANE_AFLIP_LINE_CTL_1_C = 0x721C4
    PLANE_AFLIP_LINE_CTL_2_C = 0x722C4
    PLANE_AFLIP_LINE_CTL_3_C = 0x723C4
    PLANE_AFLIP_LINE_CTL_4_C = 0x724C4
    PLANE_AFLIP_LINE_CTL_5_C = 0x725C4
    PLANE_AFLIP_LINE_CTL_1_D = 0x731C4
    PLANE_AFLIP_LINE_CTL_2_D = 0x732C4
    PLANE_AFLIP_LINE_CTL_3_D = 0x733C4
    PLANE_AFLIP_LINE_CTL_4_D = 0x734C4
    PLANE_AFLIP_LINE_CTL_5_D = 0x735C4

class _PLANE_AFLIP_LINE_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AflipCutoffLine', ctypes.c_uint32, 13),
        ('Reserved13', ctypes.c_uint32, 16),
        ('SyncFlipOutcome', ctypes.c_uint32, 1),
        ('AsyncFlipOutcome', ctypes.c_uint32, 1),
        ('AflipCutoffLineEnable', ctypes.c_uint32, 1),
    ]


class REG_PLANE_AFLIP_LINE_CTL(ctypes.Union):
    value = 0
    offset = 0

    AflipCutoffLine = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 28
    SyncFlipOutcome = 0  # bit 29 to 29
    AsyncFlipOutcome = 0  # bit 30 to 30
    AflipCutoffLineEnable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PLANE_AFLIP_LINE_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PLANE_AFLIP_LINE_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_PLANE_WM(ctypes.Union):
    ...
    Lines = 0  # bit 14 to 26
    Reserved27 = 0  # bit 27 to 29
    IgnoreLines = 0  # bit 30 to 30
...
class REG_PLANE_PIXEL_NORMALIZE(ctypes.Union):
    ...
    NormalizationFactor = 0  # bit 0 to 15
...
class REG_PLANE_CUS_CTL(ctypes.Union):
    ...
    PowerUpInProgress = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 3
    EccDoubleError = 0  # bit 4 to 4
    EccSingleError = 0  # bit 5 to 5
    Reserved6 = 0  # bit 6 to 7
    EccBypass = 0  # bit 8 to 8
    PowerUpDelay = 0  # bit 9 to 10
    PowerGateDisable = 0  # bit 11 to 11
    VertInitialPhase = 0  # bit 12 to 13
    Reserved14 = 0  # bit 14 to 14
    VertInitialPhaseSign = 0  # bit 15 to 15
    HorzInitialPhase = 0  # bit 16 to 17
    Reserved18 = 0  # bit 18 to 18
    HorzInitialPhaseSign = 0  # bit 19 to 19
    ErrorInjectionFlipBits = 0  # bit 20 to 21
    Reserved22 = 0  # bit 22 to 22
    EccErrorInjectionEnable = 0  # bit 23 to 23
    Reserved24 = 0  # bit 24 to 29
    YBinding = 0  # bit 30 to 30
    ChromaUpsamplerEnable = 0  # bit 31 to 31
...
class REG_DOUBLE_BUFFER_CTL(ctypes.Union):
    ...
    GlobalDoubleBufferUpdateDisable = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 3
    PipeDbStallA = 0  # bit 4 to 4
    PipeDbStallB = 0  # bit 5 to 5
    PipeDbStallC = 0  # bit 6 to 6
    PipeDbStallD = 0  # bit 7 to 7
...
class ENUM_DISALLOW_CC_VAL_ASYNC_UPDATE(Enum):
    DISALLOW_CC_VAL_ASYNC_UPDATE_ENABLE_THE_FIX_ = 0x0
    DISALLOW_CC_VAL_ASYNC_UPDATE_DISABLE_THE_FIX_ = 0x1
...
class _PLANE_COLOR_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('DisallowCcValAsyncUpdate', ctypes.c_uint32, 1),
...
class REG_PLANE_COLOR_CTL(ctypes.Union):
    ...
    SmoothSyncDitherStepSize = 0  # bit 0 to 2
    Spare3 = 0  # bit 3 to 3
    AlphaMode = 0  # bit 4 to 5
    Spare6 = 0  # bit 6 to 6
    Spare7 = 0  # bit 7 to 7
    Spare8 = 0  # bit 8 to 8
    DisallowCcValAsyncUpdate = 0  # bit 9 to 9
    ColorCorrectionDitheringEnable = 0  # bit 10 to 10
    PlaneGammaMultiplierPrecision = 0  # bit 11 to 11
    PlaneGammaMode = 0  # bit 12 to 12
    PlaneGammaDisable = 0  # bit 13 to 13
    PlanePreCscGammaEnable = 0  # bit 14 to 14
    PlanePostCscGammaMultiSegmentEnable = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    PlaneCscMode = 0  # bit 17 to 19
    PlaneInputCscEnable = 0  # bit 20 to 20
    PlaneCscEnable = 0  # bit 21 to 21
    YuvRangeCorrectionOutput = 0  # bit 22 to 22
    PipeCscEnable = 0  # bit 23 to 23
    Spare24 = 0  # bit 24 to 24
    Spare25 = 0  # bit 25 to 25
    Spare26 = 0  # bit 26 to 26
    Spare27 = 0  # bit 27 to 27
    YuvRangeCorrectionDisable = 0  # bit 28 to 28
    RemoveYuvOffset = 0  # bit 29 to 29
    PipeGammaEnable = 0  # bit 30 to 30
...
class REG_CUR_CTL(ctypes.Union):
    ...
    CursorModeSelect = 0  # bit 0 to 5
    Reserved6 = 0  # bit 6 to 7
    ForceAlphaValue = 0  # bit 8 to 9
    ForceAlphaPlaneSelect = 0  # bit 10 to 11
    Reserved12 = 0  # bit 12 to 14
    _180Rotation = 0  # bit 15 to 15
    CscEnable = 0  # bit 16 to 16
    Reserved17 = 0  # bit 17 to 17
    PreCscGammaEnable = 0  # bit 18 to 18
    Reserved19 = 0  # bit 19 to 22
    AllowDbStall = 0  # bit 23 to 23
    PipeCscEnable = 0  # bit 24 to 24
    Reserved25 = 0  # bit 25 to 25
    GammaEnable = 0  # bit 26 to 26
...
class REG_CUR_POS(ctypes.Union):
    ...
    XPositionMagnitude = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 14
    XPositionSign = 0  # bit 15 to 15
    YPositionMagnitude = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 30
    YPositionSign = 0  # bit 31 to 31
...
class REG_CUR_PAL(ctypes.Union):
    ...
    PaletteBlue = 0  # bit 0 to 7
    PaletteGreen = 0  # bit 8 to 15
    PaletteRed = 0  # bit 16 to 23
    Reserved24 = 0  # bit 24 to 31
...
class REG_CUR_FBC_CTL(ctypes.Union):
    ...
    ReducedScanLines = 0  # bit 0 to 7
    Reserved8 = 0  # bit 8 to 30
    SizeReductionEnable = 0  # bit 31 to 31
...
class REG_CUR_COLOR_CTL(ctypes.Union):
    ...
    ToneMappingFactor = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 14
    ToneMappingEnable = 0  # bit 15 to 15
...
class ENUM_VGA_PIPE_SELECT(Enum):
    VGA_PIPE_SELECT_PIPEA = 0x0  # Assigns the VGA display to Pipe A
    VGA_PIPE_SELECT_PIPEB = 0x1  # Assigns the VGA display to Pipe B
...
class _VGA_CONTROL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('VgaPipeSelect', ctypes.c_uint32, 1),
...
class REG_VGA_CONTROL(ctypes.Union):
    ...
    VsyncBlinkRate = 0  # bit 0 to 5
    BlinkDutyCycle = 0  # bit 6 to 7
    VgaBlankThrottlingBlank = 0  # bit 8 to 11
    VgaDeThrottling = 0  # bit 12 to 15
    Reserved16 = 0  # bit 16 to 17
    NineDotDisable = 0  # bit 18 to 18
    PaletteBypass = 0  # bit 19 to 19
    Legacy8BitPaletteEn = 0  # bit 20 to 20
    Reserved21 = 0  # bit 21 to 23
    PipeCscEnable = 0  # bit 24 to 24
    DbufClockGate = 0  # bit 25 to 25
    VgaBorderEnable = 0  # bit 26 to 26
    Reserved27 = 0  # bit 27 to 28
    VgaPipeSelect = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 30
    VgaDisplayDisable = 0  # bit 31 to 31
...
class REG_VGA_DEBUG(ctypes.Union):
    ...
    Spare8 = 0  # bit 8 to 8
    Spare9 = 0  # bit 9 to 9
    DbufFrameReset = 0  # bit 10 to 10
    BlankStatEnable = 0  # bit 11 to 11
    _409StallreqDisable = 0  # bit 12 to 12
    FlushOnframestartDisable = 0  # bit 13 to 13
    ...
    PagemodeDebug = 0  # bit 21 to 21
    GateVrdRequests = 0  # bit 22 to 22
    ScreenoffForce = 0  # bit 23 to 23
    Reserved24 = 0  # bit 24 to 25
    FifoEmptyFixSelect = 0  # bit 26 to 26
    CrResetDisable = 0  # bit 27 to 27
    Cr12WriteCounterReset = 0  # bit 28 to 28
    RequestStallThreshold = 0  # bit 29 to 30
    RequestStallDisable = 0  # bit 31 to 31
...
class ENUM_PLANE_BINDING(Enum):
    PLANE_BINDING_PLANE_1_ = 0x0  # Plane 1 is bound to FBC.
    PLANE_BINDING_PLANE_2 = 0x1  # Plane 2 is bound to FBC.
    PLANE_BINDING_PLANE_3 = 0x2  # Plane 3 is bound to FBC.
...
class REG_FBC_CTL(ctypes.Union):
    ...
    WriteBackWatermark = 0  # bit 4 to 5
    CompressionLimit = 0  # bit 6 to 7
    RefillFifoWriteWatermark = 0  # bit 8 to 9
    FalseColorControl = 0  # bit 10 to 10
    PlaneBinding = 0  # bit 11 to 12
    Reserved13 = 0  # bit 13 to 14
    SlbInitFlushDisable = 0  # bit 15 to 15
    DisableDelta = 0  # bit 16 to 16
    DisablePal = 0  # bit 17 to 17
    DisableRun = 0  # bit 18 to 18
    Reserved19 = 0  # bit 19 to 29
    AllowDbStall = 0  # bit 30 to 30
    EnableFbc = 0  # bit 31 to 31
...
class ENUM_FBC_WRITEBACK_COMPLETION_DISABLE(Enum):
    FBC_WRITEBACK_COMPLETION_ENABLE_WRITE_COMPLETIONS = 0x0
    FBC_WRITEBACK_COMPLETION_DISABLE_WRITE_COMPLETIONS = 0x1
...
class OFFSET_FBC_WB_CTL:
    FBC_WB_CTL_A = 0x4320C
    FBC_WB_CTL_B = 0x4324C

class _FBC_WB_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('WritebackCounterThreshold', ctypes.c_uint32, 10),
        ('Reserved10', ctypes.c_uint32, 20),
        ('FbcWritebackCompletionDisable', ctypes.c_uint32, 1),
        ('ClearWritebackCounter', ctypes.c_uint32, 1),
    ]


class REG_FBC_WB_CTL(ctypes.Union):
    value = 0
    offset = 0

    WritebackCounterThreshold = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 29
    FbcWritebackCompletionDisable = 0  # bit 30 to 30
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_FBC_WB_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_FBC_CFB_BASE(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 11
    CfbOffsetAddress = 0  # bit 12 to 27
    Reserved28 = 0  # bit 28 to 31
...
class REG_FBC_STRIDE(ctypes.Union):
    ...
    OverrideStride = 0  # bit 0 to 13
    Spare14 = 0  # bit 14 to 14
    OverrideStrideEnable = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    Spare19 = 0  # bit 19 to 19
...
class ENUM_MULTIFRAME_NUKE_RECOVERY(Enum):
    MULTIFRAME_NUKE_RECOVERY_ENABLE_RECOVERY_FROM_NUKE_EXTENDING_INTO_NEXT_FRAME = 0x0
    MULTIFRAME_NUKE_RECOVERY_REVERT_TO_OLD_IMPLEMENTATION = 0x1
...
class _FBC_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('MultiframeNukeRecovery', ctypes.c_uint32, 1),
...
class REG_FBC_CHICKEN(ctypes.Union):
    ...
    ComptagGatingFixDisable = 0  # bit 0 to 0
    SlbInvalidateNukeFixDisable = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    Underrun2PpcFixDisable = 0  # bit 3 to 3
    RcNukeForPsrFixDisable = 0  # bit 4 to 4
    OverrideAutomaticDisable = 0  # bit 5 to 5
    DstComptagOffset = 0  # bit 6 to 7
    Spare8 = 0  # bit 8 to 8
    Spare9 = 0  # bit 9 to 9
    SkipSegCount = 0  # bit 10 to 11
    SkipSegEnable = 0  # bit 12 to 12
    ForceSlbInvalidation = 0  # bit 13 to 13
    CompDummyPixel = 0  # bit 14 to 14
    PsrLinkOffNukeFixDisable = 0  # bit 15 to 15
    InitStateClearFixDisable = 0  # bit 16 to 16
    FlushLastSegmentFixEnable = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    DisableSlbReadCountHold = 0  # bit 19 to 19
    Spare20 = 0  # bit 20 to 20
    DisVtdFaultNuke = 0  # bit 21 to 21
    Height4096FixDisable = 0  # bit 22 to 22
    Spare23 = 0  # bit 23 to 23
    ReadWriteCollisionFixDisable = 0  # bit 24 to 24
    WbIgnoreFill = 0  # bit 25 to 25
    DisComptagUnderrunNuke = 0  # bit 26 to 26
    MultiframeNukeRecovery = 0  # bit 27 to 27
    DisFlipNuke = 0  # bit 28 to 28
    DisPipeUnderrunNuke = 0  # bit 29 to 29
    DisCountNuke = 0  # bit 30 to 30
    DisCwbNuke = 0  # bit 31 to 31
...
class REG_SEL_FETCH_PLANE_CTL(ctypes.Union):
    ...
    Spares = 0  # bit 0 to 30
    SelectiveFetchPlaneEnable = 0  # bit 31 to 31
...
class REG_LM_CTRL(ctypes.Union):
    ...
    PlaneBinding = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 30
    LuminanceMapperEnable = 0  # bit 31 to 31
...
class REG_LM_TONEFACT_DATA(ctypes.Union):
    ...
    ToneMappingFactor = 0  # bit 0 to 23
    Reserved24 = 0  # bit 24 to 31
...
class REG_LM_TONEFACT_INDEX(ctypes.Union):
    ...
    IndexAutoIncrement = 0  # bit 16 to 16
