...
# --------------------------------------------------------------------------
#
# @file Gen15PipeRegs.py
# @brief contains Gen15PipeRegs.py related register definitions
...
class ENUM_PROGRAMMABLE_SCALE_FACTOR(Enum):
    PROGRAMMABLE_SCALE_FACTOR_USE_HW_SCALE_FACTORS_FOR_BOTH_H_AND_V_ = 0x0  # Hardware ignores programming in the PS_PR
                                                                            # OG_VSCALE and PS_PROG_HSCALE registers
    PROGRAMMABLE_SCALE_FACTOR_USE_SW_SCALE_FACTOR_FOR_V_ONLY = 0x1  # The Scaler uses PS_PROG_VSCALE for V. filter. Har
                                                                    # dware calculates the Scale Factor for H. filter
    PROGRAMMABLE_SCALE_FACTOR_USE_SW_SCALE_FACTOR_FOR_H_ONLY = 0x2  # The Scaler uses PS_PROG_HSCALE for H. filter. Har
                                                                    # dware calculates the Scale Factor for V. filter
    PROGRAMMABLE_SCALE_FACTOR_USE_SW_SCALE_FACTORS_FOR_BOTH_H_AND_V_ = 0x3  # The Scaler uses PS_PROG_VSCALE for V. fil
                                                                            # ter and PS_PROG_HSCALE for H. filter.
...
class _PS_CTRL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('ProgrammableScaleFactor', ctypes.c_uint32, 2),
...
class REG_PS_CTRL(ctypes.Union):
    ...
    UvHorzFilterSetSel = 0  # bit 1 to 1
    UvVertFilterSetSel = 0  # bit 2 to 2
    YHorzFilterSetSel = 0  # bit 3 to 3
    YVertFilterSetSel = 0  # bit 4 to 4
    Reserved5 = 0  # bit 5 to 7
    VFilterBypass = 0  # bit 8 to 8
    AllowDbStall = 0  # bit 9 to 9
    Reserved10 = 0  # bit 10 to 11
    ErrorInjectionFlipBits = 0  # bit 12 to 13
    Reserved14 = 0  # bit 14 to 14
    EccErrorInjectionEnable = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 16
    PwrupInProgress = 0  # bit 17 to 17
    ProgrammableScaleFactor = 0  # bit 18 to 19
    VerticalIntFieldInvert = 0  # bit 20 to 20
    PipeScalerLocation = 0  # bit 21 to 21
    AdaptiveFilterSelect = 0  # bit 22 to 22
    FilterSelect = 0  # bit 23 to 24
    ScalerBinding = 0  # bit 25 to 27
    AdaptiveFiltering = 0  # bit 28 to 28
    Reserved29 = 0  # bit 29 to 29
    ScalerType = 0  # bit 30 to 30
    EnableScaler = 0  # bit 31 to 31
...
class REG_PS_ECC_STAT(ctypes.Union):
    ...
    SingleErrorDetected = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 15
    DoubleErrorDetected = 0  # bit 16 to 16
    Reserved17 = 0  # bit 17 to 31
...
class REG_PS_HPHASE(ctypes.Union):
    ...
    UvOrRgbInitialHphaseTrip = 0  # bit 0 to 0
    UvOrRgbInitialHphaseFrac = 0  # bit 1 to 13
    UvOrRgbInitialHphaseInt = 0  # bit 14 to 15
    YInitialHphaseTrip = 0  # bit 16 to 16
    YInitialHphaseFrac = 0  # bit 17 to 29
    YInitialHphaseInt = 0  # bit 30 to 31
...
class REG_PS_HSCALE(ctypes.Union):
    ...
    HscaleFrac = 0  # bit 0 to 14
    HscaleInt = 0  # bit 15 to 17
...
class REG_PS_PWR_GATE(ctypes.Union):
    ...
    SlpenDelay = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 2
    SettlingTime = 0  # bit 3 to 4
    DynamicPwrGateDisable = 0  # bit 5 to 5
    Reserved6 = 0  # bit 6 to 30
    PwrGateDisOverride = 0  # bit 31 to 31
...
class REG_PS_VPHASE(ctypes.Union):
    ...
    UvOrRgbInitialVphaseTrip = 0  # bit 0 to 0
    UvOrRgbInitialVphaseFrac = 0  # bit 1 to 13
    UvOrRgbInitialVphaseInt = 0  # bit 14 to 15
    YInitialVphaseTrip = 0  # bit 16 to 16
    YInitialVphaseFrac = 0  # bit 17 to 29
    YInitialVphaseInt = 0  # bit 30 to 31
...
class REG_PS_VSCALE(ctypes.Union):
    ...
    VscaleFrac = 0  # bit 0 to 14
    VscaleInt = 0  # bit 15 to 17
    Reserved18 = 0  # bit 18 to 31
...
class REG_PS_COEF_INDEX(ctypes.Union):
    ...
    Reserved6 = 0  # bit 6 to 9
    IndexAutoIncrement = 0  # bit 10 to 10
...
class REG_PS_COEF_DATA(ctypes.Union):
    ...
    Coefficient1 = 0  # bit 0 to 15
    Coefficient2 = 0  # bit 16 to 31
...
class REG_PS_ADAPTIVE_CTRL(ctypes.Union):
    ...
    Threshold1 = 0  # bit 0 to 7
    Threshold2 = 0  # bit 8 to 15
    Threshold3 = 0  # bit 16 to 23
...
class ENUM_SHARPNESS_FILTER_SIZE(Enum):
    SHARPNESS_FILTER_SIZE_3X3 = 0x0
    SHARPNESS_FILTER_SIZE_5X5 = 0x1
    SHARPNESS_FILTER_SIZE_7X7 = 0x2


class ENUM_STRENGTH(Enum):
    STRENGTH_1_0 = 0x10


class OFFSET_PS_SHARPNESS_CTRL:
    PS_SHARPNESS_CTRL_A = 0x682B0
    PS_SHARPNESS_CTRL_B = 0x68AB0
    PS_SHARPNESS_CTRL_C = 0x692B0
    PS_SHARPNESS_CTRL_D = 0x69AB0

class _PS_SHARPNESS_CTRL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('SharpnessFilterSize', ctypes.c_uint32, 2),
        ('Reserved2', ctypes.c_uint32, 6),
        ('Strength', ctypes.c_uint32, 8),
        ('Reserved16', ctypes.c_uint32, 15),
        ('SharpnessFilterEnable', ctypes.c_uint32, 1),
    ]


class REG_PS_SHARPNESS_CTRL(ctypes.Union):
    value = 0
    offset = 0

    SharpnessFilterSize = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 7
    Strength = 0  # bit 8 to 15
    Reserved16 = 0  # bit 16 to 30
    SharpnessFilterEnable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PS_SHARPNESS_CTRL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PS_SHARPNESS_CTRL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_PS_SHRPLUT_INDEX(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PS_SHRPLUT_INDEX),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PS_SHRPLUT_INDEX, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PS_SHRPLUT_DATA:
    PS_SHRPLUT_DATA_A = 0x682B8
    PS_SHRPLUT_DATA_B = 0x68AB8
    PS_SHRPLUT_DATA_C = 0x692B8
    PS_SHRPLUT_DATA_D = 0x69AB8

class _PS_SHRPLUT_DATA(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AdaptiveSharpnessLutData', ctypes.c_uint32, 12),
        ('Reserved12', ctypes.c_uint32, 20),
    ]


class REG_PS_SHRPLUT_DATA(ctypes.Union):
    value = 0
    offset = 0

    AdaptiveSharpnessLutData = 0  # bit 0 to 11
    Reserved12 = 0  # bit 12 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PS_SHRPLUT_DATA),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PS_SHRPLUT_DATA, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPE_SRCSZ:
    ...
    PIPE_SRCSZ_ERLY_TPT_B = 0x71074
    PIPE_SRCSZ_ERLY_TPT_C = 0x72074
    PIPE_SRCSZ_ERLY_TPT_D = 0x73074
...
class REG_PIPE_SRCSZ(ctypes.Union):
    ...
    VerticalSourceSize = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    HorizontalSourceSize = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_PIPE_SEAM_EXCESS(ctypes.Union):
    ...
    LeftExcessAmount = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 15
    RightExcessAmount = 0  # bit 16 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_PIPE_SCANLINE(ctypes.Union):
    ...
    LineCounterForDisplay = 0  # bit 0 to 19
    Reserved20 = 0  # bit 20 to 30
    CurrentField = 0  # bit 31 to 31
...
class REG_PIPE_BOTTOM_COLOR(ctypes.Union):
    ...
    UBBottomColor = 0  # bit 0 to 9
    YGBottomColor = 0  # bit 10 to 19
    VRBottomColor = 0  # bit 20 to 29
    PipeCscEnable = 0  # bit 30 to 30
    PipeGammaEnable = 0  # bit 31 to 31
...
class OFFSET_PIPE_SRC_CLIP_COLOR:
    PIPE_SRC_CLIP_COLOR_A = 0x60104
    PIPE_SRC_CLIP_COLOR_B = 0x61104
    PIPE_SRC_CLIP_COLOR_C = 0x62104
    PIPE_SRC_CLIP_COLOR_D = 0x63104

class _PIPE_SRC_CLIP_COLOR(ctypes.LittleEndianStructure):
    _fields_ = [
        ('BlueClipColor', ctypes.c_uint32, 10),
        ('GreenClipColor', ctypes.c_uint32, 10),
        ('RedClipColor', ctypes.c_uint32, 10),
        ('Reserved30', ctypes.c_uint32, 2),
    ]


class REG_PIPE_SRC_CLIP_COLOR(ctypes.Union):
    value = 0
    offset = 0

    BlueClipColor = 0  # bit 0 to 9
    GreenClipColor = 0  # bit 10 to 19
    RedClipColor = 0  # bit 20 to 29
    Reserved30 = 0  # bit 30 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_SRC_CLIP_COLOR),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_SRC_CLIP_COLOR, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_PIPE_SOURCE_CLIP_COLOR_ENABLE(Enum):
    PIPE_SOURCE_CLIP_COLOR_DISABLE = 0x0
    PIPE_SOURCE_CLIP_COLOR_ENABLE = 0x1


class OFFSET_PIPE_SRC_CLIP_CTL:
    PIPE_SRC_CLIP_CTL_A = 0x60100
    SEL_FETCH_PIPE_SRC_CLIP_CTL_A = 0x60108
    PIPE_SRC_CLIP_CTL_B = 0x61100
    SEL_FETCH_PIPE_SRC_CLIP_CTL_B = 0x61108
    PIPE_SRC_CLIP_CTL_C = 0x62100
    SEL_FETCH_PIPE_SRC_CLIP_CTL_C = 0x62108
    PIPE_SRC_CLIP_CTL_D = 0x63100
    SEL_FETCH_PIPE_SRC_CLIP_CTL_D = 0x63108

class _PIPE_SRC_CLIP_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('BottomClip', ctypes.c_uint32, 4),
        ('TopClip', ctypes.c_uint32, 4),
        ('RightClip', ctypes.c_uint32, 4),
        ('LeftClip', ctypes.c_uint32, 4),
        ('Reserved16', ctypes.c_uint32, 15),
        ('PipeSourceClipColorEnable', ctypes.c_uint32, 1),
    ]


class REG_PIPE_SRC_CLIP_CTL(ctypes.Union):
    value = 0
    offset = 0

    BottomClip = 0  # bit 0 to 3
    TopClip = 0  # bit 4 to 7
    RightClip = 0  # bit 8 to 11
    LeftClip = 0  # bit 12 to 15
    Reserved16 = 0  # bit 16 to 30
    PipeSourceClipColorEnable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_SRC_CLIP_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_SRC_CLIP_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_DETECTED(Enum):
    DETECTED_DETECTED = 0x1
    DETECTED_NOT_DETECTED = 0x0
...
class OFFSET_PIPE_DARKCHECK:
    PIPE_DARKCHECK_A = 0x60120
    PIPE_DARKCHECK_B = 0x61120
    PIPE_DARKCHECK_C = 0x62120
    PIPE_DARKCHECK_D = 0x63120

class _PIPE_DARKCHECK(ctypes.LittleEndianStructure):
    _fields_ = [
        ('CompareValue', ctypes.c_uint32, 10),
        ('Reserved10', ctypes.c_uint32, 18),
        ('Done', ctypes.c_uint32, 1),
        ('Detected', ctypes.c_uint32, 1),
        ('Reserved30', ctypes.c_uint32, 1),
        ('Enable', ctypes.c_uint32, 1),
    ]


class REG_PIPE_DARKCHECK(ctypes.Union):
    value = 0
    offset = 0

    CompareValue = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 27
    Done = 0  # bit 28 to 28
    Detected = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 30
    Enable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_DARKCHECK),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_DARKCHECK, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_INTERNAL_DB_STALL_1(Enum):
    INTERNAL_DB_STALL_1_UNMASK = 0x0
    INTERNAL_DB_STALL_1_MASK = 0x1


class ENUM_INTERNAL_DB_STALL_2(Enum):
    INTERNAL_DB_STALL_2_UNMASK = 0x0
    INTERNAL_DB_STALL_2_MASK = 0x1


class ENUM_INTERNAL_DB_STALL_3(Enum):
    INTERNAL_DB_STALL_3_UNMASK = 0x0
    INTERNAL_DB_STALL_3_MASK = 0x1


class ENUM_INTERNAL_DB_STALL_4(Enum):
    INTERNAL_DB_STALL_4_UNMASK = 0x0
    INTERNAL_DB_STALL_4_MASK = 0x1


class OFFSET_PIPE_DB_CTL:
    PIPE_DB_CTL_A = 0x70070
    PIPE_DB_CTL_B = 0x71070
    PIPE_DB_CTL_C = 0x72070
    PIPE_DB_CTL_D = 0x73070

class _PIPE_DB_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 7),
        ('InternalDbStall1', ctypes.c_uint32, 1),
        ('Reserved8', ctypes.c_uint32, 7),
        ('InternalDbStall2', ctypes.c_uint32, 1),
        ('Reserved16', ctypes.c_uint32, 7),
        ('InternalDbStall3', ctypes.c_uint32, 1),
        ('Reserved24', ctypes.c_uint32, 7),
        ('InternalDbStall4', ctypes.c_uint32, 1),
    ]


class REG_PIPE_DB_CTL(ctypes.Union):
    value = 0
    offset = 0

    Reserved0 = 0  # bit 0 to 6
    InternalDbStall1 = 0  # bit 7 to 7
    Reserved8 = 0  # bit 8 to 14
    InternalDbStall2 = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 22
    InternalDbStall3 = 0  # bit 23 to 23
    Reserved24 = 0  # bit 24 to 30
    InternalDbStall4 = 0  # bit 31 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_DB_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_PIPE_MISC(ctypes.Union):
    ...
    BfiEnable = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 1
    DitheringType = 0  # bit 2 to 3
    DitheringEnable = 0  # bit 4 to 4
    PortOutputBpc = 0  # bit 5 to 7
    PixelRounding = 0  # bit 8 to 8
    PixelExtension = 0  # bit 9 to 9
    XvyccColorRangeLimit = 0  # bit 10 to 10
    PipeOutputColorSpaceSelect = 0  # bit 11 to 11
    OledCompensation = 0  # bit 12 to 12
    Reserved13 = 0  # bit 13 to 13
    RotationInfo = 0  # bit 14 to 15
    OverrideBlueChannel = 0  # bit 16 to 16
    OverrideGreenChannel = 0  # bit 17 to 17
    OverrideRedChannel = 0  # bit 18 to 18
    OverridePipeOutput = 0  # bit 19 to 19
    ChangeMaskForVblankVsyncInt = 0  # bit 20 to 20
    ChangeMaskForRegisterWrite = 0  # bit 21 to 21
    ChangeMaskForLdpst = 0  # bit 22 to 22
    HdrMode = 0  # bit 23 to 23
    AllowDbStall = 0  # bit 24 to 24
    PipeGammaInputClampDisable = 0  # bit 25 to 25
    Yuv420Mode = 0  # bit 26 to 26
    Yuv420Enable = 0  # bit 27 to 27
    StereoMaskPipeRender = 0  # bit 28 to 29
    StereoMaskPipeInt = 0  # bit 30 to 31
...
class REG_PIPE_MISC2(ctypes.Union):
    ...
    FlipInfoPlaneSelect = 0  # bit 0 to 2
    Reserved3 = 0  # bit 3 to 3
    ScanlinePlaneSelect = 0  # bit 4 to 6
    Reserved7 = 0  # bit 7 to 7
    AsfuFlipException = 0  # bit 8 to 8
    Reserved9 = 0  # bit 9 to 10
    Yuv422Mode = 0  # bit 11 to 11
    IpcDemoteReqChunkSize = 0  # bit 12 to 15
    UnderrunReplacementPixelValue = 0  # bit 16 to 18
    UnderrunManualPixelOverride = 0  # bit 19 to 19
    Reserved20 = 0  # bit 20 to 23
    UnderrunBubbleCounter = 0  # bit 24 to 31
...
class REG_PIPE_FRMCNT(ctypes.Union):
    ...
    PipeFrameCounter = 0  # bit 0 to 31
...
class REG_PIPE_FRMTMSTMP(ctypes.Union):
    ...
    PipeFrameTimeStamp = 0  # bit 0 to 31
...
class REG_PIPE_FLIPTMSTMP(ctypes.Union):
    ...
    PipeFlipTimeStamp = 0  # bit 0 to 31
...
class REG_PIPE_FLIPDONETMSTMP(ctypes.Union):
    ...
    PipeFlipDoneTimeStamp = 0  # bit 0 to 31
...
class OFFSET_SW_PTS_INT_VAL:
    SW_PTS_INT_VAL_CMTG = 0x44080

class _SW_PTS_INT_VAL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('SoftwarePtsInterruptValue', ctypes.c_uint32, 32),
    ]


class REG_SW_PTS_INT_VAL(ctypes.Union):
    value = 0
    offset = 0

    SoftwarePtsInterruptValue = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _SW_PTS_INT_VAL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_SW_PTS_INT_VAL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PTS_ADJUST_VALUE:
    PTS_ADJUST_VALUE = 0x45598

class _PTS_ADJUST_VALUE(ctypes.LittleEndianStructure):
    _fields_ = [
        ('MicroSeconds', ctypes.c_uint32, 32),
    ]


class REG_PTS_ADJUST_VALUE(ctypes.Union):
    value = 0
    offset = 0

    MicroSeconds = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PTS_ADJUST_VALUE),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PTS_ADJUST_VALUE, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_PIPE_SCANLINECOMP(ctypes.Union):
    ...
    EndScanLine = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 14
    RenderResponseDestination = 0  # bit 15 to 15
    StartScanLine = 0  # bit 16 to 28
    CounterSelect = 0  # bit 29 to 29
    InclusiveExclusiveSelect = 0  # bit 30 to 30
    InitiateCompare = 0  # bit 31 to 31
...
class ENUM_CGE_ENABLE(Enum):
    CGE_DISABLE = 0x0
    CGE_ENABLE = 0x1


class OFFSET_CGE_CTRL:
    CGE_CTRL_A = 0x49080
    CGE_CTRL_B = 0x49180
    CGE_CTRL_C = 0x49280
    CGE_CTRL_D = 0x49380

class _CGE_CTRL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 30),
        ('AllowDbStall', ctypes.c_uint32, 1),
        ('CgeEnable', ctypes.c_uint32, 1),
    ]


class REG_CGE_CTRL(ctypes.Union):
    value = 0
    offset = 0

    Reserved0 = 0  # bit 0 to 29
    AllowDbStall = 0  # bit 30 to 30
    CgeEnable = 0  # bit 31 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_CGE_CTRL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_CGE_WEIGHT(ctypes.Union):
    ...
    CgeWeightIndex0 = 0  # bit 0 to 5
    Reserved6 = 0  # bit 6 to 7
    CgeWeightIndex1 = 0  # bit 8 to 13
    Reserved14 = 0  # bit 14 to 15
    CgeWeightIndex2 = 0  # bit 16 to 21
    Reserved22 = 0  # bit 22 to 23
    CgeWeightIndex3 = 0  # bit 24 to 29
    Reserved30 = 0  # bit 30 to 31
    CgeWeightIndex4 = 0  # bit 32 to 37
    Reserved38 = 0  # bit 38 to 39
    CgeWeightIndex5 = 0  # bit 40 to 45
    Reserved46 = 0  # bit 46 to 47
    CgeWeightIndex6 = 0  # bit 48 to 53
    Reserved54 = 0  # bit 54 to 55
    CgeWeightIndex7 = 0  # bit 56 to 61
    Reserved62 = 0  # bit 62 to 63
    CgeWeightIndex8 = 0  # bit 64 to 69
    Reserved70 = 0  # bit 70 to 71
    CgeWeightIndex9 = 0  # bit 72 to 77
    Reserved78 = 0  # bit 78 to 79
    CgeWeightIndex10 = 0  # bit 80 to 85
    Reserved86 = 0  # bit 86 to 87
    CgeWeightIndex11 = 0  # bit 88 to 93
    Reserved94 = 0  # bit 94 to 95
    CgeWeightIndex12 = 0  # bit 96 to 101
    Reserved102 = 0  # bit 102 to 103
    CgeWeightIndex13 = 0  # bit 104 to 109
    Reserved110 = 0  # bit 110 to 111
    CgeWeightIndex14 = 0  # bit 112 to 117
    Reserved118 = 0  # bit 118 to 119
    CgeWeightIndex15 = 0  # bit 120 to 125
    Reserved126 = 0  # bit 126 to 127
    CgeWeightIndex16 = 0  # bit 128 to 133
    Reserved134 = 0  # bit 134 to 159
...
class REG_DSC_PICTURE_PARAMETER_SET_0(ctypes.Union):
    ...
    Dsc_Version_Major = 0  # bit 0 to 3
    Dsc_Version_Minor = 0  # bit 4 to 7
    Bits_Per_Component = 0  # bit 8 to 11
    Linebuf_Depth = 0  # bit 12 to 15
    Block_Pred_Enable = 0  # bit 16 to 16
    Convert_Rgb = 0  # bit 17 to 17
    Enable_422 = 0  # bit 18 to 18
    Vbr_Enable = 0  # bit 19 to 19
    Alt_Ich_Select = 0  # bit 20 to 20
    Reserved21 = 0  # bit 21 to 21
    Native_420 = 0  # bit 22 to 22
    Native_422 = 0  # bit 23 to 23
    Native_422ZeroPaddingControl = 0  # bit 24 to 25
    Reserved26 = 0  # bit 26 to 30
    AllowDbStall = 0  # bit 31 to 31
...
class _DSC_PICTURE_PARAMETER_SET_1(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Psr2SuSlice_Row_Per_Frame', ctypes.c_uint32, 12),
    ]
...
class REG_DSC_PICTURE_PARAMETER_SET_1(ctypes.Union):
    ...
    Bits_Per_Pixel = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 19
    Psr2SuSlice_Row_Per_Frame = 0  # bit 20 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_2(ctypes.Union):
    ...
    Pic_Height = 0  # bit 0 to 15
    Pic_Width = 0  # bit 16 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_3(ctypes.Union):
    ...
    Slice_Height = 0  # bit 0 to 15
    Slice_Width = 0  # bit 16 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_4(ctypes.Union):
    ...
    Initial_Xmit_Delay = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 15
    Initial_Dec_Delay = 0  # bit 16 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_5(ctypes.Union):
    ...
    Scale_Increment_Interval = 0  # bit 0 to 15
    Scale_Decrement_Interval = 0  # bit 16 to 27
...
class REG_DSC_PICTURE_PARAMETER_SET_6(ctypes.Union):
    ...
    Initial_Scale_Value = 0  # bit 0 to 5
    Reserved6 = 0  # bit 6 to 7
    First_Line_Bpg_Offset = 0  # bit 8 to 12
    Reserved13 = 0  # bit 13 to 15
    Flatness_Min_Qp = 0  # bit 16 to 20
    Reserved21 = 0  # bit 21 to 23
    Flatness_Max_Qp = 0  # bit 24 to 28
    Reserved29 = 0  # bit 29 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_7(ctypes.Union):
    ...
    Slice_Bpg_Offset = 0  # bit 0 to 15
    Nfl_Bpg_Offset = 0  # bit 16 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_8(ctypes.Union):
    ...
    Final_Offset = 0  # bit 0 to 15
    Initial_Offset = 0  # bit 16 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_9(ctypes.Union):
    ...
    Rc_Model_Size = 0  # bit 0 to 15
    Rc_Edge_Factor = 0  # bit 16 to 19
...
class REG_DSC_PICTURE_PARAMETER_SET_10(ctypes.Union):
    ...
    Rc_Quant_Incr_Limit0 = 0  # bit 0 to 4
    Reserved5 = 0  # bit 5 to 7
    Rc_Quant_Incr_Limit1 = 0  # bit 8 to 12
    Reserved13 = 0  # bit 13 to 15
    Rc_Tgt_Offset_Hi = 0  # bit 16 to 19
    Rc_Tgt_Offset_Lo = 0  # bit 20 to 23
    Reserved24 = 0  # bit 24 to 31
...
class REG_DSC_PICTURE_PARAMETER_SET_16(ctypes.Union):
    ...
    Slice_Chunk_Size = 0  # bit 0 to 15
    Slice_Per_Line = 0  # bit 16 to 18
    Reserved19 = 0  # bit 19 to 19
    Slice_Row_Per_Frame = 0  # bit 20 to 31
...
class OFFSET_DSC_PICTURE_PARAMETER_SET_17:
    DSC_PICTURE_PARAMETER_SET_17_DSC0_PA = 0x780B4
    DSC_PICTURE_PARAMETER_SET_17_DSC1_PA = 0x781B4
    DSC_PICTURE_PARAMETER_SET_17_DSC0_PB = 0x782B4
    DSC_PICTURE_PARAMETER_SET_17_DSC1_PB = 0x783B4
    DSC_PICTURE_PARAMETER_SET_17_DSC0_PC = 0x784B4
    DSC_PICTURE_PARAMETER_SET_17_DSC1_PC = 0x785B4
    DSC_PICTURE_PARAMETER_SET_17_DSC0_PD = 0x786B4
    DSC_PICTURE_PARAMETER_SET_17_DSC1_PD = 0x787B4

class _DSC_PICTURE_PARAMETER_SET_17(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 27),
        ('Second_Line_Bpg_Offset', ctypes.c_uint32, 5),
    ]


class REG_DSC_PICTURE_PARAMETER_SET_17(ctypes.Union):
    value = 0
    offset = 0

    Reserved0 = 0  # bit 0 to 26
    Second_Line_Bpg_Offset = 0  # bit 27 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DSC_PICTURE_PARAMETER_SET_17),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DSC_PICTURE_PARAMETER_SET_17, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DSC_PICTURE_PARAMETER_SET_18:
    DSC_PICTURE_PARAMETER_SET_18_DSC0_PA = 0x780B8
    DSC_PICTURE_PARAMETER_SET_18_DSC1_PA = 0x781B8
    DSC_PICTURE_PARAMETER_SET_18_DSC0_PB = 0x782B8
    DSC_PICTURE_PARAMETER_SET_18_DSC1_PB = 0x783B8
    DSC_PICTURE_PARAMETER_SET_18_DSC0_PC = 0x784B8
    DSC_PICTURE_PARAMETER_SET_18_DSC1_PC = 0x785B8
    DSC_PICTURE_PARAMETER_SET_18_DSC0_PD = 0x786B8
    DSC_PICTURE_PARAMETER_SET_18_DSC1_PD = 0x787B8

class _DSC_PICTURE_PARAMETER_SET_18(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_DSC_PICTURE_PARAMETER_SET_18(ctypes.Union):
    value = 0
    offset = 0

    Second_Line_Offset_Adj = 0  # bit 0 to 15
    Nsl_Bpg_Offset = 0  # bit 16 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DSC_PICTURE_PARAMETER_SET_18),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DSC_PICTURE_PARAMETER_SET_18, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_DSC_RC_BUF_THRESH_0(ctypes.Union):
    ...
    Rc_Buf_Thresh_0 = 0  # bit 0 to 7
    Rc_Buf_Thresh_1 = 0  # bit 8 to 15
    Rc_Buf_Thresh_2 = 0  # bit 16 to 23
    Rc_Buf_Thresh_3 = 0  # bit 24 to 31
    Rc_Buf_Thresh_4 = 0  # bit 32 to 39
    Rc_Buf_Thresh_5 = 0  # bit 40 to 47
    Rc_Buf_Thresh_6 = 0  # bit 48 to 55
    Rc_Buf_Thresh_7 = 0  # bit 56 to 63
...
class REG_DSC_RC_BUF_THRESH_1(ctypes.Union):
    ...
    Rc_Buf_Thresh_8 = 0  # bit 0 to 7
    Rc_Buf_Thresh_9 = 0  # bit 8 to 15
    Rc_Buf_Thresh_10 = 0  # bit 16 to 23
    Rc_Buf_Thresh_11 = 0  # bit 24 to 31
    Rc_Buf_Thresh_12 = 0  # bit 32 to 39
    Rc_Buf_Thresh_13 = 0  # bit 40 to 47
    Reserved48 = 0  # bit 48 to 63
...
class REG_DSC_RC_RANGE_PARAMETERS_0(ctypes.Union):
    ...
    Rc_Min_Qp_0 = 0  # bit 0 to 4
    Rc_Max_Qp_0 = 0  # bit 5 to 9
    Rc_Bpg_Offset_0 = 0  # bit 10 to 15
    Rc_Min_Qp_1 = 0  # bit 16 to 20
    Rc_Max_Qp_1 = 0  # bit 21 to 25
    Rc_Bpg_Offset_1 = 0  # bit 26 to 31
    Rc_Min_Qp_2 = 0  # bit 32 to 36
    Rc_Max_Qp_2 = 0  # bit 37 to 41
    Rc_Bpg_Offset_2 = 0  # bit 42 to 47
    Rc_Min_Qp_3 = 0  # bit 48 to 52
    Rc_Max_Qp_3 = 0  # bit 53 to 57
    Rc_Bpg_Offset_3 = 0  # bit 58 to 63
...
class REG_DSC_RC_RANGE_PARAMETERS_1(ctypes.Union):
    ...
    Rc_Min_Qp_4 = 0  # bit 0 to 4
    Rc_Max_Qp_4 = 0  # bit 5 to 9
    Rc_Bpg_Offset_4 = 0  # bit 10 to 15
    Rc_Min_Qp_5 = 0  # bit 16 to 20
    Rc_Max_Qp_5 = 0  # bit 21 to 25
    Rc_Bpg_Offset_5 = 0  # bit 26 to 31
    Rc_Min_Qp_6 = 0  # bit 32 to 36
    Rc_Max_Qp_6 = 0  # bit 37 to 41
    Rc_Bpg_Offset_6 = 0  # bit 42 to 47
    Rc_Min_Qp_7 = 0  # bit 48 to 52
    Rc_Max_Qp_7 = 0  # bit 53 to 57
    Rc_Bpg_Offset_7 = 0  # bit 58 to 63
...
class REG_DSC_RC_RANGE_PARAMETERS_2(ctypes.Union):
    ...
    Rc_Min_Qp_8 = 0  # bit 0 to 4
    Rc_Max_Qp_8 = 0  # bit 5 to 9
    Rc_Bpg_Offset_8 = 0  # bit 10 to 15
    Rc_Min_Qp_9 = 0  # bit 16 to 20
    Rc_Max_Qp_9 = 0  # bit 21 to 25
    Rc_Bpg_Offset_9 = 0  # bit 26 to 31
    Rc_Min_Qp_10 = 0  # bit 32 to 36
    Rc_Max_Qp_10 = 0  # bit 37 to 41
    Rc_Bpg_Offset_10 = 0  # bit 42 to 47
    Rc_Min_Qp_11 = 0  # bit 48 to 52
    Rc_Max_Qp_11 = 0  # bit 53 to 57
    Rc_Bpg_Offset_11 = 0  # bit 58 to 63
...
class REG_DSC_RC_RANGE_PARAMETERS_3(ctypes.Union):
    ...
    Rc_Min_Qp_12 = 0  # bit 0 to 4
    Rc_Max_Qp_12 = 0  # bit 5 to 9
    Rc_Bpg_Offset_12 = 0  # bit 10 to 15
    Rc_Min_Qp_13 = 0  # bit 16 to 20
    Rc_Max_Qp_13 = 0  # bit 21 to 25
    Rc_Bpg_Offset_13 = 0  # bit 26 to 31
    Rc_Min_Qp_14 = 0  # bit 32 to 36
    Rc_Max_Qp_14 = 0  # bit 37 to 41
    Rc_Bpg_Offset_14 = 0  # bit 42 to 47
    Reserved48 = 0  # bit 48 to 63
...
class REG_DSC_CHICKEN_1(ctypes.Union):
    ...
    OverflowAvoidCfg = 0  # bit 30 to 31
...
class ENUM_PRIMARY_ULTRA_JOINER_ENABLE(Enum):
    PRIMARY_ULTRA_JOINER_ENABLE_SECONDARY = 0x0
    PRIMARY_ULTRA_JOINER_ENABLE_PRIMARY = 0x1


class ENUM_ULTRA_JOINER_ENABLE(Enum):
    ULTRA_JOINER_DISABLE = 0x0
    ULTRA_JOINER_ENABLE = 0x1
...
class _PIPE_DSS_CTL1(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Primary_Ultra_Joiner_Enable', ctypes.c_uint32, 1),
        ('Ultra_Joiner_Enable', ctypes.c_uint32, 1),
...
class REG_PIPE_DSS_CTL1(ctypes.Union):
    ...
    LeftDlBufferTargetDepth = 0  # bit 0 to 11
    Reserved12 = 0  # bit 12 to 15
    Overlap = 0  # bit 16 to 19
    UncompressedJoinerSlave = 0  # bit 20 to 20
    UncompressedJoinerMaster = 0  # bit 21 to 21
    Primary_Ultra_Joiner_Enable = 0  # bit 22 to 22
    Ultra_Joiner_Enable = 0  # bit 23 to 23
    DualLinkMode = 0  # bit 24 to 24
    SplitterConfiguration = 0  # bit 25 to 26
    VgaCenteringEnable = 0  # bit 27 to 27
    Master_Big_Joiner_Enable = 0  # bit 28 to 28
    Big_Joiner_Enable = 0  # bit 29 to 29
    JoinerEnable = 0  # bit 30 to 30
    SplitterEnable = 0  # bit 31 to 31
...
class REG_PIPE_DSS_CTL2(ctypes.Union):
    ...
    RightDlBufferTargetDepth = 0  # bit 0 to 11
    Spare12 = 0  # bit 12 to 12
    Spare13 = 0  # bit 13 to 13
    Spare14 = 0  # bit 14 to 14
    RightBranchVdscEnable = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 23
    Spare24 = 0  # bit 24 to 24
    Spare25 = 0  # bit 25 to 25
    Spare26 = 0  # bit 26 to 26
    Reserved27 = 0  # bit 27 to 30
    LeftBranchVdscEnable = 0  # bit 31 to 31
...
class ENUM_DSC_PIXEL_REPLICATION(Enum):
    DSC_PIXEL_REPLICATION_NO_PIXEL_REPLICATION = 0x0


class OFFSET_PIPE_DSS_CTL3:
    PIPE_DSS_CTL3_PA = 0x780F0
    PIPE_DSS_CTL3_PB = 0x782F0
    PIPE_DSS_CTL3_PC = 0x784F0
    PIPE_DSS_CTL3_PD = 0x786F0

class _PIPE_DSS_CTL3(ctypes.LittleEndianStructure):
    _fields_ = [
        ('DscPixelReplication', ctypes.c_uint32, 16),
        ('Reserved16', ctypes.c_uint32, 16),
    ]


class REG_PIPE_DSS_CTL3(ctypes.Union):
    value = 0
    offset = 0

    DscPixelReplication = 0  # bit 0 to 15
    Reserved16 = 0  # bit 16 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_DSS_CTL3),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_DSS_CTL3, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_GAMMA_MODE(ctypes.Union):
    ...
    GammaMode = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 2
    GammaModeCc2 = 0  # bit 3 to 4
    Reserved5 = 0  # bit 5 to 14
    PaletteAnticolDis = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 24
    PostCscCc2DitheringEnable = 0  # bit 25 to 25
    PostCscCc1DitheringEnable = 0  # bit 26 to 26
    PostCscCc2GammaEnable = 0  # bit 27 to 27
    PreCscCc2GammaEnable = 0  # bit 28 to 28
    AllowDbStall = 0  # bit 29 to 29
    PostCscGammaEnable = 0  # bit 30 to 30
    PreCscGammaEnable = 0  # bit 31 to 31
...
class REG_PAL_PREC_INDEX(ctypes.Union):
    ...
    IndexValue = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 14
    IndexAutoIncrement = 0  # bit 15 to 15
    Reserved16 = 0  # bit 16 to 31
...
class REG_PAL_PREC_DATA(ctypes.Union):
    ...
    BluePrecisionPaletteEntry = 0  # bit 0 to 9
    GreenPrecisionPaletteEntry = 0  # bit 10 to 19
    RedPrecisionPaletteEntry = 0  # bit 20 to 29
    Reserved30 = 0  # bit 30 to 31
...
class REG_PAL_GC_MAX(ctypes.Union):
    ...
    RedMaxGcPoint = 0  # bit 0 to 16
    Reserved17 = 0  # bit 17 to 31
    GreenMaxGcPoint = 0  # bit 32 to 48
    Reserved49 = 0  # bit 49 to 63
    BlueMaxGcPoint = 0  # bit 64 to 80
    Reserved81 = 0  # bit 81 to 95
...
class _PAL_EXT_GC_MAX(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Reserved51', ctypes.c_uint32, 13),
        ('BlueExtMaxGcPoint', ctypes.c_uint32, 19),
        ('Reserved83', ctypes.c_uint32, 13),
    ]
...
class REG_PAL_EXT_GC_MAX(ctypes.Union):
    ...
    RedExtMaxGcPoint = 0  # bit 0 to 18
    Reserved19 = 0  # bit 19 to 31
    GreenExtMaxGcPoint = 0  # bit 32 to 50
    Reserved51 = 0  # bit 51 to 63
    BlueExtMaxGcPoint = 0  # bit 64 to 82
    Reserved83 = 0  # bit 83 to 95
...
class REG_CSC_COEFF(ctypes.Union):
    ...
    Gy = 0  # bit 0 to 15
    Ry = 0  # bit 16 to 31
    Reserved32 = 0  # bit 32 to 47
    By = 0  # bit 48 to 63
    Gu = 0  # bit 64 to 79
    Ru = 0  # bit 80 to 95
    Reserved96 = 0  # bit 96 to 111
    Bu = 0  # bit 112 to 127
    Gv = 0  # bit 128 to 143
    Rv = 0  # bit 144 to 159
    Reserved160 = 0  # bit 160 to 175
    Bv = 0  # bit 176 to 191

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _CSC_COEFF),
        ('value', ctypes.c_uint32 * 6)
    ]
...
class _CSC_PREOFF(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Reserved45', ctypes.c_uint32, 19),
        ('PrecscLowOffset', ctypes.c_uint32, 13),
        ('Reserved77', ctypes.c_uint32, 19),
    ]
...
class REG_CSC_PREOFF(ctypes.Union):
    ...
    PrecscHighOffset = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 31
    PrecscMediumOffset = 0  # bit 32 to 44
    Reserved45 = 0  # bit 45 to 63
    PrecscLowOffset = 0  # bit 64 to 76
    Reserved77 = 0  # bit 77 to 95
...
class REG_CSC_POSTOFF(ctypes.Union):
    ...
    PostcscHighOffset = 0  # bit 0 to 12
    Reserved13 = 0  # bit 13 to 31
    PostcscMediumOffset = 0  # bit 32 to 44
    Reserved45 = 0  # bit 45 to 63
    PostcscLowOffset = 0  # bit 64 to 76
    Reserved77 = 0  # bit 77 to 95
...
class REG_CSC_MODE(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 27
    PipeCscCC2Enable = 0  # bit 28 to 28
    AllowDbStall = 0  # bit 29 to 29
    PipeOutputCscEnable = 0  # bit 30 to 30
    PipeCscEnable = 0  # bit 31 to 31
...
class REG_OUTPUT_CSC_PREOFF(ctypes.Union):
    value = []
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _OUTPUT_CSC_PREOFF),
        ('value', ctypes.c_uint32 * 3)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_OUTPUT_CSC_PREOFF, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            for i, v in enumerate(value):
...
class REG_LUT_3D_CTL(ctypes.Union):
    ...
    AllowDbStall = 0  # bit 29 to 29
    NewLutReady = 0  # bit 30 to 30
    Lut3DEnable = 0  # bit 31 to 31
...
class REG_LUT_3D_INDEX(ctypes.Union):
    ...
    IndexValue = 0  # bit 0 to 12
    IndexAutoIncrement = 0  # bit 13 to 13
    Reserved14 = 0  # bit 14 to 31
...
class REG_DPLC_CTL(ctypes.Union):
    ...
    TileSize = 0  # bit 0 to 0
    HistBufferDelay = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    Spare3 = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
    ...
    Spare10 = 0  # bit 10 to 10
    Spare11 = 0  # bit 11 to 11
    EnhancementMode = 0  # bit 12 to 13
    Reserved14 = 0  # bit 14 to 18
    HistDisableMode = 0  # bit 19 to 19
    ArbitrationOption = 0  # bit 20 to 20
    MaskDmcTrigger = 0  # bit 21 to 21
    HistogramRamReadbackReturn = 0  # bit 22 to 22
    FastAccessModeEnable = 0  # bit 23 to 23
    AllowDbStall = 0  # bit 24 to 24
    IeBufferId = 0  # bit 25 to 25
    HistogramBufferId = 0  # bit 26 to 26
    FrameHistogramDone = 0  # bit 27 to 27
    Orientation = 0  # bit 28 to 28
    LoadIe = 0  # bit 29 to 29
    IeEnable = 0  # bit 30 to 30
    FunctionEnable = 0  # bit 31 to 31
...
class REG_DPLC_IE_DATA(ctypes.Union):
    ...
    EvenPoint = 0  # bit 0 to 11
    Reserved12 = 0  # bit 12 to 15
    OddPoint = 0  # bit 16 to 27
    Reserved28 = 0  # bit 28 to 31
...
class REG_DPLC_RESTORE(ctypes.Union):
    ...
    IeBufferIdStateRestore = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 31
...
class ENUM_HISTOGRAM_MODE_SELECT(Enum):
    ...
    HISTOGRAM_MODE_SELECT_PROGRAMMABLE_COEFFICIENT_MODE = 0x2  # Programmable Coefficient Mode. Uses the coefficients p
                                                               # rogrammed in DPST_HISTOGRAM_PROG_COEF.
...
class _DPST_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('HistogramModeSelect', ctypes.c_uint32, 2),
...
class REG_DPST_CTL(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 6
    AllowDbStall = 0  # bit 7 to 7
    Reserved8 = 0  # bit 8 to 10
    Reserved11 = 0  # bit 11 to 11
    Reserved12 = 0  # bit 12 to 12
    EnhancementMode = 0  # bit 13 to 14
    IeTableValueFormat = 0  # bit 15 to 15
    GuardbandInterruptDelayCounter = 0  # bit 16 to 23
    HistogramModeSelect = 0  # bit 24 to 25
    Reserved26 = 0  # bit 26 to 26
    IeModificationTableEnable = 0  # bit 27 to 27
    RestoreDpst = 0  # bit 28 to 28
    Reserved29 = 0  # bit 29 to 30
    IeHistogramEnable = 0  # bit 31 to 31
...
class REG_DPST_GUARD(ctypes.Union):
    ...
    ThresholdGuardband = 0  # bit 0 to 21
    GuardbandInterruptDelay = 0  # bit 22 to 29
    HistogramEventStatus = 0  # bit 30 to 30
    HistogramInterruptEnable = 0  # bit 31 to 31
...
class ENUM_SEGMENT(Enum):
    SEGMENT_FRAME_SEGMENTS = 0x0
    SEGMENT_FULL_FRAME = 0x80


class ENUM_SEGMENT_READ_ENABLE(Enum):
    SEGMENT_READ_DISABLE = 0x0
    SEGMENT_READ_ENABLE = 0x1


class OFFSET_DPST_HIST_INDEX:
    DPST_HIST_INDEX_A = 0x490D8
    DPST_HIST_INDEX_B = 0x491D8
    DPST_HIST_INDEX_C = 0x492D8
    DPST_HIST_INDEX_D = 0x493D8

class _DPST_HIST_INDEX(ctypes.LittleEndianStructure):
    _fields_ = [
        ('BinIndex', ctypes.c_uint32, 5),
        ('Reserved5', ctypes.c_uint32, 3),
        ('Segment', ctypes.c_uint32, 8),
        ('Reserved16', ctypes.c_uint32, 15),
        ('SegmentReadEnable', ctypes.c_uint32, 1),
    ]


class REG_DPST_HIST_INDEX(ctypes.Union):
    value = 0
    offset = 0

    BinIndex = 0  # bit 0 to 4
    Reserved5 = 0  # bit 5 to 7
    Segment = 0  # bit 8 to 15
    Reserved16 = 0  # bit 16 to 30
    SegmentReadEnable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DPST_HIST_INDEX),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_HIST_INDEX, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_BUSY_BIT(Enum):
    BUSY_BIT_VALID = 0x0
    BUSY_BIT_BUSY = 0x1


class OFFSET_DPST_HIST_BIN:
    DPST_HIST_BIN_A = 0x490C4
    DPST_HIST_BIN_B = 0x491C4
    DPST_HIST_BIN_C = 0x492C4
    DPST_HIST_BIN_D = 0x493C4

class _DPST_HIST_BIN(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Data', ctypes.c_uint32, 31),
        ('BusyBit', ctypes.c_uint32, 1),
    ]


class REG_DPST_HIST_BIN(ctypes.Union):
    value = 0
    offset = 0

    Data = 0  # bit 0 to 30
    BusyBit = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DPST_HIST_BIN),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_HIST_BIN, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DPST_IE_INDEX:
    DPST_IE_INDEX_A = 0x490DC
    DPST_IE_INDEX_B = 0x491DC
    DPST_IE_INDEX_C = 0x492DC
    DPST_IE_INDEX_D = 0x493DC

class _DPST_IE_INDEX(ctypes.LittleEndianStructure):
    _fields_ = [
        ('BinIndex', ctypes.c_uint32, 7),
        ('Reserved7', ctypes.c_uint32, 25),
    ]


class REG_DPST_IE_INDEX(ctypes.Union):
    value = 0
    offset = 0

    BinIndex = 0  # bit 0 to 6
    Reserved7 = 0  # bit 7 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DPST_IE_INDEX),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_IE_INDEX, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_DPST_IE_BIN(ctypes.Union):
    value = 0
    offset = 0
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_IE_BIN, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_SELECTIVE_FETCH_ENABLE(Enum):
    SELECTIVE_FETCH_DISABLE = 0x0
    SELECTIVE_FETCH_ENABLE = 0x1


class OFFSET_DPST_SF_CTL:
    DPST_SF_CTL_A = 0x490D0
    DPST_SF_CTL_B = 0x491D0
    DPST_SF_CTL_C = 0x492D0
    DPST_SF_CTL_D = 0x493D0

class _DPST_SF_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 31),
        ('SelectiveFetchEnable', ctypes.c_uint32, 1),
    ]


class REG_DPST_SF_CTL(ctypes.Union):
    value = 0
    offset = 0

    Reserved0 = 0  # bit 0 to 30
    SelectiveFetchEnable = 0  # bit 31 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_SF_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_SEGMENT_SIZE(Enum):
    SEGMENT_SIZE_32_LINES = 0x20


class OFFSET_DPST_SF_SEG:
    DPST_SF_SEG_A = 0x490D4
    DPST_SF_SEG_B = 0x491D4
    DPST_SF_SEG_C = 0x492D4
    DPST_SF_SEG_D = 0x493D4

class _DPST_SF_SEG(ctypes.LittleEndianStructure):
    _fields_ = [
        ('SegmentSize', ctypes.c_uint32, 16),
        ('SegmentEnd', ctypes.c_uint32, 7),
        ('Reserved23', ctypes.c_uint32, 1),
        ('SegmentStart', ctypes.c_uint32, 7),
        ('Reserved31', ctypes.c_uint32, 1),
    ]


class REG_DPST_SF_SEG(ctypes.Union):
    value = 0
    offset = 0

    SegmentSize = 0  # bit 0 to 15
    SegmentEnd = 0  # bit 16 to 22
    Reserved23 = 0  # bit 23 to 23
    SegmentStart = 0  # bit 24 to 30
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_SF_SEG, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_DPST_HISTOGRAM_PROG_COEF:
    DPST_HISTOGRAM_PROG_COEF_A = 0x490E0
    DPST_HISTOGRAM_PROG_COEF_B = 0x491E0
    DPST_HISTOGRAM_PROG_COEF_C = 0x492E0
    DPST_HISTOGRAM_PROG_COEF_D = 0x493E0

class _DPST_HISTOGRAM_PROG_COEF(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_DPST_HISTOGRAM_PROG_COEF(ctypes.Union):
    value = 0
    offset = 0

    BlueCoefficient = 0  # bit 0 to 8
    Reserved9 = 0  # bit 9 to 9
    GreenCoefficient = 0  # bit 10 to 18
    Reserved19 = 0  # bit 19 to 19
    RedCoefficient = 0  # bit 20 to 28
    Reserved29 = 0  # bit 29 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _DPST_HISTOGRAM_PROG_COEF),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_DPST_HISTOGRAM_PROG_COEF, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_IPC_DEMOTE_COUNT_PIPE_A_SELECT(Enum):
    IPC_DEMOTE_COUNT_PIPE_A_SELECT_DISABLE = 0x0
    IPC_DEMOTE_COUNT_PIPE_A_SELECT_ENABLE = 0x1


class ENUM_IPC_DEMOTE_COUNT_PIPE_B_SELECT(Enum):
    IPC_DEMOTE_COUNT_PIPE_B_SELECT_DISABLE = 0x0
    IPC_DEMOTE_COUNT_PIPE_B_SELECT_ENABLE = 0x1


class ENUM_IPC_DEMOTE_COUNT_PIPE_C_SELECT(Enum):
    IPC_DEMOTE_COUNT_PIPE_C_SELECT_DISABLE = 0x0
    IPC_DEMOTE_COUNT_PIPE_C_SELECT_ENABLE = 0x1


class ENUM_IPC_DEMOTE_COUNT_PIPE_D_SELECT(Enum):
    IPC_DEMOTE_COUNT_PIPE_D_SELECT_DISABLE = 0x0
    IPC_DEMOTE_COUNT_PIPE_D_SELECT_ENABLE = 0x1


class ENUM_ENABLE_IPC_VC1_DEMOTE_COUNT(Enum):
    ENABLE_IPC_VC1_DEMOTE_COUNT_DISABLE = 0x0
    ENABLE_IPC_VC1_DEMOTE_COUNT_ENABLE = 0x1
...
class _ARB_HP_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('IpcDemoteCountPipeASelect', ctypes.c_uint32, 1),
        ('IpcDemoteCountPipeBSelect', ctypes.c_uint32, 1),
        ('IpcDemoteCountPipeCSelect', ctypes.c_uint32, 1),
        ('IpcDemoteCountPipeDSelect', ctypes.c_uint32, 1),
        ('EnableIpcVc1DemoteCount', ctypes.c_uint32, 1),
...
class REG_ARB_HP_CTL(ctypes.Union):
    ...
    RtidFifoWatermark = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 2
    EnableIpc = 0  # bit 3 to 3
    IackThrottleMax = 0  # bit 4 to 8
    Reserved9 = 0  # bit 9 to 9
    Abox0AtsRequestThrottle = 0  # bit 10 to 14
    Abox1AtsRequestThrottle = 0  # bit 15 to 19
    Reserved20 = 0  # bit 20 to 20
    IpcDemoteCountPipeASelect = 0  # bit 21 to 21
    IpcDemoteCountPipeBSelect = 0  # bit 22 to 22
    IpcDemoteCountPipeCSelect = 0  # bit 23 to 23
    IpcDemoteCountPipeDSelect = 0  # bit 24 to 24
    EnableIpcVc1DemoteCount = 0  # bit 25 to 25
...
class ENUM_WRITE_COMPLETION_DISABLE(Enum):
    WRITE_COMPLETION_ENABLED = 0x0
    WRITE_COMPLETION_DISABLED = 0x1


class ENUM_LP_WRITE_COMPLETION_REQUEST_INFLIGHT_THRESHOLD(Enum):
    LP_WRITE_COMPLETION_REQUEST_INFLIGHT_THRESHOLD_64 = 0x0
    LP_WRITE_COMPLETION_REQUEST_INFLIGHT_THRESHOLD_128 = 0x1
    LP_WRITE_COMPLETION_REQUEST_INFLIGHT_THRESHOLD_192 = 0x2
    LP_WRITE_COMPLETION_REQUEST_INFLIGHT_THRESHOLD_256 = 0x3
...
class ENUM_INFLIGHT_LP_READ_REQUEST_LIMIT_ENABLE(Enum):
    INFLIGHT_LP_READ_REQUEST_LIMIT_DISABLED = 0x0
    INFLIGHT_LP_READ_REQUEST_LIMIT_ENABLED = 0x1
...
class ENUM_DARBL_REQUEST_LIMIT(Enum):
    DARBL_REQUEST_LIMIT_1 = 0x0
    DARBL_REQUEST_LIMIT_2 = 0x1
    DARBL_REQUEST_LIMIT_4 = 0x2
    DARBL_REQUEST_LIMIT_16 = 0x3
...
class ENUM_DSB_LP_WRITE_REQUEST_LIMIT(Enum):
    DSB_LP_WRITE_REQUEST_LIMIT_1 = 0x0
    DSB_LP_WRITE_REQUEST_LIMIT_2 = 0x1
    DSB_LP_WRITE_REQUEST_LIMIT_4 = 0x2
    DSB_LP_WRITE_REQUEST_LIMIT_8 = 0x3
...
class OFFSET_ARB_LP_CTL:
    ARB_LP_CTL = 0x45000

class _ARB_LP_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('WriteCompletionDisable', ctypes.c_uint32, 1),
        ('LpReadCompletionQueueOverflow', ctypes.c_uint32, 1),
        ('LpWriteCompletionQueueOverflow', ctypes.c_uint32, 1),
        ('LpWriteCompletionRequestInflightThreshold', ctypes.c_uint32, 2),
        ('Reserved5', ctypes.c_uint32, 4),
        ('InflightLpReadRequestLimit', ctypes.c_uint32, 2),
        ('InflightLpReadRequestLimitEnable', ctypes.c_uint32, 1),
        ('Reserved12', ctypes.c_uint32, 4),
        ('FbcRequestLimit', ctypes.c_uint32, 2),
        ('DarblRequestLimit', ctypes.c_uint32, 2),
        ('Reserved20', ctypes.c_uint32, 4),
        ('LpWriteRequestLimit', ctypes.c_uint32, 2),
        ('DsbLpWriteRequestLimit', ctypes.c_uint32, 2),
...
class REG_ARB_LP_CTL(ctypes.Union):
    value = 0
    offset = 0

    WriteCompletionDisable = 0  # bit 0 to 0
    LpReadCompletionQueueOverflow = 0  # bit 1 to 1
    LpWriteCompletionQueueOverflow = 0  # bit 2 to 2
    LpWriteCompletionRequestInflightThreshold = 0  # bit 3 to 4
    Reserved5 = 0  # bit 5 to 8
    InflightLpReadRequestLimit = 0  # bit 9 to 10
    InflightLpReadRequestLimitEnable = 0  # bit 11 to 11
    Reserved12 = 0  # bit 12 to 15
    FbcRequestLimit = 0  # bit 16 to 17
    DarblRequestLimit = 0  # bit 18 to 19
    Reserved20 = 0  # bit 20 to 23
    LpWriteRequestLimit = 0  # bit 24 to 25
    DsbLpWriteRequestLimit = 0  # bit 26 to 27
    LpWdWriteRequestLimit = 0  # bit 28 to 29
    KvmrMemoryWake = 0  # bit 30 to 30
    FbcMemoryWake = 0  # bit 31 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_ARB_LP_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_DSB_ARBITRATION_INTERVAL(Enum):
    DSB_ARBITRATION_INTERVAL_16_CLOCKS = 0x0
    DSB_ARBITRATION_INTERVAL_32_CLOCKS = 0x1
    DSB_ARBITRATION_INTERVAL_64_CLOCKS = 0x2
    DSB_ARBITRATION_INTERVAL_128_CLOCKS = 0x3


class ENUM_DISABLE_BLOCK_VALID_CHECK(Enum):
    DISABLE_BLOCK_VALID_CHECK_ENABLE = 0x0
    DISABLE_BLOCK_VALID_CHECK_DISABLE = 0x1


class ENUM_DISABLE_COLOR_CLEAR_LOOKUP(Enum):
    DISABLE_COLOR_CLEAR_LOOKUP_ENABLE = 0x0
    DISABLE_COLOR_CLEAR_LOOKUP_DISABLE = 0x1


class ENUM_DISABLE_WEIGHTED_ARBITRATION(Enum):
    DISABLE_WEIGHTED_ARBITRATION_ENABLE = 0x0
    DISABLE_WEIGHTED_ARBITRATION_DISABLE = 0x1


class OFFSET_PIPE_ARB_CTL:
    PIPE_ARB_CTL_A = 0x70028
    PIPE_ARB_CTL_B = 0x71028
    PIPE_ARB_CTL_C = 0x72028
    PIPE_ARB_CTL_D = 0x73028

class _PIPE_ARB_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('FrameStartDrainDelay', ctypes.c_uint32, 6),
        ('Reserved6', ctypes.c_uint32, 4),
        ('DsbArbitrationInterval', ctypes.c_uint32, 2),
        ('DisableBlockValidCheck', ctypes.c_uint32, 1),
        ('UseProgrammedSlots', ctypes.c_uint32, 1),
        ('Reserved14', ctypes.c_uint32, 2),
        ('AdditionalSlots', ctypes.c_uint32, 3),
        ('DisableColorClearLookup', ctypes.c_uint32, 1),
        ('DisableWeightedArbitration', ctypes.c_uint32, 1),
        ('RequestVsDataArbitration', ctypes.c_uint32, 5),
        ('AtsThrottleMax', ctypes.c_uint32, 5),
        ('Reserved31', ctypes.c_uint32, 1),
    ]


class REG_PIPE_ARB_CTL(ctypes.Union):
    value = 0
    offset = 0

    FrameStartDrainDelay = 0  # bit 0 to 5
    Reserved6 = 0  # bit 6 to 9
    DsbArbitrationInterval = 0  # bit 10 to 11
    DisableBlockValidCheck = 0  # bit 12 to 12
    UseProgrammedSlots = 0  # bit 13 to 13
    Reserved14 = 0  # bit 14 to 15
    AdditionalSlots = 0  # bit 16 to 18
    DisableColorClearLookup = 0  # bit 19 to 19
    DisableWeightedArbitration = 0  # bit 20 to 20
    RequestVsDataArbitration = 0  # bit 21 to 25
    AtsThrottleMax = 0  # bit 26 to 30
    Reserved31 = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_ARB_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_ARB_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_PIPE_CLKGATE_DIS(ctypes.Union):
    ...
    DoledGatingDis = 0  # bit 0 to 0
    DarpbGatingDis = 0  # bit 1 to 1
    Dprp4GatingDis = 0  # bit 2 to 2
    Dup4GatingDis = 0  # bit 3 to 3
    DplmGatingDis = 0  # bit 4 to 4
    Dups4GatingDis = 0  # bit 5 to 5
    DprcGatingDis = 0  # bit 6 to 6
    DpstGatingDis = 0  # bit 7 to 7
    DpfrGatingDis = 0  # bit 8 to 8
    DpfPipeBindingGatingDis = 0  # bit 9 to 9
    DpfGatingDis = 0  # bit 10 to 10
    DpbGatingDis = 0  # bit 11 to 11
    Dprp1GatingDis = 0  # bit 12 to 12
    Dup1GatingDis = 0  # bit 13 to 13
    Reserved14 = 0  # bit 14 to 14
    Dups1GatingDis = 0  # bit 15 to 15
    Dprp2GatingDis = 0  # bit 16 to 16
    Dup2GatingDis = 0  # bit 17 to 17
    Reserved18 = 0  # bit 18 to 18
    Dups2GatingDis = 0  # bit 19 to 19
    Dprp3GatingDis = 0  # bit 20 to 20
    Dup3GatingDis = 0  # bit 21 to 21
    Reserved22 = 0  # bit 22 to 22
    Dups3GatingDis = 0  # bit 23 to 23
    DmuxGatingDis = 0  # bit 24 to 24
    DprsGatingDis = 0  # bit 25 to 25
    DpcebGatingDis = 0  # bit 26 to 26
    DarbsGatingDis = 0  # bit 27 to 27
    DcGatingDis = 0  # bit 28 to 28
    DdbGatingDis = 0  # bit 29 to 29
    Reserved30 = 0  # bit 30 to 30
    DpccGatingDis = 0  # bit 31 to 31
...
class ENUM_REPORT_CRC_ON_DMUX_FRAMEDONE(Enum):
    REPORT_CRC_ON_DMUX_FRAMEDONE_DO_NOT_OVERWRITE_CRC_DONE_WITH_DMUX_FRAMEDONE_INDICATION_FOR_WIDI = 0x0
    REPORT_CRC_ON_DMUX_FRAMEDONE_OVERWRITE_CRC_DONE_WITH_DMUX_FRAMEDONE_INDICATION_FOR_WIDI = 0x1
...
class ENUM_OLED_COMP_SIZE_DISABLE(Enum):
    OLED_COMP_SIZE_DISABLE_DO_NOT_SKIP_WINDOWING_LOGIC_FOR_OLED_PLANE = 0x0
    OLED_COMP_SIZE_DISABLE_SKIP_WINDOWING_LOGIC_FOR_OLED_PLANE = 0x1
...
class _PIPE_CHICKEN(ctypes.LittleEndianStructure):
    _fields_ = [
        ...
        ('Spare18', ctypes.c_uint32, 1),
        ('Spare19', ctypes.c_uint32, 1),
        ('ReportCrcOnDmuxFramedone', ctypes.c_uint32, 1),
        ('Spare21', ctypes.c_uint32, 1),
        ...
        ('OledCompSizeDisable', ctypes.c_uint32, 1),
    ]
...
class REG_PIPE_CHICKEN(ctypes.Union):
    ...
    Spare1 = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    SurfaceArmingRequiredSync = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    Spare5 = 0  # bit 5 to 5
    Spare6 = 0  # bit 6 to 6
    MaskFlips = 0  # bit 7 to 7
    Spare8 = 0  # bit 8 to 8
    Spare9 = 0  # bit 9 to 9
    Spare10 = 0  # bit 10 to 10
    Spare11 = 0  # bit 11 to 11
    Spare12 = 0  # bit 12 to 12
    RevertBottomColorPixelFix = 0  # bit 13 to 13
    _3DLutOnFirstFrame = 0  # bit 14 to 14
    Spare15 = 0  # bit 15 to 15
    Spare16 = 0  # bit 16 to 16
    Spare17 = 0  # bit 17 to 17
    Spare18 = 0  # bit 18 to 18
    Spare19 = 0  # bit 19 to 19
    ReportCrcOnDmuxFramedone = 0  # bit 20 to 20
    Spare21 = 0  # bit 21 to 21
    ScalerPwrGateEbbs = 0  # bit 22 to 22
    Spare23 = 0  # bit 23 to 23
    Spare24 = 0  # bit 24 to 24
    Spare25 = 0  # bit 25 to 25
    Spare26 = 0  # bit 26 to 26
    Spare27 = 0  # bit 27 to 27
    Spare28 = 0  # bit 28 to 28
    DisableDpstWriteExitPsr = 0  # bit 29 to 29
    DisablePipeUnderrunRecovery = 0  # bit 30 to 30
    OledCompSizeDisable = 0  # bit 31 to 31
...
class REG_DPLC_PART_CTL(ctypes.Union):
    ...
    PartAStartTileRow = 0  # bit 0 to 4
    PartAEndTileRow = 0  # bit 5 to 9
    Reserved10 = 0  # bit 10 to 15
    PartBStartTileRow = 0  # bit 16 to 20
    PartBEndTileRow = 0  # bit 21 to 25
    Reserved26 = 0  # bit 26 to 31
...
class REG_DPLC_FA_SURF(ctypes.Union):
    ...
    SurfaceBaseAddress = 0  # bit 12 to 31
...
class REG_DPLC_FA_STATUS(ctypes.Union):
    ...
    PartAHistogramReady = 0  # bit 0 to 0
    PartALoadIe = 0  # bit 1 to 1
    PartAHistogramCopyDone = 0  # bit 2 to 2
    Reserved3 = 0  # bit 3 to 15
    PartBHistogramReady = 0  # bit 16 to 16
    PartBLoadIe = 0  # bit 17 to 17
    PartBHistogramCopyDone = 0  # bit 18 to 18
    Reserved19 = 0  # bit 19 to 31
...
class ENUM_A_CREDITS(Enum):
    A_CREDITS_8_CREDITS = 0x8
    A_CREDITS_12_CREDITS = 0xC
...
class REG_MBUS_DBOX_CTL(ctypes.Union):
    ...
    ACredits = 0  # bit 0 to 3
    Reserved4 = 0  # bit 4 to 4
    ICredits = 0  # bit 5 to 7
    BCredits = 0  # bit 8 to 12
    Reserved13 = 0  # bit 13 to 15
...
class REG_MBUS_UBOX_CTL(ctypes.Union):
    ...
    VgaBCredits = 0  # bit 0 to 2
    Reserved3 = 0  # bit 3 to 3
    KvmSpriteACredits = 0  # bit 4 to 6
...
class REG_PIPE_MISC3(ctypes.Union):
    ...
    HighestRecoveryCounterStatus = 0  # bit 0 to 15
    PipeSourceSizeExcess = 0  # bit 16 to 23
...
class ENUM_PIPE_BINDING(Enum):
    ...
    PIPE_BINDING_A_B_C_D = 0xF  # Pipes A, B, C, and D are joined.


class ENUM_CURRENT_PIPE_POSITION(Enum):
    CURRENT_PIPE_POSITION_FIRST_FROM_LEFT = 0x0
    CURRENT_PIPE_POSITION_SECOND_FROM_LEFT = 0x1
    CURRENT_PIPE_POSITION_THIRD_FROM_LEFT = 0x2
    CURRENT_PIPE_POSITION_FOURTH_FROM_LEFT = 0x3
...
class REG_PIPE_MISC4(ctypes.Union):
    ...
    Reserved0 = 0  # bit 0 to 0
    RightFilterCoeff = 0  # bit 1 to 7
    Reserved8 = 0  # bit 8 to 8
    CenterFilterCoeff = 0  # bit 9 to 15
    Reserved16 = 0  # bit 16 to 16
    LeftFilterCoeff = 0  # bit 17 to 23
    PipeBinding = 0  # bit 24 to 27
    CurrentPipePosition = 0  # bit 28 to 29
    Reserved30 = 0  # bit 30 to 31
...
class ENUM_EVENT_TYPE(Enum):
    EVENT_TYPE_LEVEL_0 = 0x0
    EVENT_TYPE_LEVEL_1 = 0x1
    EVENT_TYPE_EDGE_1_TO_0 = 0x2
    EVENT_TYPE_EDGE_0_TO_1 = 0x3


class ENUM_EVENT_RECURRENCE(Enum):
    EVENT_RECURRENCE_SINGLE = 0x0  # Single event - The event enable is cleared by DMC
    EVENT_RECURRENCE_RECURRING = 0x1  # Recurring event - The event is not cleared by DMC


class ENUM_EVENT_ENABLE(Enum):
    EVENT_DISABLE = 0x0
    EVENT_ENABLE = 0x1


class OFFSET_PIPEDMC_EVT_CTL:
    PIPEDMC_EVT_CTL_0_A = 0x5F034
    PIPEDMC_EVT_CTL_1_A = 0x5F038
    PIPEDMC_EVT_CTL_2_A = 0x5F03C
    PIPEDMC_EVT_CTL_3_A = 0x5F040
    PIPEDMC_EVT_CTL_4_A = 0x5F044
    PIPEDMC_EVT_CTL_5_A = 0x5F048
    PIPEDMC_EVT_CTL_6_A = 0x5F04C
    PIPEDMC_EVT_CTL_7_A = 0x5F050
    PIPEDMC_EVT_CTL_0_B = 0x5F434
    PIPEDMC_EVT_CTL_1_B = 0x5F438
    PIPEDMC_EVT_CTL_2_B = 0x5F43C
    PIPEDMC_EVT_CTL_3_B = 0x5F440
    PIPEDMC_EVT_CTL_4_B = 0x5F444
    PIPEDMC_EVT_CTL_5_B = 0x5F448
    PIPEDMC_EVT_CTL_6_B = 0x5F44C
    PIPEDMC_EVT_CTL_7_B = 0x5F450
    PIPEDMC_EVT_CTL_0_C = 0x5F834
    PIPEDMC_EVT_CTL_1_C = 0x5F838
    PIPEDMC_EVT_CTL_2_C = 0x5F83C
    PIPEDMC_EVT_CTL_3_C = 0x5F840
    PIPEDMC_EVT_CTL_4_C = 0x5F844
    PIPEDMC_EVT_CTL_5_C = 0x5F848
    PIPEDMC_EVT_CTL_6_C = 0x5F84C
    PIPEDMC_EVT_CTL_7_C = 0x5F850
    PIPEDMC_EVT_CTL_0_D = 0x5FC34
    PIPEDMC_EVT_CTL_1_D = 0x5FC38
    PIPEDMC_EVT_CTL_2_D = 0x5FC3C
    PIPEDMC_EVT_CTL_3_D = 0x5FC40
    PIPEDMC_EVT_CTL_4_D = 0x5FC44
    PIPEDMC_EVT_CTL_5_D = 0x5FC48
    PIPEDMC_EVT_CTL_6_D = 0x5FC4C
    PIPEDMC_EVT_CTL_7_D = 0x5FC50

class _PIPEDMC_EVT_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Reserved0', ctypes.c_uint32, 8),
        ('Event_Id', ctypes.c_uint32, 8),
        ('Event_Type', ctypes.c_uint32, 2),
        ('Reserved18', ctypes.c_uint32, 12),
        ('Event_Recurrence', ctypes.c_uint32, 1),
        ('Event_Enable', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_EVT_CTL(ctypes.Union):
    value = 0
    offset = 0

    Reserved0 = 0  # bit 0 to 7
    Event_Id = 0  # bit 8 to 15
    Event_Type = 0  # bit 16 to 17
    Reserved18 = 0  # bit 18 to 29
    Event_Recurrence = 0  # bit 30 to 30
    Event_Enable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_EVT_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_EVT_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_SCANLINECMPLOWER:
    PIPEDMC_SCANLINECMPLOWER_A = 0x5F120
    PIPEDMC_SCANLINECMPLOWER_B = 0x5F520
    PIPEDMC_SCANLINECMPLOWER_C = 0x5F920
    PIPEDMC_SCANLINECMPLOWER_D = 0x5FD20

class _PIPEDMC_SCANLINECMPLOWER(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Scanline_Lower', ctypes.c_uint32, 21),
        ('Reserved21', ctypes.c_uint32, 9),
        ('Scanlineoutrangecmp_En', ctypes.c_uint32, 1),
        ('Scanlineinrangecmp_En', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_SCANLINECMPLOWER(ctypes.Union):
    value = 0
    offset = 0

    Scanline_Lower = 0  # bit 0 to 20
    Reserved21 = 0  # bit 21 to 29
    Scanlineoutrangecmp_En = 0  # bit 30 to 30
    Scanlineinrangecmp_En = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_SCANLINECMPLOWER),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_SCANLINECMPLOWER, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_SCANLINECMPUPPER:
    PIPEDMC_SCANLINECMPUPPER_A = 0x5F124
    PIPEDMC_SCANLINECMPUPPER_B = 0x5F524
    PIPEDMC_SCANLINECMPUPPER_C = 0x5F924
    PIPEDMC_SCANLINECMPUPPER_D = 0x5FD24

class _PIPEDMC_SCANLINECMPUPPER(ctypes.LittleEndianStructure):
    _fields_ = [
...
class REG_PIPEDMC_SCANLINECMPUPPER(ctypes.Union):
    value = 0
    offset = 0

    Scanline_Upper = 0  # bit 0 to 20
    Reserved21 = 0  # bit 21 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_SCANLINECMPUPPER),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_SCANLINECMPUPPER, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class REG_TIMESTAMP_CTR(ctypes.Union):
    ...
    TimestampCounter = 0  # bit 0 to 31
...
class OFFSET_TIMESTAMP_CTR_CMTG:
    TIMESTAMP_CTR_CMTG_CMTG = 0x44078

class _TIMESTAMP_CTR_CMTG(ctypes.LittleEndianStructure):
    _fields_ = [
        ('TimestampCounter', ctypes.c_uint32, 32),
    ]


class REG_TIMESTAMP_CTR_CMTG(ctypes.Union):
    value = 0
    offset = 0
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _TIMESTAMP_CTR_CMTG),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_TIMESTAMP_CTR_CMTG, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FQ_CTRL:
    PIPEDMC_FQ_CTRL_A = 0x5F078
    PIPEDMC_FQ_CTRL_B = 0x5F478
    PIPEDMC_FQ_CTRL_C = 0x5F878
    PIPEDMC_FQ_CTRL_D = 0x5FC78

class _PIPEDMC_FQ_CTRL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('Preemption', ctypes.c_uint32, 1),
        ('Spare1', ctypes.c_uint32, 1),
        ('Spare2', ctypes.c_uint32, 1),
        ('Spare3', ctypes.c_uint32, 1),
        ('Spare4', ctypes.c_uint32, 1),
        ...
        ('Spare28', ctypes.c_uint32, 1),
        ('Spare29', ctypes.c_uint32, 1),
        ('Flipqueue_Busy', ctypes.c_uint32, 1),
        ('Flipqueue_Control', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_FQ_CTRL(ctypes.Union):
    value = 0
    offset = 0

    Preemption = 0  # bit 0 to 0
    Spare1 = 0  # bit 1 to 1
    Spare2 = 0  # bit 2 to 2
    Spare3 = 0  # bit 3 to 3
    Spare4 = 0  # bit 4 to 4
    ...
    Spare28 = 0  # bit 28 to 28
    Spare29 = 0  # bit 29 to 29
    Flipqueue_Busy = 0  # bit 30 to 30
    Flipqueue_Control = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FQ_CTRL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FQ_CTRL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FPQ_CTL1:
    PIPEDMC_FPQ_CTL1_A = 0x5F160
    PIPEDMC_FPQ_CTL1_B = 0x5F560
    PIPEDMC_FPQ_CTL1_C = 0x5F960
    PIPEDMC_FPQ_CTL1_D = 0x5FD60

class _PIPEDMC_FPQ_CTL1(ctypes.LittleEndianStructure):
    _fields_ = [
        ('SwDmcWake', ctypes.c_uint32, 1),
        ('Reserved1', ctypes.c_uint32, 31),
    ]


class REG_PIPEDMC_FPQ_CTL1(ctypes.Union):
    value = 0
    offset = 0

    SwDmcWake = 0  # bit 0 to 0
    Reserved1 = 0  # bit 1 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FPQ_CTL1),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FPQ_CTL1, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FPQ_CTL2:
    PIPEDMC_FPQ_CTL2_A = 0x5F164
    PIPEDMC_FPQ_CTL2_B = 0x5F564
    PIPEDMC_FPQ_CTL2_C = 0x5F964
    PIPEDMC_FPQ_CTL2_D = 0x5FD64

class _PIPEDMC_FPQ_CTL2(ctypes.LittleEndianStructure):
    _fields_ = [
        ('W1DmcWake', ctypes.c_uint32, 1),
        ('DmcInterruptAtDelayedVblank', ctypes.c_uint32, 1),
        ('Reserved2', ctypes.c_uint32, 30),
    ]


class REG_PIPEDMC_FPQ_CTL2(ctypes.Union):
    value = 0
    offset = 0

    W1DmcWake = 0  # bit 0 to 0
    DmcInterruptAtDelayedVblank = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FPQ_CTL2),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FPQ_CTL2, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_VBI_MASK_CTL:
    PIPEDMC_VBI_MASK_CTL_A = 0x5F07C
    PIPEDMC_VBI_MASK_CTL_B = 0x5F47C
    PIPEDMC_VBI_MASK_CTL_C = 0x5F87C
    PIPEDMC_VBI_MASK_CTL_D = 0x5FC7C

class _PIPEDMC_VBI_MASK_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('MaskVbiSelect', ctypes.c_uint32, 2),
        ('Reserved2', ctypes.c_uint32, 2),
        ('MaskConfiguration', ctypes.c_uint32, 4),
        ('Reserved8', ctypes.c_uint32, 22),
        ('MaskStatus', ctypes.c_uint32, 1),
        ('MaskEnable', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_VBI_MASK_CTL(ctypes.Union):
    value = 0
    offset = 0

    MaskVbiSelect = 0  # bit 0 to 1
    Reserved2 = 0  # bit 2 to 3
    MaskConfiguration = 0  # bit 4 to 7
    Reserved8 = 0  # bit 8 to 29
    MaskStatus = 0  # bit 30 to 30
    MaskEnable = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_VBI_MASK_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_VBI_MASK_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_ADAPTIVE_SYNC_CFG(Enum):
    ADAPTIVE_SYNC_CFG_STATIC = 0x0
    ADAPTIVE_SYNC_CFG_DYNAMIC = 0x1


class ENUM_ADAPTIVE_SYNC_STATUS(Enum):
    ADAPTIVE_SYNC_STATUS_DISABLED = 0x0
    ADAPTIVE_SYNC_STATUS_ENABLED = 0x1


class OFFSET_PIPEDMC_ADAPTIVE_SYNC_STATUS:
    PIPEDMC_ADAPTIVE_SYNC_STATUS_A = 0x5F198
    PIPEDMC_ADAPTIVE_SYNC_STATUS_B = 0x5F598
    PIPEDMC_ADAPTIVE_SYNC_STATUS_C = 0x5F998
    PIPEDMC_ADAPTIVE_SYNC_STATUS_D = 0x5FD98

class _PIPEDMC_ADAPTIVE_SYNC_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AdaptiveSyncCfg', ctypes.c_uint32, 1),
        ('AdaptiveSyncStatus', ctypes.c_uint32, 1),
        ('Reserved2', ctypes.c_uint32, 30),
    ]


class REG_PIPEDMC_ADAPTIVE_SYNC_STATUS(ctypes.Union):
    value = 0
    offset = 0

    AdaptiveSyncCfg = 0  # bit 0 to 0
    AdaptiveSyncStatus = 0  # bit 1 to 1
    Reserved2 = 0  # bit 2 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_ADAPTIVE_SYNC_STATUS),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_ADAPTIVE_SYNC_STATUS, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FPQ_PUSH_PTS_STATUS:
    PIPEDMC_FPQ_PUSH_PTS_STATUS_A = 0x5F154
    PIPEDMC_FPQ_PUSH_PTS_STATUS_B = 0x5F554
    PIPEDMC_FPQ_PUSH_PTS_STATUS_C = 0x5F954
    PIPEDMC_FPQ_PUSH_PTS_STATUS_D = 0x5FD54

class _PIPEDMC_FPQ_PUSH_PTS_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ('FlipQueuePushPtsStatus', ctypes.c_uint32, 32),
    ]


class REG_PIPEDMC_FPQ_PUSH_PTS_STATUS(ctypes.Union):
    value = 0
    offset = 0

    FlipQueuePushPtsStatus = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FPQ_PUSH_PTS_STATUS),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FPQ_PUSH_PTS_STATUS, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FPQ_W1_STATUS:
    PIPEDMC_FPQ_W1_STATUS_A = 0x5F158
    PIPEDMC_FPQ_W1_STATUS_B = 0x5F558
    PIPEDMC_FPQ_W1_STATUS_C = 0x5F958
    PIPEDMC_FPQ_W1_STATUS_D = 0x5FD58

class _PIPEDMC_FPQ_W1_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ('FlipQueueWindow1Status', ctypes.c_uint32, 32),
    ]


class REG_PIPEDMC_FPQ_W1_STATUS(ctypes.Union):
    value = 0
    offset = 0

    FlipQueueWindow1Status = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FPQ_W1_STATUS),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FPQ_W1_STATUS, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_FPQ_W2_STATUS:
    PIPEDMC_FPQ_W2_STATUS_A = 0x5F15C
    PIPEDMC_FPQ_W2_STATUS_B = 0x5F55C
    PIPEDMC_FPQ_W2_STATUS_C = 0x5F95C
    PIPEDMC_FPQ_W2_STATUS_D = 0x5FD5C

class _PIPEDMC_FPQ_W2_STATUS(ctypes.LittleEndianStructure):
    _fields_ = [
        ('FlipQueueWindow2Status', ctypes.c_uint32, 32),
    ]


class REG_PIPEDMC_FPQ_W2_STATUS(ctypes.Union):
    value = 0
    offset = 0

    FlipQueueWindow2Status = 0  # bit 0 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_FPQ_W2_STATUS),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_FPQ_W2_STATUS, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_INTERRUPT:
    PIPEDMC_INTERRUPT_A = 0x5F190
    PIPEDMC_INTERRUPT_B = 0x5F590
    PIPEDMC_INTERRUPT_C = 0x5F990
    PIPEDMC_INTERRUPT_D = 0x5FD90

class _PIPEDMC_INTERRUPT(ctypes.LittleEndianStructure):
    _fields_ = [
        ('PipedmcAtsFaultInterrupt', ctypes.c_uint32, 1),
        ('PipedmcGttFaultInterrupt', ctypes.c_uint32, 1),
        ('PipedmcErrorInterrupt', ctypes.c_uint32, 1),
        ('PipedmcFlipQueueProgrammingDoneInterrupt', ctypes.c_uint32, 1),
        ...
        ('Spare_24', ctypes.c_uint32, 1),
        ('Spare_25', ctypes.c_uint32, 1),
        ('Spare_26', ctypes.c_uint32, 1),
        ('Spare_27', ctypes.c_uint32, 1),
        ('Spare_28', ctypes.c_uint32, 1),
        ('Spare_29', ctypes.c_uint32, 1),
        ('Spare_30', ctypes.c_uint32, 1),
        ('Spare_31', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_INTERRUPT(ctypes.Union):
    value = 0
    offset = 0

    PipedmcAtsFaultInterrupt = 0  # bit 0 to 0
    PipedmcGttFaultInterrupt = 0  # bit 1 to 1
    PipedmcErrorInterrupt = 0  # bit 2 to 2
    PipedmcFlipQueueProgrammingDoneInterrupt = 0  # bit 3 to 3
    ...
    Spare_24 = 0  # bit 24 to 24
    Spare_25 = 0  # bit 25 to 25
    Spare_26 = 0  # bit 26 to 26
    Spare_27 = 0  # bit 27 to 27
    Spare_28 = 0  # bit 28 to 28
    Spare_29 = 0  # bit 29 to 29
    Spare_30 = 0  # bit 30 to 30
    Spare_31 = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_INTERRUPT),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_INTERRUPT, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_PIPEDMC_INTERRUPT_MASK:
    PIPEDMC_INTERRUPT_MASK_A = 0x5F194
    PIPEDMC_INTERRUPT_MASK_B = 0x5F594
    PIPEDMC_INTERRUPT_MASK_C = 0x5F994
    PIPEDMC_INTERRUPT_MASK_D = 0x5FD94

class _PIPEDMC_INTERRUPT_MASK(ctypes.LittleEndianStructure):
    _fields_ = [
        ('PipedmcAtsFaultInterruptMask', ctypes.c_uint32, 1),
        ('PipedmcGttFaultInterruptMask', ctypes.c_uint32, 1),
        ('PipedmcErrorInterruptMask', ctypes.c_uint32, 1),
        ('PipedmcFlipQueueProgrammingDoneInterruptMask', ctypes.c_uint32, 1),
        ('Spare_4', ctypes.c_uint32, 1),
        ('Spare_5', ctypes.c_uint32, 1),
        ('Spare_6', ctypes.c_uint32, 1),
        ('Spare_7', ctypes.c_uint32, 1),
...
class REG_PIPEDMC_INTERRUPT_MASK(ctypes.Union):
    value = 0
    offset = 0

    PipedmcAtsFaultInterruptMask = 0  # bit 0 to 0
    PipedmcGttFaultInterruptMask = 0  # bit 1 to 1
    PipedmcErrorInterruptMask = 0  # bit 2 to 2
    PipedmcFlipQueueProgrammingDoneInterruptMask = 0  # bit 3 to 3
    Spare_4 = 0  # bit 4 to 4
    Spare_5 = 0  # bit 5 to 5
    Spare_6 = 0  # bit 6 to 6
    Spare_7 = 0  # bit 7 to 7
    ...
    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_INTERRUPT_MASK),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_INTERRUPT_MASK, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_PIPEDMC_WRITEBACK_COMPLETION_DISABLE(Enum):
    PIPEDMC_WRITEBACK_COMPLETION_ENABLE_WRITE_COMPLETIONS = 0x0
    PIPEDMC_WRITEBACK_COMPLETION_DISABLE_WRITE_COMPLETIONS = 0x1


class ENUM_CLEAR_WRITEBACK_COUNTER(Enum):
    CLEAR_WRITEBACK_COUNTER_DON_T_CLEAR = 0x0
    CLEAR_WRITEBACK_COUNTER_CLEAR = 0x1


class OFFSET_PIPEDMC_WB_CTL:
    PIPEDMC_WB_CTL_A = 0x5F100
    PIPEDMC_WB_CTL_B = 0x5F500
    PIPEDMC_WB_CTL_C = 0x5F900
    PIPEDMC_WB_CTL_D = 0x5FD00

class _PIPEDMC_WB_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('WritebackCounterThreshold', ctypes.c_uint32, 10),
        ('Reserved10', ctypes.c_uint32, 20),
        ('PipedmcWritebackCompletionDisable', ctypes.c_uint32, 1),
        ('ClearWritebackCounter', ctypes.c_uint32, 1),
    ]


class REG_PIPEDMC_WB_CTL(ctypes.Union):
    value = 0
    offset = 0

    WritebackCounterThreshold = 0  # bit 0 to 9
    Reserved10 = 0  # bit 10 to 29
    PipedmcWritebackCompletionDisable = 0  # bit 30 to 30
    ClearWritebackCounter = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPEDMC_WB_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPEDMC_WB_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_CRC_RES:
    ...
    DDI_CRC_RES_USBC1 = 0x64364
    DDI_CRC_RES_SRD_USBC1 = 0x6436C
    DDI_CRC_RES_USBC2 = 0x64464
    DDI_CRC_RES_SRD_USBC2 = 0x6446C
    DDI_CRC_RES_USBC3 = 0x64564
    DDI_CRC_RES_SRD_USBC3 = 0x6456C
    DDI_CRC_RES_USBC4 = 0x64664
    DDI_CRC_RES_SRD_USBC4 = 0x6466C

class _CRC_RES(ctypes.LittleEndianStructure):
    _fields_ = [
        ('CrcResultValue', ctypes.c_uint32, 32),
    ]


class REG_CRC_RES(ctypes.Union):
    value = 0
    offset = 0

    CrcResultValue = 0  # bit 0 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_CRC_RES, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class OFFSET_CRC_EXP:
    PIPE_CD_CRC_EXP_A = 0x60054
    PIPE_CD_CRC_EXP_B = 0x61054
    PIPE_CD_CRC_EXP_C = 0x62054
    PIPE_CD_CRC_EXP_D = 0x63054

class _CRC_EXP(ctypes.LittleEndianStructure):
    _fields_ = [
        ('CrcExpectedValue', ctypes.c_uint32, 32),
    ]


class REG_CRC_EXP(ctypes.Union):
    value = 0
    offset = 0

    CrcExpectedValue = 0  # bit 0 to 31
    ...
    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_CRC_EXP, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
...
class ENUM_CRC_SOURCE_SELECT(Enum):
    CRC_SOURCE_SELECT_PLANE_1 = 0x0  # Plane 1 output.
    CRC_SOURCE_SELECT_PLANE_2 = 0x2  # Plane 2 output.
    CRC_SOURCE_SELECT_DMUX = 0x4  # DMUX output.
    CRC_SOURCE_SELECT_PLANE_3 = 0x6  # Plane 3 output.
    CRC_SOURCE_SELECT_PLANE_4 = 0x7  # Plane 4 output.
    CRC_SOURCE_SELECT_PLANE_5 = 0x5  # Plane 5 output.
...
class OFFSET_PIPE_CD_CRC_CTL:
    PIPE_CD_CRC_CTL_A = 0x60050
    PIPE_CD_CRC_CTL_B = 0x61050
    PIPE_CD_CRC_CTL_C = 0x62050
    PIPE_CD_CRC_CTL_D = 0x63050

class _PIPE_CD_CRC_CTL(ctypes.LittleEndianStructure):
    _fields_ = [
        ('AccumStartFrame', ctypes.c_uint32, 4),
        ('AccumEndFrame', ctypes.c_uint32, 4),
        ('AccumEnable', ctypes.c_uint32, 1),
        ('Reserved9', ctypes.c_uint32, 7),
        ('CrcChannelMask', ctypes.c_uint32, 3),
        ('Reserved19', ctypes.c_uint32, 3),
        ...
        ('CrcSourceSelect', ctypes.c_uint32, 3),
        ('EnableCrc', ctypes.c_uint32, 1),
    ]


class REG_PIPE_CD_CRC_CTL(ctypes.Union):
    value = 0
    offset = 0
    ...
    CrcChannelMask = 0  # bit 16 to 18
    Reserved19 = 0  # bit 19 to 21
    CrcInputInsufficient = 0  # bit 22 to 22
    CrcFieldEye = 0  # bit 23 to 23
    CrcDone = 0  # bit 24 to 24
    CrcChange = 0  # bit 25 to 25
    Reserved26 = 0  # bit 26 to 27
    CrcSourceSelect = 0  # bit 28 to 30
    EnableCrc = 0  # bit 31 to 31

    _anonymous_ = ("bitMap",)
    _fields_ = [
        ('bitMap', _PIPE_CD_CRC_CTL),
        ('value', ctypes.c_uint32)
    ]

    def __init__(self, offset=None, value=None):
        assert not (offset is None and value is None)
        super(REG_PIPE_CD_CRC_CTL, self).__init__()
        if offset is not None:
            self.offset = offset
        if value is not None:
            self.value = value
