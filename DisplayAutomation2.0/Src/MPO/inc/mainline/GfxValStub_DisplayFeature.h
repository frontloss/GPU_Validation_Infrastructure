...
//----- GVSTUB_FREE_RESOURCE YANGRA-----
typedef struct _GVSTUB_FREE_RES_ARGS_YANGRA
{
    IN UINT64 pGmmBlock;
    IN UINT64 pUserVirtualAddress;
} GVSTUB_FREE_RES_ARGS_YANGRA, *PGVSTUB_FREE_RES_ARGS_YANGRA;
...
typedef enum _GVSTUB_SURFACE_MEMORY_TYPE
{
	...
	GVSTUB_SURFACE_MEMORY_TILE4 = 16,                      // Surface uses Tile4 memory 
