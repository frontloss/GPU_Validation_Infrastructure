 ...
 */
MPO_DLL BOOL DDRW_DFTFreeResource(PGFX_ADAPTER_INFO pAdapterInfo, PPYPLANES_RESOURCE_INFO pResourceInfo);
 ...
 */
MPO_DLL BOOL FlipQDFTCreateResource(PGFX_ADAPTER_INFO pAdapterInfo, PPLANES pPlanes);
