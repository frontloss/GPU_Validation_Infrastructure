...
typedef struct _PYPLANES_MPO_PLANE_IN_FLAGS
{
    union {
        struct
        {
            ...
            UINT StereoFlip : 1;               // 0x00000020
            UINT FlipImmediateNoTearing : 1;   // 0x00000040
            UINT Reserved : 25;                // 0xFFFFFFE0
        };
        UINT uiValue;
    };
...
/*MPO Flip Delay Args*/
typedef struct _PYPLANES_MPO_FLIP_DELAY_ARGS
{
    BOOLEAN bWaitForFlipDone;
    BOOLEAN bWaitForScanline;
    UINT32  uiScanLineToWait;
    ULONG   ulScanlineCountOffset;
    UINT64  uiFrameCountOffset;
} PYPLANES_MPO_FLIP_DELAY_ARGS, *PPYPLANES_MPO_FLIP_DELAY_ARGS;
...
typedef struct _PLANES_
{
    ...
    ULONG64                      ulTargetFlipTime;
    ULONG64                      uldelay;
    UINT                         uDuration;
    PYPLANES_MPO_FLIP_DELAY_ARGS stMpoFlipDelayArgs[PYPLANES_MAX_PIPES];
} _PLANES_, *PPLANES;
