 ...
 */
CDLL_EXPORT BOOL DDRW_EnableDisableMPOSimulation(PGFX_ADAPTER_INFO pAdapterInfo, HANDLE hGfxValSim, BOOL bEnable);
 ...
 */
CDLL_EXPORT UINT DDRW_CheckForMultiPlaneOverlaySupport3(PGFX_ADAPTER_INFO pAdapterInfo, PPLANES pPlanes);
 ...
 * @return			Returns 0(False) on function failure; else 1(True)
 */
CDLL_EXPORT BOOL DDRW_GetMPOCaps(PGFX_ADAPTER_INFO pAdapterInfo, PMPO_CAPS_ARG pMPOCaps);
 ...
 */
CDLL_EXPORT UINT DDRW_SetSourceAddressForMultiPlaneOverlay3(PGFX_ADAPTER_INFO pAdapterInfo, PPLANES pPlanes);
 ...
 * @return		Returns 0(False) on function failure; else 1(True)
 */
CDLL_EXPORT BOOL FlipQEnableDisableMPOSimulation(PGFX_ADAPTER_INFO pAdapterInfo, HANDLE hGfxValSim, BOOL bEnable);
 ...
 */
CDLL_EXPORT UINT FlipQCheckForMultiPlaneOverlaySupport3(PGFX_ADAPTER_INFO pAdapterInfo, PPLANES pPlanes);
 ...
 */
CDLL_EXPORT UINT FlipQSetSourceAddressForMultiPlaneOverlay3(PGFX_ADAPTER_INFO pAdapterInfo, PPLANES pPlanes);
