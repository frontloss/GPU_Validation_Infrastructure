...
BOOLEAN ADLS_MMIOHANDLERS_RegisterGeneralMMIOHandlers(PMMIO_INTERFACE pstMMIOInterface)
{
    BOOLEAN bRet = FALSE;
    ...
    do
    {
        ...
        bRet = ADLS_MMIOHANDLERS_RegisterHotPlugHandlers(pstMMIOInterface);
...
BOOLEAN ADLS_MMIOHANDLERS_RegisterHotPlugHandlers(PMMIO_INTERFACE pstMMIOInterface)
{
    BOOLEAN bRet = FALSE;
    ...
    do
    {
        ...
        bRet = COMMONMMIOHANDLERS_RegisterMMIOHandlers(pstMMIOInterface, 0xFF, FALSE, SDE_ISR_ADDR_GEN12, SDE_ISR_ADDR_GEN12, 0, NULL, NULL, 0, FALSE, eNoExecHw,
                                                       ADLS_MMIOHANDLERS_HotPlugLiveStateMMIOReadHandler, NULL, NULL, NULL, NULL);
        if (bRet == FALSE)
        {
            break;
        }
        ...
        bRet = COMMONMMIOHANDLERS_RegisterMMIOHandlers(pstMMIOInterface, 0xFF, FALSE, SOUTH_HOT_PLUG_CTL_FOR_DDI_ADDR_GEN12, SOUTH_HOT_PLUG_CTL_FOR_TYPEC_ADDR_GEN12, 0, NULL, NULL,
                                                       0, TRUE, eNoExecHw, NULL, ADLS_MMIOHANDLERS_HotPlugCtlMMIOWriteHandler, NULL, NULL, NULL);
...
BOOLEAN ADLS_MMIOHANDLERS_GenSpecificMMIOInitialization(PMMIO_INTERFACE pstMMIOInterface)
{
    BOOLEAN bRet    = FALSE;
    ULONG   ulCount = 0;
    ...
    if (pstMMIOInterface)
    {
        ...
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_B_START] = DDI_AUX_DATA_TC1_START_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_B_END]   = DDI_AUX_DATA_TC1_END_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_CTL_B]        = DDI_AUX_CTL_TC1_GEN12;

        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_C_START] = DDI_AUX_DATA_TC2_START_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_C_END]   = DDI_AUX_DATA_TC2_END_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_CTL_C]        = DDI_AUX_CTL_TC2_GEN12;

        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_D_START] = DDI_AUX_DATA_TC3_START_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_D_END]   = DDI_AUX_DATA_TC3_END_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_CTL_D]        = DDI_AUX_CTL_TC3_GEN12;

        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_E_START] = DDI_AUX_DATA_TC4_START_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_DATA_E_END]   = DDI_AUX_DATA_TC4_END_GEN12;
        pstMMIOInterface->pulGenMMIOOffsetArray[eINDEX_DDI_AUX_CTL_E]        = DDI_AUX_CTL_TC4_GEN12;

        // Every new offset should be added above this. So as to invalidate the rest
        // Do below: ulCount = [Last enum in above list] + 1;
        ulCount = eINDEX_DDI_AUX_CTL_E + 1;
...
// bIsHPD == FALSE ==> SPI
BOOLEAN ADLS_MMIOHANDLERS_SetupInterruptRegistersForHPDorSPI(PMMIO_INTERFACE pstMMIOInterface, PORT_TYPE ePortType, BOOLEAN bAttach, BOOLEAN bIsHPD,
                                                             PORT_CONNECTOR_INFO PortConnectorInfo)
{
    ...
    do
    {
        ...
        if (FALSE == ADLS_MMIOHANDLERS_IsHPDEnabledForPort(pstMMIOInterface, ePortType, PortConnectorInfo))
        {
            break;
        }
...
BOOLEAN ADLS_MMIOHANDLERS_SetLiveStateForPort(PMMIO_INTERFACE pstMMIOInterface, PORT_TYPE ePortType, BOOLEAN bAttach, PORT_CONNECTOR_INFO PortConnectorInfo)
{
    BOOLEAN                                bRet                = TRUE;
    SOUTH_DE_INTR_BIT_DEFINITION_SPT_GEN12 stPCHLiveReg        = { 0 };
    PGLOBAL_MMIO_REGISTER_DATA             pstGlobalMMORegData = &pstMMIOInterface->stGlobalMMORegData;
...
BOOLEAN ADLS_MMIOHANDLERS_IsHPDEnabledForPort(PMMIO_INTERFACE pstMMIOInterface, PORT_TYPE ePortType, PORT_CONNECTOR_INFO PortConnectorInfo)
{
    BOOLEAN                    bRet                = FALSE;
    ...
    do
    {
        ...
        case INTHDMIA_PORT:
            ...
            // The SOUTH DE TC registers need to be checked for  Port B till Port E
        case INTDPB_PORT:
        case INTHDMIB_PORT:
        ...
        case INTDPD_PORT:
        case INTHDMID_PORT:
            if (stSouthTCCtlreg.Tc3HpdEnable)
            {
                bRet = TRUE;
            }
            break;
        ...
        case INTDPE_PORT:
        case INTHDMIE_PORT:
            if (stSouthTCCtlreg.Tc4HpdEnable)
            {
                bRet = TRUE;
            }
            break;
...
BOOLEAN ADLS_MMIOHANDLERS_HotPlugLiveStateMMIOReadHandler(PMMIO_HANDLER_INFO pstMMIOHandlerInfo, ULONG ulMMIOOffset, PULONG pulReadData, PREGRW_EXEC_SITE peRegRWExecSite)
{
    BOOLEAN                                bRet             = TRUE;
...
*/
BOOLEAN ADLS_MMIOHANDLERS_HotPlugCtlMMIOWriteHandler(PMMIO_HANDLER_INFO pstMMIOHandlerInfo, ULONG ulMMIOOffset, ULONG ulWriteData, PREGRW_EXEC_SITE peRegRWExecSite)
{
    BOOLEAN bRet = FALSE;
...
BOOLEAN ADLS_MMIOHANDLERS_ScdcInterruptGeneration(PMMIO_INTERFACE pstMMIOInterface, PSCDC_ARGS pstScdcArgs)
{
    BOOLEAN                                bRet             = FALSE;
    GFX_MSTR_INTR_GEN12                    stMasterIntCtrl  = { 0 };
    DISPLAY_INT_CTL_GEN12                  stDisplayIntCtrl = { 0 };
