...
#ifndef __GEN12MMIO_H__
#define __GEN12MMIO_H__

#include "..\\CommonMMIO.h"
#include "Gen12CommonInterruptRegisters.h"

#define DDI_AUX_CTL_A_GEN12 0x64010
#define DDI_AUX_CTL_B_GEN12 0x64110
#define DDI_AUX_CTL_C_GEN12 0x64210
#define DDI_AUX_CTL_TC1_GEN12 0x64310
#define DDI_AUX_CTL_TC2_GEN12 0x64410
#define DDI_AUX_CTL_TC3_GEN12 0x64510
#define DDI_AUX_CTL_TC4_GEN12 0x64610
#define DDI_AUX_CTL_TC5_GEN12 0x64710
#define DDI_AUX_CTL_TC6_GEN12 0x64810

#define DDI_AUX_DATA_A_START_GEN12 0x64014 // 64014h - 64027h
#define DDI_AUX_DATA_A_END_GEN12 0x64024

#define DDI_AUX_DATA_B_START_GEN12 0x64114 // 64114h - 64127h
#define DDI_AUX_DATA_B_END_GEN12 0x64124

#define DDI_AUX_DATA_C_START_GEN12 0x64214 // 64214h - 64227h
#define DDI_AUX_DATA_C_END_GEN12 0x64224

#define DDI_AUX_DATA_TC1_START_GEN12 0x64314 // 64314h - 64327h
#define DDI_AUX_DATA_TC1_END_GEN12 0x64324

#define DDI_AUX_DATA_TC2_START_GEN12 0x64414 // 64414h - 64427h
#define DDI_AUX_DATA_TC2_END_GEN12 0x64424

#define DDI_AUX_DATA_TC3_START_GEN12 0x64514 // 64514h - 64527h
#define DDI_AUX_DATA_TC3_END_GEN12 0x64524

#define DDI_AUX_DATA_TC4_START_GEN12 0x64614 // 64614h - 64627h
#define DDI_AUX_DATA_TC4_END_GEN12 0x64624

#define DDI_AUX_DATA_TC5_START_GEN12 0x64714 // 64714h - 64727h
#define DDI_AUX_DATA_TC5_END_GEN12 0x64724

#define DDI_AUX_DATA_TC6_START_GEN12 0x64814 // 64814h - 64827h
#define DDI_AUX_DATA_TC6_END_GEN12 0x64824
...
typedef enum _DDI_BUF_CTL_INSTANCE_D12
{
    DDI_BUF_CTL_A_ADDR_D12     = 0x64000,
    DDI_BUF_CTL_B_ADDR_D12     = 0x64100,
    DDI_BUF_CTL_C_ADDR_D12     = 0x64200,
    DDI_BUF_CTL_USBC1_ADDR_D12 = 0x64300,
    DDI_BUF_CTL_USBC2_ADDR_D12 = 0x64400,
    DDI_BUF_CTL_USBC3_ADDR_D12 = 0x64500,
    DDI_BUF_CTL_USBC4_ADDR_D12 = 0x64600,
    DDI_BUF_CTL_USBC5_ADDR_D12 = 0x64700,
    DDI_BUF_CTL_USBC6_ADDR_D12 = 0x64800,
} DDI_BUF_CTL_INSTANCE_D12;

/*****************************************************************************
Description:  Do not read or write the register when the associated power well is disabled.

******************************************************************************/
typedef union _DDI_BUF_CTL_D12 {
    struct
    {
        /******************************************************************************************************************
...
C_ASSERT(4 == sizeof(DDI_BUF_CTL_D12));

typedef enum _PWR_WELL_CTL_DDI_INSTANCE_D12
{
    PWR_WELL_CTL_DDI1_ADDR_D12 = 0x45450,
    PWR_WELL_CTL_DDI2_ADDR_D12 = 0x45454,
    PWR_WELL_CTL_DDI4_ADDR_D12 = 0x4545C,
} PWR_WELL_CTL_DDI_INSTANCE_D12;
...
******************************************************************************/
typedef union _PWR_WELL_CTL_DDI_D12 {
    struct
    {
        /******************************************************************************************************************
        ...
        /******************************************************************************************************************/
        DDU32 UNIQUENAME(Reserved) : DD_BITFIELD_RANGE(18, 20); //

        /******************************************************************************************************************/
        DDU32 UNIQUENAME(Reserved) : DD_BITFIELD_RANGE(21, 31); //
    };

    DDU32 Value;

} PWR_WELL_CTL_DDI_D12;

C_ASSERT(4 == sizeof(PWR_WELL_CTL_DDI_D12));

/* Common MMIO Read/Write handlers used across Gen12*/
