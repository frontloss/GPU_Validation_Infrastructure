...
#define CTL_MAX_RESERVED_SIZE 112
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlInit(ctl_init_args_t * pInitDesc,  ///< [in][out] App's control API version
    ...
    ///         + `nullptr == hAPIHandle`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlClose(ctl_api_handle_t hAPIHandle ///< [in][release] Control API implementation handle obtained during init
                                                                                ///< call
    );
    ...
    ///         + `nullptr == pArgs`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetRuntimePath(ctl_runtime_path_args_t *pArgs ///< [in] Runtime path
    );
    ...
    ///         + `nullptr == pArgs`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlWaitForPropertyChange(ctl_device_adapter_handle_t      hDeviceAdapter, ///< [in][release] handle to control device adapter
    ...
    ///         + `nullptr == pArgs`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlReservedCall(ctl_device_adapter_handle_t hDeviceAdapter, ///< [in][release] handle to control device adapter
...
#pragma region _3D
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSupported3DCapabilities(ctl_device_adapter_handle_t hDAhandle,   ///< [in][release] Handle to display adapter
    ...
    ///         + `nullptr == pFeature`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSet3DFeature(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
...
#pragma region display
    ...
    ///         + `nullptr == hDeviceAdapter`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlCheckDriverVersion(ctl_device_adapter_handle_t hDeviceAdapter, ///< [in][release] handle to control device adapter
    ...
    ///         + `nullptr == pCount`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumerateDevices(ctl_api_handle_t hAPIHandle,           ///< [in][release] Applications should pass the Control API handle returned
    ...
    ///         + `nullptr == pCount`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumerateDisplayOutputs(ctl_device_adapter_handle_t hDeviceAdapter, ///< [in][release] handle to control device adapter
                                                                      uint32_t *                  pCount, ///< [in,out][release] pointer to the number of display output instances.
                                                                                                          ...
                                                                                                          ///< If count is larger than the number of drivers available, then the api
                                                                                                          ///< will update the value with the correct number of drivers available.
                                                                      ctl_display_output_handle_t *phDisplayOutputs ///< [in,out][optional][release][range(0, *pCount)] array of
                                                                                                                    ///< display output instance handles
    );
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumerateI2CPinPairs(ctl_device_adapter_handle_t hDeviceAdapter, ///< [in][release] handle to device adapter
                                                                   ...
                                                                   ctl_i2c_pin_pair_handle_t *phI2cPinPairs ///< [out][optional][release][range(0, *pCount)] array of i2c pin pair
                                                                                                            ...
                                                                                                            ///< *pCount > 0.
                                                                                                            ///< If Count is not equal to actual number of i2c pin-pair instances,
                                                                                                            ///< it will return CTL_RESULT_ERROR_INVALID_SIZE.
    );
    ...
    ///         + `nullptr == pProperties`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetDeviceProperties(ctl_device_adapter_handle_t      hDAhandle,  ///< [in][release] Handle to control device adapter
    ...
    ///         + `nullptr == pProperties`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetDisplayProperties(ctl_display_output_handle_t hDisplayOutput, ///< [in][release] Handle to display output
    ...
    ///         + `nullptr == pProperties`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetAdaperDisplayEncoderProperties(
    ...
    ///         + `nullptr == hInstance`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetZeDevice(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSharpnessCaps(ctl_display_output_handle_t hDisplayOutput, ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetCurrentSharpness(ctl_display_output_handle_t hDisplayOutput,    ///< [in][release] Handle to display output
    ...
    ///         + `nullptr == pSharpnessSettings`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetCurrentSharpness(ctl_display_output_handle_t hDisplayOutput,    ///< [in][release] Handle to display output
...
#define CTL_I2C_MAX_DATA_SIZE 0x0080
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlI2CAccess(ctl_display_output_handle_t hDisplayOutput, ///< [in] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlI2CAccessOnPinPair(ctl_i2c_pin_pair_handle_t      hI2cPinPair,   ///< [in] Handle to I2C pin pair.
...
#define CTL_AUX_MAX_DATA_SIZE 132
    ...
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernal mode driver call failure"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlAUXAccess(ctl_display_output_handle_t hDisplayOutput, ///< [in] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetPowerOptimizationCaps(
    ctl_display_output_handle_t    hDisplayOutput,        ///< [in][release] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetPowerOptimizationSetting(
    ctl_display_output_handle_t        hDisplayOutput,            ///< [in][release] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetPowerOptimizationSetting(
    ctl_display_output_handle_t        hDisplayOutput,            ///< [in][release] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetBrightnessSetting(ctl_display_output_handle_t hDisplayOutput,       ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_DISPLAY_NOT_ACTIVE - "Display not active"
    ///     - ::CTL_RESULT_ERROR_INVALID_OPERATION_TYPE - "Currently Brightness API is supported only on companion display"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetBrightnessSetting(ctl_display_output_handle_t hDisplayOutput,       ///< [in][release] Handle to display output
...
#define CTL_MAX_NUM_SAMPLES_PER_CHANNEL_1D_LUT 8192
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPixelTransformationGetConfig(
    ...
    ///     - ::CTL_RESULT_ERROR_3DLUT_INVALID_OPERATION - "Invalid 3dlut operation"
    ///     - ::CTL_RESULT_ERROR_3DLUT_UNSUCCESSFUL - "3dlut call unsuccessful"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPixelTransformationSetConfig(
    ctl_display_output_handle_t  hDisplayOutput,     ///< [in] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_NULL_OS_ADAPATER_HANDLE - "Null OS adapter handle"
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernal mode driver call failure"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPanelDescriptorAccess(ctl_display_output_handle_t         hDisplayOutput,            ///< [in] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSupportedRetroScalingCapability(
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetRetroScaling(ctl_device_adapter_handle_t   hDAhandle,              ///< [in][release] Handle to adapter
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSupportedScalingCapability(ctl_display_output_handle_t hDisplayOutput, ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetCurrentScaling(ctl_display_output_handle_t hDisplayOutput,        ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetCurrentScaling(ctl_display_output_handle_t hDisplayOutput, ///< [in][release] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetLACEConfig(ctl_display_output_handle_t hDisplayOutput, ///< [in] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    ///     - ::CTL_RESULT_ERROR_LACE_INVALID_DATA_ARGUMENT_PASSED - "Lace Incorrrect AggressivePercent data or LuxVsAggressive Map data passed by user"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetLACEConfig(ctl_display_output_handle_t hDisplayOutput, ///< [in]Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSoftwarePSR(ctl_display_output_handle_t hDisplayOutput,     ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetIntelArcSyncInfoForMonitor(
    ctl_display_output_handle_t          hDisplayOutput,            ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumerateMuxDevices(ctl_api_handle_t hAPIHandle, ///< [in][release] Applications should pass the Control API handle returned
                                                                                               ///< by the CtlInit function
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetMuxProperties(ctl_mux_output_handle_t hMuxDevice,    ///< [in] MUX device instance handle
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSwitchMux(ctl_mux_output_handle_t     hMuxDevice,            ///< [in] MUX device instance handle
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetIntelArcSyncProfile(
    ctl_display_output_handle_t          hDisplayOutput,            ///< [in][release] Handle to display output
    ...
    ///         + `nullptr == pIntelArcSyncProfileParams`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlSetIntelArcSyncProfile(
    ctl_display_output_handle_t          hDisplayOutput,            ///< [in][release] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEdidManagement(ctl_display_output_handle_t hDisplayOutput,     ///< [in] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetCustomMode(ctl_display_output_handle_t     hDisplayOutput, ///< [in] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetCombinedDisplay(ctl_device_adapter_handle_t  hDeviceAdapter,      ///< [in][release] Handle to control device adapter
    ...
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernel mode driver call failure"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetDisplayGenlock(
...
#define CTL_MAX_DISPLAYS_FOR_MGPU_COLLAGE 16
    ...
    ///     - ::CTL_RESULT_ERROR_NULL_OS_ADAPATER_HANDLE - "Null OS adapter handle"
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernel mode driver call failure"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetVblankTimestamp(ctl_display_output_handle_t hDisplayOutput, ///< [in] Handle to display output
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlLinkDisplayAdapters(ctl_device_adapter_handle_t hPrimaryAdapter, ///< [in][release] Handle to Primary adapter in LDA chain
    ...
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernel mode driver call failure"
    ///     - ::CTL_RESULT_ERROR_ADAPTER_NOT_SUPPORTED_ON_LDA_SECONDARY - "Unsupported (secondary) adapter handle passed"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlUnlinkDisplayAdapters(ctl_device_adapter_handle_t hPrimaryAdapter ///< [in][release] Handle to Primary adapter in LDA chain
    );
    ...
    ///     - ::CTL_RESULT_ERROR_KMD_CALL - "Kernel mode driver call failure"
    ///     - ::CTL_RESULT_ERROR_ADAPTER_NOT_SUPPORTED_ON_LDA_SECONDARY - "Unsupported (secondary) adapter handle passed"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetLinkedDisplayAdapters(ctl_device_adapter_handle_t hPrimaryAdapter, ///< [in][release] Handle to Primary adapter in LDA chain
    ...
    ///     - ::CTL_RESULT_ERROR_INVALID_OPERATION_TYPE - "Invalid operation type"
    ///     - ::CTL_RESULT_ERROR_INVALID_ARGUMENT - "Invalid combination of parameters"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetDynamicContrastEnhancement(ctl_display_output_handle_t hDisplayOutput, ///< [in] Handle to display output
...
#define CTL_MAX_WIREFORMAT_COLOR_MODELS_SUPPORTED 4
    ...
    ///     - ::CTL_RESULT_ERROR_NULL_OS_INTERFACE - "Null OS interface"
    ///     - ::CTL_RESULT_ERROR_NULL_OS_ADAPATER_HANDLE - "Null OS adapter handle"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetWireFormat(
    ctl_display_output_handle_t       hDisplayOutput,          ///< [in][release] Handle to display output
    ...
    ///     - ::CTL_RESULT_ERROR_INVALID_OPERATION_TYPE - "Invalid operation type"
    ///     - ::CTL_RESULT_ERROR_INVALID_ARGUMENT - "Invalid combination of parameters"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetDisplaySettings(ctl_display_output_handle_t hDisplayOutput,  ///< [in] Handle to display output
...
#pragma region engine
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumEngineGroups(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEngineGetProperties(ctl_engine_handle_t      hEngine,    ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pStats`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEngineGetActivity(ctl_engine_handle_t hEngine, ///< [in] Handle for the component.
...
#define CTL_FAN_TEMP_SPEED_PAIR_COUNT 32
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumFans(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to the adapter
                                                       uint32_t *                  pCount,    ///< [in,out] pointer to the number of components of this type.
                                                                                              ///< if count is zero, then the driver shall update the value with the
                                                                                              ///< total number of components of this type that are available.
                                                                                              ///< if count is greater than the number of components of this type that
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanGetProperties(ctl_fan_handle_t      hFan,       ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pConfig`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanGetConfig(ctl_fan_handle_t  hFan,   ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanSetDefaultMode(ctl_fan_handle_t hFan ///< [in] Handle for the component.
    );
    ...
    ///         + Fixing the fan speed not supported by the hardware or the fan speed units are not supported. See ::ctl_fan_properties_t.supportedModes and
    ///         ::ctl_fan_properties_t.supportedUnits.
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanSetFixedSpeedMode(ctl_fan_handle_t       hFan, ///< [in] Handle for the component.
    ...
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_FEATURE
    ///         + Fan speed table not supported by the hardware or the fan speed units are not supported. See ::ctl_fan_properties_t.supportedModes and
    ///         ::ctl_fan_properties_t.supportedUnits.
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanSetSpeedTableMode(ctl_fan_handle_t             hFan,      ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFanGetState(ctl_fan_handle_t      hFan,  ///< [in] Handle for the component.
...
#pragma region frequency
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumFrequencyDomains(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
                                                                   uint32_t *                  pCount,    ///< [in,out] pointer to the number of components of this type.
                                                                                                          ///< if count is zero, then the driver shall update the value with the
                                                                                                          ///< total number of components of this type that are available.
                                                                                                          ///< if count is greater than the number of components of this type that
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencyGetProperties(ctl_freq_handle_t      hFrequency, ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencyGetAvailableClocks(ctl_freq_handle_t hFrequency, ///< [in] Device handle of the device.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pLimits`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencyGetRange(ctl_freq_handle_t hFrequency, ///< [in] Handle for the component.
    ...
    ///     - ::CTL_RESULT_ERROR_INSUFFICIENT_PERMISSIONS
    ///         + User does not have permissions to make these modifications.
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencySetRange(ctl_freq_handle_t       hFrequency, ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pState`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencyGetState(ctl_freq_handle_t hFrequency, ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlFrequencyGetThrottleTime(ctl_freq_handle_t         hFrequency,   ///< [in] Handle for the component.
                                                                       ctl_freq_throttle_time_t *pThrottleTime ///< [in,out] Will contain a snapshot of the throttle time counters
...
#pragma region media
    ...
    ///         + `nullptr == pFeatureCaps`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSupportedVideoProcessingCapabilities(
    ...
    ///         + `nullptr == pFeature`
    ///     - ::CTL_RESULT_ERROR_UNSUPPORTED_VERSION - "Unsupported version"
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlGetSetVideoProcessingFeature(
    ctl_device_adapter_handle_t            hDAhandle, ///< [in][release] Handle to display adapter
...
#pragma region memory
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumMemoryModules(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
                                                                uint32_t *                  pCount,    ///< [in,out] pointer to the number of components of this type.
                                                                                                       ///< if count is zero, then the driver shall update the value with the
                                                                                                       ///< total number of components of this type that are available.
                                                                                                       ///< if count is greater than the number of components of this type that
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlMemoryGetProperties(ctl_mem_handle_t      hMemory,    ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pState`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlMemoryGetState(ctl_mem_handle_t hMemory, ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlMemoryGetBandwidth(ctl_mem_handle_t     hMemory,   ///< [in] Handle for the component.
...
#define CTL_FAN_COUNT 5
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGetProperties(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockWaiverSet(ctl_device_adapter_handle_t hDeviceHandle ///< [in][release] Handle to display adapter
    );
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuFrequencyOffsetGet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuFrequencyOffsetSet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuVoltageOffsetGet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuVoltageOffsetSet(ctl_device_adapter_handle_t hDeviceHandle,  ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pVfPair`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuLockGet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockGpuLockSet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pOcFrequencyOffset`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockVramFrequencyOffsetGet(ctl_device_adapter_handle_t hDeviceHandle,     ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockVramFrequencyOffsetSet(ctl_device_adapter_handle_t hDeviceHandle,    ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pVoltage`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockVramVoltageOffsetGet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockVramVoltageOffsetSet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockPowerLimitGet(ctl_device_adapter_handle_t hDeviceHandle,       ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockPowerLimitSet(ctl_device_adapter_handle_t hDeviceHandle,      ///< [in][release] Handle to display adapter
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockTemperatureLimitGet(ctl_device_adapter_handle_t hDeviceHandle,    ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockTemperatureLimitSet(ctl_device_adapter_handle_t hDeviceHandle,   ///< [in][release] Handle to display adapter
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPowerTelemetryGet(ctl_device_adapter_handle_t hDeviceHandle, ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hDeviceHandle`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlOverclockResetToDefault(ctl_device_adapter_handle_t hDeviceHandle ///< [in][release] Handle to display adapter
    );
...
#pragma region pci
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPciGetProperties(ctl_device_adapter_handle_t hDAhandle,  ///< [in][release] Handle to display adapter
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pState`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPciGetState(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
...
#pragma region power
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumPowerDomains(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
                                                               uint32_t *                  pCount,    ///< [in,out] pointer to the number of components of this type.
                                                                                                      ///< if count is zero, then the driver shall update the value with the
                                                                                                      ///< total number of components of this type that are available.
                                                                                                      ///< if count is greater than the number of components of this type that
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPowerGetProperties(ctl_pwr_handle_t        hPower,     ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pEnergy`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPowerGetEnergyCounter(ctl_pwr_handle_t            hPower, ///< [in] Handle for the component.
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_HANDLE
    ///         + `nullptr == hPower`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPowerGetLimits(ctl_pwr_handle_t    hPower,      ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlPowerSetLimits(ctl_pwr_handle_t          hPower,      ///< [in] Handle for the component.
...
#pragma region temperature
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pCount`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlEnumTemperatureSensors(ctl_device_adapter_handle_t hDAhandle, ///< [in][release] Handle to display adapter
                                                                     uint32_t *                  pCount,    ///< [in,out] pointer to the number of components of this type.
                                                                                                            ///< if count is zero, then the driver shall update the value with the
                                                                                                            ///< total number of components of this type that are available.
                                                                                                            ///< if count is greater than the number of components of this type that
    ...
    ///     - CTL_RESULT_ERROR_INVALID_NULL_POINTER
    ///         + `nullptr == pProperties`
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlTemperatureGetProperties(ctl_temp_handle_t      hTemperature, ///< [in] Handle for the component.
    ...
    CTL_APIEXPORT ctl_result_t CTL_APICALL ctlTemperatureGetState(ctl_temp_handle_t hTemperature, ///< [in] Handle for the component.
...
#pragma endregion // temperature
    ...
    typedef ctl_result_t(CTL_APICALL *ctl_pfnInit_t)(ctl_init_args_t *, ctl_api_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlClose
    typedef ctl_result_t(CTL_APICALL *ctl_pfnClose_t)(ctl_api_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetRuntimePath
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetRuntimePath_t)(ctl_runtime_path_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlWaitForPropertyChange
    typedef ctl_result_t(CTL_APICALL *ctl_pfnWaitForPropertyChange_t)(ctl_device_adapter_handle_t, ctl_wait_property_change_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlReservedCall
    typedef ctl_result_t(CTL_APICALL *ctl_pfnReservedCall_t)(ctl_device_adapter_handle_t, ctl_reserved_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSupported3DCapabilities
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSupported3DCapabilities_t)(ctl_device_adapter_handle_t, ctl_3d_feature_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSet3DFeature
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSet3DFeature_t)(ctl_device_adapter_handle_t, ctl_3d_feature_getset_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlCheckDriverVersion
    typedef ctl_result_t(CTL_APICALL *ctl_pfnCheckDriverVersion_t)(ctl_device_adapter_handle_t, ctl_version_info_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumerateDevices
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumerateDevices_t)(ctl_api_handle_t, uint32_t *, ctl_device_adapter_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumerateDisplayOutputs
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumerateDisplayOutputs_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_display_output_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumerateI2CPinPairs
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumerateI2CPinPairs_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_i2c_pin_pair_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetDeviceProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetDeviceProperties_t)(ctl_device_adapter_handle_t, ctl_device_adapter_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetDisplayProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetDisplayProperties_t)(ctl_display_output_handle_t, ctl_display_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetAdaperDisplayEncoderProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetAdaperDisplayEncoderProperties_t)(ctl_display_output_handle_t, ctl_adapter_display_encoder_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetZeDevice
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetZeDevice_t)(ctl_device_adapter_handle_t, void *, void **);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSharpnessCaps
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSharpnessCaps_t)(ctl_display_output_handle_t, ctl_sharpness_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetCurrentSharpness
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetCurrentSharpness_t)(ctl_display_output_handle_t, ctl_sharpness_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetCurrentSharpness
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetCurrentSharpness_t)(ctl_display_output_handle_t, ctl_sharpness_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlI2CAccess
    typedef ctl_result_t(CTL_APICALL *ctl_pfnI2CAccess_t)(ctl_display_output_handle_t, ctl_i2c_access_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlI2CAccessOnPinPair
    typedef ctl_result_t(CTL_APICALL *ctl_pfnI2CAccessOnPinPair_t)(ctl_i2c_pin_pair_handle_t, ctl_i2c_access_pinpair_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlAUXAccess
    typedef ctl_result_t(CTL_APICALL *ctl_pfnAUXAccess_t)(ctl_display_output_handle_t, ctl_aux_access_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetPowerOptimizationCaps
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetPowerOptimizationCaps_t)(ctl_display_output_handle_t, ctl_power_optimization_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetPowerOptimizationSetting
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetPowerOptimizationSetting_t)(ctl_display_output_handle_t, ctl_power_optimization_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetPowerOptimizationSetting
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetPowerOptimizationSetting_t)(ctl_display_output_handle_t, ctl_power_optimization_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetBrightnessSetting
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetBrightnessSetting_t)(ctl_display_output_handle_t, ctl_set_brightness_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetBrightnessSetting
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetBrightnessSetting_t)(ctl_display_output_handle_t, ctl_get_brightness_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPixelTransformationGetConfig
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPixelTransformationGetConfig_t)(ctl_display_output_handle_t, ctl_pixtx_pipe_get_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPixelTransformationSetConfig
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPixelTransformationSetConfig_t)(ctl_display_output_handle_t, ctl_pixtx_pipe_set_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPanelDescriptorAccess
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPanelDescriptorAccess_t)(ctl_display_output_handle_t, ctl_panel_descriptor_access_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSupportedRetroScalingCapability
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSupportedRetroScalingCapability_t)(ctl_device_adapter_handle_t, ctl_retro_scaling_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetRetroScaling
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetRetroScaling_t)(ctl_device_adapter_handle_t, ctl_retro_scaling_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSupportedScalingCapability
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSupportedScalingCapability_t)(ctl_display_output_handle_t, ctl_scaling_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetCurrentScaling
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetCurrentScaling_t)(ctl_display_output_handle_t, ctl_scaling_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetCurrentScaling
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetCurrentScaling_t)(ctl_display_output_handle_t, ctl_scaling_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetLACEConfig
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetLACEConfig_t)(ctl_display_output_handle_t, ctl_lace_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetLACEConfig
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetLACEConfig_t)(ctl_display_output_handle_t, ctl_lace_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSoftwarePSR
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSoftwarePSR_t)(ctl_display_output_handle_t, ctl_sw_psr_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetIntelArcSyncInfoForMonitor
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetIntelArcSyncInfoForMonitor_t)(ctl_display_output_handle_t, ctl_intel_arc_sync_monitor_params_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumerateMuxDevices
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumerateMuxDevices_t)(ctl_api_handle_t, uint32_t *, ctl_mux_output_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetMuxProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetMuxProperties_t)(ctl_mux_output_handle_t, ctl_mux_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSwitchMux
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSwitchMux_t)(ctl_mux_output_handle_t, ctl_display_output_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetIntelArcSyncProfile
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetIntelArcSyncProfile_t)(ctl_display_output_handle_t, ctl_intel_arc_sync_profile_params_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlSetIntelArcSyncProfile
    typedef ctl_result_t(CTL_APICALL *ctl_pfnSetIntelArcSyncProfile_t)(ctl_display_output_handle_t, ctl_intel_arc_sync_profile_params_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEdidManagement
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEdidManagement_t)(ctl_display_output_handle_t, ctl_edid_management_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetCustomMode
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetCustomMode_t)(ctl_display_output_handle_t, ctl_get_set_custom_mode_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetCombinedDisplay
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetCombinedDisplay_t)(ctl_device_adapter_handle_t, ctl_combined_display_args_t *);
    ...
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetVblankTimestamp_t)(ctl_display_output_handle_t, ctl_vblank_ts_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlLinkDisplayAdapters
    typedef ctl_result_t(CTL_APICALL *ctl_pfnLinkDisplayAdapters_t)(ctl_device_adapter_handle_t, ctl_lda_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlUnlinkDisplayAdapters
    typedef ctl_result_t(CTL_APICALL *ctl_pfnUnlinkDisplayAdapters_t)(ctl_device_adapter_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetLinkedDisplayAdapters
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetLinkedDisplayAdapters_t)(ctl_device_adapter_handle_t, ctl_lda_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetDynamicContrastEnhancement
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetDynamicContrastEnhancement_t)(ctl_display_output_handle_t, ctl_dce_args_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetWireFormat
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetWireFormat_t)(ctl_display_output_handle_t, ctl_get_set_wire_format_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetDisplaySettings
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetDisplaySettings_t)(ctl_display_output_handle_t, ctl_display_settings_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumEngineGroups
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumEngineGroups_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_engine_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEngineGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEngineGetProperties_t)(ctl_engine_handle_t, ctl_engine_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEngineGetActivity
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEngineGetActivity_t)(ctl_engine_handle_t, ctl_engine_stats_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumFans
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumFans_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_fan_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanGetProperties_t)(ctl_fan_handle_t, ctl_fan_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanGetConfig
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanGetConfig_t)(ctl_fan_handle_t, ctl_fan_config_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanSetDefaultMode
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanSetDefaultMode_t)(ctl_fan_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanSetFixedSpeedMode
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanSetFixedSpeedMode_t)(ctl_fan_handle_t, const ctl_fan_speed_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanSetSpeedTableMode
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanSetSpeedTableMode_t)(ctl_fan_handle_t, const ctl_fan_speed_table_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFanGetState
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFanGetState_t)(ctl_fan_handle_t, ctl_fan_speed_units_t, int32_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumFrequencyDomains
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumFrequencyDomains_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_freq_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencyGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencyGetProperties_t)(ctl_freq_handle_t, ctl_freq_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencyGetAvailableClocks
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencyGetAvailableClocks_t)(ctl_freq_handle_t, uint32_t *, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencyGetRange
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencyGetRange_t)(ctl_freq_handle_t, ctl_freq_range_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencySetRange
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencySetRange_t)(ctl_freq_handle_t, const ctl_freq_range_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencyGetState
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencyGetState_t)(ctl_freq_handle_t, ctl_freq_state_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlFrequencyGetThrottleTime
    typedef ctl_result_t(CTL_APICALL *ctl_pfnFrequencyGetThrottleTime_t)(ctl_freq_handle_t, ctl_freq_throttle_time_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSupportedVideoProcessingCapabilities
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSupportedVideoProcessingCapabilities_t)(ctl_device_adapter_handle_t, ctl_video_processing_feature_caps_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlGetSetVideoProcessingFeature
    typedef ctl_result_t(CTL_APICALL *ctl_pfnGetSetVideoProcessingFeature_t)(ctl_device_adapter_handle_t, ctl_video_processing_feature_getset_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumMemoryModules
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumMemoryModules_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_mem_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlMemoryGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnMemoryGetProperties_t)(ctl_mem_handle_t, ctl_mem_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlMemoryGetState
    typedef ctl_result_t(CTL_APICALL *ctl_pfnMemoryGetState_t)(ctl_mem_handle_t, ctl_mem_state_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlMemoryGetBandwidth
    typedef ctl_result_t(CTL_APICALL *ctl_pfnMemoryGetBandwidth_t)(ctl_mem_handle_t, ctl_mem_bandwidth_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGetProperties_t)(ctl_device_adapter_handle_t, ctl_oc_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockWaiverSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockWaiverSet_t)(ctl_device_adapter_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuFrequencyOffsetGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuFrequencyOffsetGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuFrequencyOffsetSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuFrequencyOffsetSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuVoltageOffsetGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuVoltageOffsetGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuVoltageOffsetSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuVoltageOffsetSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuLockGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuLockGet_t)(ctl_device_adapter_handle_t, ctl_oc_vf_pair_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockGpuLockSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockGpuLockSet_t)(ctl_device_adapter_handle_t, ctl_oc_vf_pair_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockVramFrequencyOffsetGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockVramFrequencyOffsetGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockVramFrequencyOffsetSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockVramFrequencyOffsetSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockVramVoltageOffsetGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockVramVoltageOffsetGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockVramVoltageOffsetSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockVramVoltageOffsetSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockPowerLimitGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockPowerLimitGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockPowerLimitSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockPowerLimitSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockTemperatureLimitGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockTemperatureLimitGet_t)(ctl_device_adapter_handle_t, double *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockTemperatureLimitSet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockTemperatureLimitSet_t)(ctl_device_adapter_handle_t, double);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPowerTelemetryGet
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPowerTelemetryGet_t)(ctl_device_adapter_handle_t, ctl_power_telemetry_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlOverclockResetToDefault
    typedef ctl_result_t(CTL_APICALL *ctl_pfnOverclockResetToDefault_t)(ctl_device_adapter_handle_t);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPciGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPciGetProperties_t)(ctl_device_adapter_handle_t, ctl_pci_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPciGetState
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPciGetState_t)(ctl_device_adapter_handle_t, ctl_pci_state_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumPowerDomains
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumPowerDomains_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_pwr_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPowerGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPowerGetProperties_t)(ctl_pwr_handle_t, ctl_power_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPowerGetEnergyCounter
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPowerGetEnergyCounter_t)(ctl_pwr_handle_t, ctl_power_energy_counter_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPowerGetLimits
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPowerGetLimits_t)(ctl_pwr_handle_t, ctl_power_limits_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlPowerSetLimits
    typedef ctl_result_t(CTL_APICALL *ctl_pfnPowerSetLimits_t)(ctl_pwr_handle_t, const ctl_power_limits_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlEnumTemperatureSensors
    typedef ctl_result_t(CTL_APICALL *ctl_pfnEnumTemperatureSensors_t)(ctl_device_adapter_handle_t, uint32_t *, ctl_temp_handle_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlTemperatureGetProperties
    typedef ctl_result_t(CTL_APICALL *ctl_pfnTemperatureGetProperties_t)(ctl_temp_handle_t, ctl_temp_properties_t *);

    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Function-pointer for ctlTemperatureGetState
    typedef ctl_result_t(CTL_APICALL *ctl_pfnTemperatureGetState_t)(ctl_temp_handle_t, double *);
