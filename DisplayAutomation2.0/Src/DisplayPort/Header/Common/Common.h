...
#define IGFX_DISPLAY_DEVICE_OVERRIDE \
    (0x004)                                   // Policy indicates Unattached device
...
#define MAX_MONITORS_PER_ADAPTER \
    6 // The maximum number of monitors that
...
#define IGFX_DISPLAY_DEVICE_CONFIG_FLAG_DDEXTD (0x5)  // Display Extended Desktop

// collage
#define IGFX_DISPLAY_DEVICE_CONFIG_FLAG_DUAL_HORZCOLLAGE (0x6) // Dual Horizontal Collage
#define IGFX_DISPLAY_DEVICE_CONFIG_FLAG_DUAL_VERTCOLLAGE (0x7) // Dual Vertical Collage
#define IGFX_DISPLAY_DEVICE_CONFIG_FLAG_TRI_HORZCOLLAGE (0x8)  // Tri Horizontal Collage
#define IGFX_DISPLAY_DEVICE_CONFIG_FLAG_TRI_VERTCOLLAGE (0x9)  // Tri Vertical Collage
...
static const GUID IGFX_HDMI_INFOFRAME_1_0 = { 0xa619d1a8, 0x863f, 0x4a30, { 0xad, 0xe, 0xbb, 0x44, 0x44, 0x6, 0x74, 0x48 } };

typedef struct IGFX_ERROR
{
...
// Extended structure for three displays.
// {70FD0DA7-F8BD-4afc-9898-A5C13107A445}
...
#endif
} IGFX_TEST_CONFIG_EX, *PIGFX_TEST_CONFIG_EX;
...
// {954C250E-62A7-4f14-BEDF-8DBAD36CF582}
...
typedef struct
{
    ...
    ULONG   ulBuildNumber;
    BOOLEAN bGOP_VBIOS;
} IGFX_GOP_VERSION, *PIGFX_GOP_VERSION;
...
typedef struct _IGFX_SYSTEM_CONFIG_DATA_N_VIEW
{
    ...
    IGFX_DISPLAY_CONFIG_DATA_EX DispCfg[16]; // Array of Display Data
...
#define IGFX_MEDIA_FEATURE_GC 0x0400              // GC
...
static const GUID IGFX_GET_SET_PF2_MEDIASCALAR_GUID = { 0x1bf943c9, 0x507d, 0x400b, { 0xad, 0xc, 0xf4, 0x7d, 0x4b, 0x74, 0x87, 0x1a } };
...
static const GUID IGFX_DLCAPS_GUID_1_0 = { 0x4e0275f0, 0x51da, 0x49a0, { 0x84, 0xfc, 0xe5, 0x64, 0x81, 0xde, 0x44, 0x6a } };
...
#define IGFX_POWER_SRD 0x20 // PSR(Haswell), SRD(Ivybridge,Sandybridge)
...
#define IGFX_POWER_DFRC 0x100            // Dynamic Frame Rate Control
...
static DWORD dwBlockDevice[] = { 0x70, 0x72, 0x74, 0xFF }; // 0x6E, 0x6F are removed as requested by Marketing

static DWORD dwBlockAddress[] = { 0x70, 0x72, 0x74, 0xFF };
...
static const GUID IGFX_GET_SET_MBM_INFO_GUID = { 0xa6e5a3eb, 0x204b, 0x4b30, { 0x91, 0x44, 0x60, 0x3e, 0x42, 0x79, 0x54, 0x77 } };
...
// bug 4910092 - Making version check specific to API
#define MEDIAGAMUT_VERSIONS_SUPPORTED 1
#define MEDIASCALING_VERSIONS_SUPPORTED 1
#define MEDIAQUALITY_VERSIONS_SUPPORTED 3
#define MEDIACOLOR_VERSIONS_SUPPORTED 2
...
#define IGFX_MEDIA_COLOR_INPUTRANGE_APP_SETTINGS 0
...
// {FB35CFCC-6C8F-40C8-BFA7-F67DD58F9A4B}
static const GUID IGFX_GET_SET_MEDIA_GAMUT_MAPPING = { 0xfb35cfcc, 0x6c8f, 0x40c8, { 0xbf, 0xa7, 0xf6, 0x7d, 0xd5, 0x8f, 0x9a, 0x4b } };

#define IGFX_MEDIA_GAMUT_COMPRESSION_DISABLED 0
#define IGFX_MEDIA_GAMUT_COMPRESSION_RELATIVE 1
#define IGFX_MEDIA_GAMUT_COMPRESSION_PERCEPTUAL 2
typedef struct _IGFX_MEDIA_GAMUT_MAPPING
{
    ...
    /*INOUT*/ DWORD dwFlags;
#endif
} IGFX_MEDIA_GAMUT_MAPPING, *PIGFX_MEDIA_GAMUT_MAPPING;
...
static const GUID IGFX_GET_DEVICETYPE_GUID = { 0x46c34d74, 0x4042, 0x4241, 0x95, 0x95, 0xb1, 0x34, 0xf0, 0x13, 0x24, 0xdf };
...
// {808CDFEB-E04F-4214-ABD2-3E7BBE629599}
...
static const GUID IGFX_S3D_CAPS_GUID = { 0xbca5da13, 0x973b, 0x4986, { 0x99, 0xf7, 0xcd, 0x8e, 0x9e, 0x12, 0x73, 0x7d } };

// {51C3057B-953B-43DE-96B6-A5FF1ABA8805}
static const GUID IGFX_S3D_CAPS_GUID_EX = { 0x51c3057b, 0x953b, 0x43de, { 0x96, 0xb6, 0xa5, 0xff, 0x1a, 0xba, 0x88, 0x5 } };
...
typedef struct _IGFX_S3D_MODE_CAPS_STRUCT
{
    ...
    ULONG ulReserved;    // Do not care for now
...
static const GUID IGFX_S3D_CONTROL_GUID = { 0x945849bd, 0x99d7, 0x4be8, { 0xac, 0xe1, 0xc4, 0x9a, 0x9a, 0x7a, 0xe, 0xb1 } };
...
static const GUID IGFX_PERSISTENCE_GUID = { 0x35a3e4e5, 0xa33a, 0x4bc6, 0x9a, 0x15, 0x45, 0xc1, 0x99, 0x96, 0x92, 0x80 };
...
// POWER CONS TURBO OVER CLOCKING
...
static const GUID IGFX_TURBO_OVERCLOCKING = { 0x9e9ceb39, 0xee24, 0x4c8a, { 0xbb, 0xac, 0xbd, 0x89, 0x84, 0xd7, 0xc1, 0x6b } };
...
typedef struct _IGFX_POWER_CONSERVATION_DATA_EX
{
    ...
    // TRUE if Over Clocking is enabled when Current Frequency is above or equal to Minimum frequency
    // and Current voltage is greater than zero
    BOOL bEnableOC;

    // Maximum turbo Frequency
    DWORD dwMaxOCFrequency;

    // Maximum turbo  Voltage
    DWORD dwMaxOCVoltage;

    // Minimum turbo Frequency
    ...
    // Removed reserved on Powercons request to differentiate the OC vlotage 1000 and 256.
    DWORD dwFlags;
#endif
...
typedef struct _IGFX_MONITOR_CONTROL_HEADER
{
    DWORD      dwVersion;
    DWORD      dwReserved; // for internal use only
    IGFX_ERROR ErrorInfo;
} IGFX_MONITOR_CONTROL_HEADER, IGFX_DIPSLAY_CONFIG_HEADER;

// {2949522C-C19D-47b4-ACBD-CF7FAAFE95A0}
static const GUID IGFX_MONITOR_CONTROLLER_GUID = { 0x2949522c, 0xc19d, 0x47b4, { 0xac, 0xbd, 0xcf, 0x7f, 0xaa, 0xfe, 0x95, 0xa0 } };

typedef enum _MONITOR_POWER_STATE
{
    UNKNOWN = -1, // power state before a get call...
    OFF,
    ON
} MONITOR_POWER_STATE;

typedef struct _IGFX_MONITOR_POWERCONTROLLER
{
    IGFX_MONITOR_CONTROL_HEADER header;
#if IS_MONITOR_CONTROLLLER_VERSION_SUPPORTED(1)
    DWORD               dwDeviceID;
    MONITOR_POWER_STATE monitorPowerState;
    DWORD               dwReserved; // for internal use only
#endif
#if IS_MONITOR_CONTROLLLER_VERSION_SUPPORTED(2)
    // add new code here for future releases
#endif
} IGFX_MONITOR_POWERCONTROLLER;

// {B8958995-02A6-4bdf-8028-A4E22AC3F14D}
static const GUID IGFX_GET_SET_DP_TOPOLOGY_GUID = { 0xb8958995, 0x2a6, 0x4bdf, { 0x80, 0x28, 0xa4, 0xe2, 0x2a, 0xc3, 0xf1, 0x4d } };

#define DP_TOPOLOGY_VERSION_SUPPORTED 1
#define IS_DP_TOPOLOGY_VERSION_SUPPORTED(x) (x <= DP_TOPOLOGY_VERSION_SUPPORTED)
...
typedef enum _QUERY_TYPE
{
    ...
    IGFX_DP_LIST_DETAILS,
    IGFX_DP_DISPLAY_NAMES
} QUERY_TYPE;

#if 0
typedef struct _IGFX_DP_RELATIVE_ADDRESS
{
    UCHAR ucTotalLinkCount;
    UCHAR ucAddress[8];
}IGFX_DP_RELATIVE_ADDRESS, *PIGFX_DP_RELATIVE_ADDRESS;

typedef struct _IGFX_DP_TOPOLOGY_DISPLAY
{
...
}IGFX_DP_DISPLAY, *PIGFX_DP_DISPLAY;

typedef struct _IGFX_DP_TOPOLOGY
{
	IGFX_VERSION_HEADER				versionHeader;
#if IS_DP_TOPOLOGY_VERSION_SUPPORTED(1)
	DWORD			PortType;
	BOOL			bValidDPTopology;
	QUERY_TYPE		queryType;
	ULONG			NumDisplays;        // Number of displays
	DWORD			dwReserved;			// Reserved
    IGFX_DP_DISPLAY	displays[1];		// Array of modes
#endif
#if IS_DP_TOPOLOGY_VERSION_SUPPORTED(2)
	// add new code here for future releases
#endif
}IGFX_DP_TOPOLOGY, *PIGFX_DP_TOPOLOGY;
#endif

// {3A135933-C8DC-43a0-8999-4A7322D90DF1}
static const GUID IGFX_GET_SET_AUDIO_FEATURE_GUID = { 0x3a135933, 0xc8dc, 0x43a0, { 0x89, 0x99, 0x4a, 0x73, 0x22, 0xd9, 0xd, 0xf1 } };

#define AUDIO_VERSIONS_SUPPORTED 1
#define IS_AUDIO_VERSION_SUPPORTED(x) (x <= AUDIO_VERSIONS_SUPPORTED)

#define IGFX_AUDIO_UNINITIALIZED 0
#define IGFX_CLONED_AUDIO 1
#define IGFX_INDEPENDENT_AUDIO 2
#define IGFX_AUDIO_GET 0
#define IGFX_AUDIO_SET 1
#define IGFX_AUDIO_WT_VIDEO_DISABLE 1
#define IGFX_AUDIO_WT_VIDEO_ENABLE 2
#define CUI_AUDIO_DEV_MAX 0x06 // DEVICE2 + DEVICE3 = 0x10 + 0x100
#define CUI_AUDIO_DEV_MIN 0x03 // DEVICE1 + DEVICE2 = 0x01 + 0x010
#define IGFX_MAX_AUDIO_DEVICES 0x03
typedef struct _IGFX_AUDIO_FEATURE_INFO
{
    IGFX_VERSION_HEADER versionHeader;
#if IS_AUDIO_VERSION_SUPPORTED(1)
    DWORD dwNumberofAudio;
    DWORD dwAudioCapDisplays[IGFX_MAX_AUDIO_DEVICES];
    DWORD dwAudioConfig;
    DWORD dwActiveAudioDisplays[IGFX_MAX_AUDIO_DEVICES];
    DWORD dwAudioWoutVideo;
    DWORD dwAudioSupport;
    DWORD dwAudioWOVideoSupport; // Support
#endif

#if IS_AUDIO_VERSION_SUPPORTED(2)
#endif

} IGFX_AUDIO_FEATURE_INFO, *PIGFX_AUDIO_FEATURE_INFO;

// API to get Display Model and Serial Number.
// {D4D89CDA-18AF-4905-B6D5-01FC8A9B1F90}
static const GUID IGFX_DISPLAY_DETAILS_GUID = { 0xd4d89cda, 0x18af, 0x4905, { 0xb6, 0xd5, 0x1, 0xfc, 0x8a, 0x9b, 0x1f, 0x90 } };

#define DISPLAY_DETAILS_VERSIONS_SUPPORTED 1
#define IS_DISP_DETAILS_VERSION_SUPPORTED(x) (x <= DISPLAY_DETAILS_VERSIONS_SUPPORTED)

typedef struct _IGFX_DISPLAY_DETAILS
{
    IGFX_VERSION_HEADER versionHeader;
#if IS_DISP_DETAILS_VERSION_SUPPORTED(1)
    DWORD dwDeviceID;
    WCHAR DeviceSerial[13];
    WCHAR DeviceModel[13];
#endif
} IGFX_DISPLAY_DETAILS;
...
#define D3D_VERSION_SUPPORTED 3
...
// {D6B817FE-03C0-45E7-987A-7EF605DFDFCC}
...
typedef struct _IGFX_RESTORE_GRAPHICS_DEFAULT_VERSION_HEADER
{
    DWORD      dwVersion;
    DWORD      dwReserved;
    IGFX_ERROR ErrorInfo;
...
typedef struct _RESTORE_GRAPHICS_DEFAULT_INFO
{
...
} IGFX_RESTORE_GRAPHICS_DEFAULT_INFO, *PIGFX_RESTORE_GRAPHICS_DEFAULT_INFO;

// DPP RCR

// {EDC4EC28-DB84-45F7-AFAB-F704A11051BB}
static const GUID IGFX_GET_SET_DPP_INFO_GUID = { 0xedc4ec28, 0xdb84, 0x45f7, { 0xaf, 0xab, 0xf7, 0x4, 0xa1, 0x10, 0x51, 0xbb } };

#define DPP_VERSION_SUPPORTED 1
#define IS_DPP_VERSION_SUPPORTED(x) (x <= DPP_VERSION_SUPPORTED)

typedef struct _IGFX_DPP_VERSION_HEADER
{
    DWORD      dwVersion;
    DWORD      dwReserved;
    IGFX_ERROR ErrorInfo;
} IGFX_DPP_VERSION_HEADER;

typedef struct _DPP_INFO
{
    IGFX_DPP_VERSION_HEADER header;
#if IS_DPP_VERSION_SUPPORTED(1)
    /*OUT*/ BOOL   bIsSupportedDPP;
    /*INOUT*/ BOOL bIsEnabledDPP;
    /*INOUT*/ BOOL bIsEnabledManualMode;
    /*INOUT*/ UINT uiAmbientColorTemperatureValue;
    /*INOUT*/ UINT uiAmbientLightValue;
    /*INOUT*/ UINT uiBrightnessValue;
    /*INOUT*/ UINT uiSkinToneValue;
#endif
#if IS_DPP_VERSION_SUPPORTED(2)
    // add new code here for future releases
#endif
} IGFX_DPP_INFO, *PIGFX_DPP_INFO;

// {4AFD1957-3482-4CAE-82A0-550BDF479E4E}
static const GUID IGFX_GET_SET_SMARTFRAME_GUID = { 0x4afd1957, 0x3482, 0x4cae, { 0x82, 0xa0, 0x55, 0xb, 0xdf, 0x47, 0x9e, 0x4e } };

#define SF_VERSION_SUPPORTED 1
#define IS_SF_VERSION_SUPPORTED(x) (x <= SF_VERSION_SUPPORTED)

typedef struct _IGFX_SF_VERSION_HEADER
{
    DWORD      dwVersion;
    DWORD      dwReserved;
    IGFX_ERROR ErrorInfo;
} IGFX_SF_VERSION_HEADER;

typedef struct _SmartFrame
{
    IGFX_SF_VERSION_HEADER header;
#if IS_SF_VERSION_SUPPORTED(1)
    /*IN*/ DWORD      dwDisplayUID;
    /*OUT*/ BOOLEAN   bFeatureSupported; // return True/false is SF supported or not
    /*INOUT*/ BOOLEAN bSFEnable;         // Enable/Disable SF requested
    /*IN*/ ULONG      ulSFCustomCompX;   // CUI scaled custom scaling x val
    /*IN*/ ULONG      ulSFCustomCompY;   // CUI scaled custom scaling y val
    /*IN*/ ULONG      iYPosition;        // Vertical Position where SF viewport should start
#endif
#if IS_SF_VERSION_SUPPORTED(2)
                             // add new code here for future releases
#endif
} IGFX_SMARTFRAME_INFO, *PIGFX_SMARTFRAME_INFO;

// {8D80421F-DBA3-42EC-B62F-C41F66BDEC01}
static const GUID IGFX_GET_SET_N_VIEW_CONFIG_EX_GUID = { 0x8d80421f, 0xdba3, 0x42ec, { 0xb6, 0x2f, 0xc4, 0x1f, 0x66, 0xbd, 0xec, 0x1 } };

#define COLLAGE_VERSION_SUPPORTED 1
#define IS_COLLAGE_VERSION_SUPPORTED(x) (x <= COLLAGE_VERSION_SUPPORTED)
#define MAX_MULTIPLE_DISPLAYS 3

typedef struct IGFX_BEZEL_VALUES
{
    DWORD lBezelX;
    DWORD lBezelY;
    DWORD lMaxBezelX;
...
typedef struct IGFX_COLLAGE_CONFIG
{
    BOOL              dwEnableBezelCorrection;
    IGFX_BEZEL_VALUES bezelValues[MAX_MULTIPLE_DISPLAYS - 1];
} IGFX_COLLAGE_CONFIG;

typedef struct _IGFX_SYSTEM_CONFIG_DATA_N_VIEW_EX
{
    IGFX_DIPSLAY_CONFIG_HEADER configHeader;
#if IS_COLLAGE_VERSION_SUPPORTED(1)
    DWORD                       dwOpMode;                       // Operating Mode
    UINT                        uiNDisplays;                    // number of displays
    IGFX_COLLAGE_CONFIG         collageConfig;                  // Collage Related
    IGFX_DISPLAY_CONFIG_DATA_EX DispCfg[MAX_MULTIPLE_DISPLAYS]; // Array of Display Data
#endif
#if IS_COLLAGE_VERSION_SUPPORTED(2)

#endif
} IGFX_SYSTEM_CONFIG_DATA_N_VIEW_EX, *PIGFX_SYSTEM_CONFIG_DATA_N_VIEW_EX;

// {0A0E7BF5-6951-4B02-8776-F6E9124841E5}
static const GUID IGFX_GET_VIDEO_MODE_LIST_EX2_GUID = { 0xa0e7bf5, 0x6951, 0x4b02, { 0x87, 0x76, 0xf6, 0xe9, 0x12, 0x48, 0x41, 0xe5 } };

#define VIDEO_MODELIST_VERSIONS_EX2_SUPPORTED 1
#define IS_VIDEO_MODELIST_VERSION_EX2_SUPPORTED(x) (x <= VIDEO_MODELIST_VERSIONS_EX2_SUPPORTED)
#define MAX_CUI_VIDEO_MODES 1000 // same number already defined in UserStruct.h

typedef struct _IGFX_VIDEO_MODE_LIST_EX2
{
    IGFX_VERSION_HEADER versionHeader;
#if IS_VIDEO_MODELIST_VERSION_EX2_SUPPORTED(1)
    DWORD                       dwOpMode;
    UINT                        uiNDisplays; // Number of active displays
    IGFX_DISPLAY_CONFIG_DATA_EX DispCfg[MAX_MONITORS_PER_ADAPTER];
    DWORD                       dwDeviceID;
    WORD                        vmlNumModes;                   // Number of video modes in list
    IGFX_COLLAGE_CONFIG         collageConfig;                 // Collage Related
    IGFX_DISPLAY_RESOLUTION_EX  vmlModes[MAX_CUI_VIDEO_MODES]; // Array of modes
#endif
#if IS_VIDEO_MODELIST_VERSION_EX2_SUPPORTED(2)
    // For future extention
#endif
} IGFX_VIDEO_MODE_LIST_EX2, *PIGFX_VIDEO_MODE_LIST_EX2;

//// {61A8470B-918E-48FB-B65B-A6846678C2F1}
////static const GUID IGFX_GET_SET_COLLAGE_STATUS_GUID =
// GUID IGFX_GET_SET_COLLAGE_STATUS_GUID =
//{ 0x61a8470b, 0x918e, 0x48fb, { 0xb6, 0x5b, 0xa6, 0x84, 0x66, 0x78, 0xc2, 0xf1 } };
...
typedef struct _IGFX_COLLAGE_STATUS
{
    ...
    /*OUT*/ BOOL   bDefaultCollageStatus; // This is always FALSE
    /*INOUT*/ BOOL bIsCollageModeEnabled;
#endif
#if IS_COLLAGE_STATUS_VERSION_SUPPORTED(2)
    // For future extention
#endif
} IGFX_COLLAGE_STATUS, *PIGFX_COLLAGE_STATUS;
