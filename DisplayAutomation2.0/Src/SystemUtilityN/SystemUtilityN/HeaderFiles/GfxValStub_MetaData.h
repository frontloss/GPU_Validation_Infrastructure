...
/**
 * file name       GfxValStub_MetaData.h (This file has been copied from mainline driver (Source\miniport\LHDM\GfxValStub\inc). This file has to be maintained in sync with driver
 * file.) Date:           04/02/2015
 * @version        0.1
