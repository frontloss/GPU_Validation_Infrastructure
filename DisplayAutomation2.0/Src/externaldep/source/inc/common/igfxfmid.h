/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*****************************************************************************
** Copyright (c) Intel Corporation (1997-2016).                             *
**                                                                          *
...
typedef enum
{
    ...
    IGFX_MAX_CORE = 19,     // Max Family, for lookup table
...
#define GFX_IS_NAPA_RENDER_FAMILY(p) ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN3_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN3_5_CORE))

#define GFX_IS_GEN_RENDER_FAMILY(p)                                                                                                                                      \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN4_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN4_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_CORE) ||    \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_75_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN6_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) ||    \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) ||    \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_5_OR_LATER(p)                                                                                                                                         \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_75_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN6_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) ||    \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) ||     \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_5_75_OR_LATER(p)                                                                                                                                    \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN5_75_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN6_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) ||  \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_6_OR_LATER(p)                                                                                                                                      \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN6_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) ||  \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_7_OR_LATER(p)                                                                                                                                      \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_7_5_OR_LATER(p)                                                                                                                                     \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN7_5_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) ||  \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_8_OR_LATER(p)                                                                                                                                     \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN8_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_8_CHV_OR_LATER(p)                                                                                                                               \
    ((GFX_GET_CURRENT_PRODUCT(p) == IGFX_CHERRYVIEW) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_9_OR_LATER(p)                                                                                                                                      \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN9_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_10_OR_LATER(p)                                                                                                                                      \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN10_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || \
     (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_11_OR_LATER(p) \
    ((GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN11_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GEN12_CORE) || (GFX_GET_CURRENT_RENDERCORE(p) == IGFX_GENNEXT_CORE))

#define GFX_IS_GEN_12_OR_LATER(p) ((GFX_GET_CURRENT_RENDERCORE(p) >= IGFX_GEN12_CORE))

#define GFX_IS_ATOM_PRODUCT_FAMILY(p) (GFX_IS_PRODUCT(p, IGFX_VALLEYVIEW) || GFX_IS_PRODUCT(p, IGFX_CHERRYVIEW) || GFX_IS_PRODUCT(p, IGFX_BROXTON))
...
#define ICDV_DEVICE_F0_ID_MASK \
    0xFFF0 // Mask of Penwell_D graphics function 0 ID. Bits [3:0]
...
// GLV
#define IGLV_GT1_MOB_SIM_DEVICE_F0_ID 0xFF10 // For Pre-Si
...
// CNL Si device ids
#define ICNL_5x8_ULX_DEVICE_F0_ID 0x5A51
#define ICNL_5x8_ULT_DEVICE_F0_ID 0x5A52
#define ICNL_4x8_ULT_DEVICE_F0_ID 0x5A5A
#define ICNL_3x8_ULT_DEVICE_F0_ID 0x5A42
#define ICNL_2x8_ULT_DEVICE_F0_ID 0x5A4A
#define ICNL_9x8_ULT_DEVICE_F0_ID 0x5A62
#define ICNL_9x8_SUPERSKU_DEVICE_F0_ID 0x5A60
#define ICNL_5x8_SUPERSKU_DEVICE_F0_ID 0x5A50
#define ICNL_1x6_5x8_SUPERSKU_DEVICE_F0_ID 0x5A40
#define ICNL_5x8_HALO_DEVICE_F0_ID 0x5A54
#define ICNL_3x8_HALO_DEVICE_F0_ID 0x5A44
#define ICNL_5x8_DESKTOP_DEVICE_F0_ID 0x5A55
#define ICNL_3x8_DESKTOP_DEVICE_F0_ID 0x5A45
#define ICNL_4x8_ULX_DEVICE_F0_ID 0x5A59
#define ICNL_3x8_ULX_DEVICE_F0_ID 0x5A41
#define ICNL_2x8_ULX_DEVICE_F0_ID 0x5A49
#define ICNL_4x8_HALO_DEVICE_F0_ID 0x5A5C

// CNX_G
#define ICNX_G_GT1_MOB_DEVICE_F0_ID 0xFF15 // For Pre-Si
...
// ICL PCH SImulation
#define PCH_ICL_DEV_SIM_ID 0x3A16

// GEN11LP
// TODO: Jalpa - this is causing build issue in OCL NEO.
#define IGEN11LP_GT1_MOB_DEVICE_F0_ID 0xFF05 // For Pre-Si
#define IICL_LP_GT1_MOB_DEVICE_F0_ID 0xFF05  // For Pre-Si only
...
#define IICL_LP_0x0x0_ULT_DEVICE_A0_ID 0x8A70 // No GFX, Display Only
#define IICL_LP_1x1x8_ULT_DEVICE_A0_ID 0x8A71

// Gen12LP
#define IGEN12LP_GT1_MOB_DEVICE_F0_ID 0xFF20 // For Pre-Si

// ICL
#define IICL_1x4x8_DESK_DEVICE_F0_ID 0xFF01
#define IICL_2x4x8_DESK_DEVICE_F0_ID 0xFF02 // Not POR
#define IICL_4x4x8_DESK_DEVICE_F0_ID 0xFF03

// LKF
#define ILKF_1x8x8_DESK_DEVICE_F0_ID 0x9840

// ICL PCH LP Device IDs
#define ICP_LP_RESERVED_FUSE_ID 0x3480 // Reserved for fused parts
