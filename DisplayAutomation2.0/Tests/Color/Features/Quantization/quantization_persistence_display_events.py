#################################################################################################
# @file         quantization_persistence_display_events.py
...
#               3.Will perform the scenario based on input hotplug_unplug(),mode_switch(), display_switch() and
#                 monitor_turnoff_on()
...
class QuantizationTestPersistenceDisplayEvents(QuantizationTestBase):
    ############################
    # Test Function
    ############################
                            ...
                            for port, panel in adapter.panels.items():
                                if panel.is_active and panel.is_lfp is False:
                                    ...
                                    self.enable_and_verify(panel.display_and_adapterInfo,
                                                           ...
                                                           panel.connector_port_type, configure_avi=False)
                    else:
    ...
    ##
    # @brief test_02_mode switch function - Function to perform quantization and ocsc verification and
    ...
    ##
    # @brief test_03_display switch function - Function to perform apply single config on each display and
