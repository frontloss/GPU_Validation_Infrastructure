#####################################################################################################################################
# @file         glk_verify_register_programming.py
# @brief        Verifies Register Programming for GLK Platform
# @details      ref: glk_verify_register_programming.py \n
...
##
# @brief        GlkVerifyRegisterProgramming Class
class GlkVerifyRegisterProgramming:
    ddi_select_map = dict([
        (0b000, 'None'),
        (0b001, 'B'),
        (0b010, 'C'),
...
if __name__ == "__main__":
    ...
    result, return_params = GlkVerifyRegisterProgramming(test_parameters,
