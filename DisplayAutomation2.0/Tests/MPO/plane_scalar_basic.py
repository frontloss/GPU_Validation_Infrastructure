...
##
# @brief    Contains function to verify if the scalar is enabled during scaling of plane
class PlaneScalarBasic(mpo_base.MPOBase):
    display = None

    ##
    # @brief            To verify scalar
    # @param[in]        display
    # @param[in]        ps_ctl_reg; register name
    # @return           void
    ...
    def perform_flip(self, pplanes):
        ...
        if checkmpo_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
            ...
            if ssa_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
                ...
                self.mpo_helper_dft.verify_planes(self.display, "PLANE_CTL_1", "source_pixel_format_RGB_8888",
                                   "tiled_surface_TILE_Y_LEGACY_MEMORY")
                self.mpo_helper_dft.verify_planes(self.display, "PLANE_CTL_2", "source_pixel_format_RGB_8888",
                                   "tiled_surface_TILE_Y_LEGACY_MEMORY")
                self.mpo_helper_dft.verify_planes(self.display, "PLANE_CTL_3", "source_pixel_format_RGB_8888",
                                   "tiled_surface_TILE_Y_LEGACY_MEMORY")
                ...
                if (pplanes.stPlaneInfo[1].stMPOSrcRect.lRight != pplanes.stPlaneInfo[
                    ...
                    self.verify_scalar(self.display, "PS_CTRL_1")
                ...
                if (pplanes.stPlaneInfo[2].stMPOSrcRect.lRight != pplanes.stPlaneInfo[
                    ...
                    self.verify_scalar(self.display, "PS_CTRL_2")

                ##
                # Check for underrun
                self.mpo_helper_dft.verify_underrun()
