########################################################################################################################
# @file         mpo_3d_apps_media_youtube_resize_p016.py
...
#               * Submit flips with 3 planes where 2 planes are of P016 format and 1 plane is of RGB format.
#                 RGB format represents the desktop, P016 represents media content and youtube playback.
...
class MPO3DAppsMediaYoutubeResizeP016(mpo_base.MPOBase):
    display = None
    ...
    def perform_flip(self, pplanes):
        ...
        if checkmpo_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
            ...
            if ssa_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
                ...
                logging.info(
                    self.mpo_helper_dft.getStepInfo() + 'Performed flip of 3 planes: P016_YUV_420_16_BIT, P016_YUV_420_16_BIT, RGB_8888')
                ##
                ...
                if not plane1_result or not plane2_result or not plane3_result:
                    gdhm.report_bug(
                        title="[MPO][Plane scaling]Plane verification failed: P016_YUV_420_16_BIT, P016_YUV_420_16_BIT, RGB_8888",
                        problem_classification=gdhm.ProblemClassification.FUNCTIONALITY,
                        component=gdhm.Component.Driver.DISPLAY_OS_FEATURES,
                        priority=gdhm.Priority.P2,
                        exposure=gdhm.Exposure.E2
                    )
                    self.fail('Plane verification failed: P016_YUV_420_16_BIT, P016_YUV_420_16_BIT, RGB_8888')
