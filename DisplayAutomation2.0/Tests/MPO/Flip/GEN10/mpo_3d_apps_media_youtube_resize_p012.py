########################################################################################################################
# @file         mpo_3d_apps_media_youtube_resize_p012.py
...
#               * Submit flips with 3 planes where 2 planes are of P012 format and 1 plane is of RGB format.
...
class MPO3DAppsMediaYoutubeResizeP012(mpo_base.MPOBase):
    display = None
