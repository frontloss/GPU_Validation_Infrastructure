########################################################################################################################
# @file         mpo_plane_format_media_resize_p016.py
# @brief        Basic test to verify underruns during resize of plane in P016 YUV format.
#               * Apply Single display configuration across all the displays.
#               * Submit flips with 2 planes where 1 plane is of P016 format and 1 plane is of RGB format.
...
##
# @brief    Contains function to check underruns during resize of plane in P016 YUV format
class MPOPlaneFormatMediaResizeP016(mpo_base.MPOBase):
    display = None
