########################################################################################################################
# @file         mpo_3d_apps_media_resize_p010.py
...
#               * Submit flips with 3 planes where 2 planes are of RGB format and 1 plane is of P010 format.
...
class MPO3DAppsMediaResizeP010(mpo_base.MPOBase):
    display = None
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: Flips plane in P010 YUV format and checks for underrun")
