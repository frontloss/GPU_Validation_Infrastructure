########################################################################################################################
# @file         mpo_media_youtube_snapmode_p010.py
# @brief        Basic test to verify underruns during resize of 2 P010 YUV planes in snapmode.
#               * Apply Single display configuration across all the displays.
#               * Submit flips with 3 planes where 2 planes are of P010 format and 1 plane is of RGB format in snapmode.
...
##
# @brief    Contains function to check underruns during resize of 2 P010 YUV planes in snapmode
class MPOMediaYoutubeSnapModeP010(mpo_base.MPOBase):
    display = None
