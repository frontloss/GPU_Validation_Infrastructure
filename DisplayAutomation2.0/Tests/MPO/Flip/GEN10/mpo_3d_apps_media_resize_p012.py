########################################################################################################################
# @file         mpo_3d_apps_media_resize_p012.py
...
#               * Submit flips with 3 planes where 2 planes are of RGB format and 1 plane is of P012 format.
...
class MPO3DAppsMediaResizeP012(mpo_base.MPOBase):
    display = None
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: Flips plane in P012 YUV format and checks for underrun")
