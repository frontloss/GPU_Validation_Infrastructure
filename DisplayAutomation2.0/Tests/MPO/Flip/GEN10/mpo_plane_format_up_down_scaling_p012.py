########################################################################################################################
# @file         mpo_plane_format_up_down_scaling_p012.py
# @brief        Basic test to verify scaling of planes.
#               * Apply Single display configuration across all the displays.
#               * Submit 2 flips, where 1 plane is of P012 format and another with RGB format.
...
##
# @brief    Contains function to check up down scaling of plane in in P012 YUV format
class MPOPlaneFormatUpDownScalingP012(mpo_base.MPOBase):
    display = None
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: Flips RGB and P012 YUV planes and checks for underrun"
