########################################################################################################################
# @file         mpo_plane_format_media_youtube_resize_p016.py
...
#               * Submit 2 flips, where 1 plane is of P016 format and another with YUV 422 with 8 BPC.
#                 P016 format and YUV 422 format represents media content.
...
class MPOPlaneFormatMediaYouTubeResizeP016(mpo_base.MPOBase):
    display = None
    ...
    def perform_flip(self, pplanes):
        ...
        if checkmpo_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
            ...
            if ssa_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
                ...
                logging.info(
                    self.mpo_helper_dft.getStepInfo() + 'Performed flip of 2 planes: P016_YUV_420_16_BIT, YUV_422_PACKED_8_BPC')
                ##
                ...
                if not plane1_result or not plane2_result:
                    gdhm.report_bug(
                        title="[MPO][Plane scaling]Plane verification failed: P016_YUV_420_16_BIT, YUV_422_PACKED_8_BPC",
                        problem_classification=gdhm.ProblemClassification.FUNCTIONALITY,
                        component=gdhm.Component.Driver.DISPLAY_OS_FEATURES,
                        priority=gdhm.Priority.P2,
                        exposure=gdhm.Exposure.E2
                    )
                    self.fail('Plane verification failed: P016_YUV_420_16_BIT, YUV_422_PACKED_8_BPC')
