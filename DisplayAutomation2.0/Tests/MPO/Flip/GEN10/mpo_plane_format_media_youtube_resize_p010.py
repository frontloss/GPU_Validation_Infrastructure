########################################################################################################################
# @file         mpo_plane_format_media_youtube_resize_p010.py
...
#               * Submit flips with 2 planes where 2 planes are of P010 format.
#                 P010 format represents media content.
...
class MPOPlaneFormatMediaYouTubeResizeP010(mpo_base.MPOBase):
    display = None
    ...
    def perform_flip(self, pplanes):
        ...
        if checkmpo_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
            ...
            if ssa_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
                ...
                logging.info(
                    self.mpo_helper_dft.getStepInfo() + 'Performed flip of 2 planes: P010_YUV_420_10_BIT, P010_YUV_420_10_BIT')
                ##
                ...
                if not plane1_result or not plane2_result:
                    gdhm.report_bug(
                        title="[MPO][Plane scaling]Plane verification failed: P010_YUV_420_10_BIT, P010_YUV_420_10_BIT",
                        problem_classification=gdhm.ProblemClassification.FUNCTIONALITY,
                        component=gdhm.Component.Driver.DISPLAY_OS_FEATURES,
                        priority=gdhm.Priority.P2,
                        exposure=gdhm.Exposure.E2
                    )
                    self.fail('Plane verification failed: P010_YUV_420_10_BIT, P010_YUV_420_10_BIT')
    ...
    def runTest(self):
        ...
        for display_index in range(len(self.connected_list)):
            if self.config.set_display_configuration_ex(topology, [self.connected_list[display_index]]) is True:
                ...
                plane1 = flip.PLANE_INFO(0, 0, 1, flip.PIXEL_FORMAT.PIXEL_FORMAT_P010YUV420,
