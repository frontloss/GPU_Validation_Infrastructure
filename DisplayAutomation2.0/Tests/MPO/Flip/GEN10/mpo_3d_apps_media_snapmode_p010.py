########################################################################################################################
# @file         mpo_3d_apps_media_snapmode_p010.py
...
class MPO3DAppsMediaSnapModeP010(mpo_base.MPOBase):
    display = None
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: Flips 2 RGB and 1 P010 YUV planes and checks for flicker/ corruption"
