########################################################################################################################
# @file         mpo_3d_apps_media_resize_p016.py
...
#               * Submit flips with 3 planes where 2 planes are of RGB format and 1 plane is of P016 format.
...
class MPO3DAppsMediaResizeP016(mpo_base.MPOBase):
    display = None
    ...
    def runTest(self):
        ...
        for display_index in range(len(self.connected_list)):
            if self.config.set_display_configuration_ex(topology, [self.connected_list[display_index]]) is True:
                ...
                rect3 = flip.MPO_RECT(0, 0, resolution.HzRes // 2, resolution.VtRes // 2)
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: Flips planes in P016 YUV format and checks for underrun")
