...
#               * Submit flips with 3 planes where 2 planes are of RGB format and 1 plane is of YUV_422 format in snapmode.
...
##
# @brief    Contains function to check for underruns during resize of 1 RGB and 1 YUV planes in snapmode
