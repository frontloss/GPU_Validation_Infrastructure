...
#               * Submit flips with 3 planes where 2 planes are of YUV_422 format and 1 plane is of RGB format.
#                 RGB format represents the desktop, YUV422 format represents media content and youtube playback.
...
if __name__ == '__main__':
    ...
    logging.info(
        'Test purpose: Flips YUV_422_PACKED_8_BPC and RGB resized planes and  checks for watermark/underrun errors')
