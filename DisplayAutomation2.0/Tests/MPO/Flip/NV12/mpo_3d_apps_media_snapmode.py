########################################################################################################################
# @file         mpo_3d_apps_media_snapmode.py
...
class MPO3DAppsMediaSnapMode(mpo_base.MPOBase):
    display = None
...
if __name__ == '__main__':
    ...
    logging.info(
        'Test purpose: Flips NV12_YUV_420 and RGB planes in snap mode checks for flickr/corruption with plane resize')
