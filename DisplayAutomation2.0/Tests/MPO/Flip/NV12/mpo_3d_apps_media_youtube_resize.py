########################################################################################################################
# @file         mpo_3d_apps_media_youtube_resize.py
...
#               * Submit flips with 3 planes where 2 planes are of NV12 format and 1 plane is of RGB format.
...
class MPO3DAppsMediaYoutubeResize(mpo_base.MPOBase):
    display = None
