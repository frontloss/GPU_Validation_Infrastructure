...
##
# @brief    Contains function to check scaling of planes
...
if __name__ == '__main__':
    ...
    logging.info('Test purpose: Flips NV12_YUV_420 and RGB planes with different resolution and tile formats')
