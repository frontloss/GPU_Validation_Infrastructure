...
#               * Submit flips with 2 planes where 1 plane is of NV12 format and another one is of RGB.
...
##
# @brief    Contains function to check up down scaling of plane in in NV12 format
        ...
        if checkmpo_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
            ...
            if ssa_result == flip.PLANES_ERROR_CODE.PLANES_SUCCESS:
                ...
                if not plane1_result or not plane2_result:
                    gdhm.report_bug(
                        title="[MPO][Plane scaling]Plane verification failed: NV12_YUV_420, RGB_8888",
                        problem_classification=gdhm.ProblemClassification.FUNCTIONALITY,
                        component=gdhm.Component.Driver.DISPLAY_OS_FEATURES,
                        priority=gdhm.Priority.P2,
                        exposure=gdhm.Exposure.E2
                    )
                    self.fail('Plane verification failed: NV12_YUV_420, RGB_8888')
...
if __name__ == '__main__':
    ...
    logging.info('Test purpose: Flips NV12_YUV_420 and RGB planes with different scaling parameters')
