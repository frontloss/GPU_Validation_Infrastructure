########################################################################################################################
# @file         wm.py
# @brief        This script contains functions to check watermark
...
class Watermark(object):
    ...
    ##
    # @brief            Function to read the register details from file and copy it to a dict (regname,offset)
    # @return           dictionary
    ...
    ##
    # @brief            Function to read the bitmaps details from file and copy it to a dict
    # @return           dictionary
    ...
    ##
    # @brief            To get first set bit position
    # @param[in]        n
    # @return           ret
    ...
    ##
    # @brief            To compare register value
    # @param[in]        regValue
    # @param[in]        expectedValue
    # @param[in]        bitmap
    # @return           True/ False and Value
    ...
    ##
    # @brief            To get linetime reg value
    # @param[in]        baseRegister
    # @param[in]        pipeID
    # @param[in]        bitMaps
    # @return           val
    ...
    ##
    # @brief            To get cursor WM reg value
    # @param[in]        baseRegister
    # @param[in]        pipeID
    # @param[in]        wmLevel
    # @param[in]        bitMaps
    ...
    ##
    # @brief            To get display inforamtion
    # @return           None
    ...
    ##
    # @brief            To get BPP from PixelFormat
    ...
    ##
    # @brief            To get cursor BPP from mode
    # @param[in]        mode
    # @return           bpp
    ...
    ##
    # @brief            To get cursor size from mode
    # @param[in]        mode
    # @return           size
    ...
    ##
    # @brief            To get Y plane mapping for planar formats
    # @param[in]        pipeID
    # @param[in]        planeID
    # @return           YPlaneID
    ...
    ##
    # @brief            To verify Min DBUF Requirement
    # @param[in]        pipeID
    # @param[in]        planeID
    # @return           empty
    ...
    ##
    # @brief            To fill csv input for cursor
    # @param[in]        pipeID
    # @return           csv file
    ...
    ##
    # @brief            To fill csv output for cursor
    # @param[in]        pipeID
    # @return           None
    ...
    ##
    # @brief            To compare WM values with Golden Data
    # @return           None
