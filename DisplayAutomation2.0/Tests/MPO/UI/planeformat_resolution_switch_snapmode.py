########################################################################################################################
# @file         planeformat_resolution_switch_snapmode.py
# @brief        Basic test to verify lane format getting enabled with no corruption on video app during mode change
...
##
# @brief    Contains function to check lane format getting enabled with no corruption on video app during mode change
class PlaneFormatResolutionSwitchSnapmode(mpo_ui_base.MPOUIBase):
