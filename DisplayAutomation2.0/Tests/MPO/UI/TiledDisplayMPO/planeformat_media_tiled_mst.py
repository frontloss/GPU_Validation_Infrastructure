########################################################################################################################
# @file         planeformat_media_tiled_mst.py
# @brief        Basic test to verify register programming and also check for underrun during basic video playback on
#               Tiled display.
...
##
# @brief    Contains function to check register programming and underrun during basic video playback on Tiled display
class PlaneFormatMediaTiledMSTBase(mpo_ui_tiled_mst_base.MPOUITiledMSTBase):
    ...
    def runTest(self):
        ...
        if not self.mpo_helper.verify_planes_mst(pixel_format, 'PLANE_CTL_1'):
            ...
            logging.info("Plane verification passed during fullscreen video playback on Tiled display")
...
if __name__ == '__main__':
    ...
    logging.info("Test purpose: To verify for register programming and also check for underrun"
                 "during basic video playback on Tiled Display")
