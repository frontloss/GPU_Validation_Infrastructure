########################################################################################################################
# @file         collage_config_switching.py
# @brief        To switch the configuration between collage and non collage.
#
...
##
# @brief        This class contains runTest function to perform collage config switching for legacy platforms
class CollageConfigSwitch(DisplayCollageBase):
    ...
    def runTest(self) -> None:
        ...
        # Function call to switch Single Display(any one of collage display)
        ...
        # Function call to apply collage mode with list of supported configurations
        self.apply_collage_mode(supported_config)
