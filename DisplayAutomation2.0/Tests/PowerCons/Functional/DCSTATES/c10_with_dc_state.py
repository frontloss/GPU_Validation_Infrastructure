...
class TestC10WithDcState(DCStatesBase):
    ...
    def t_11_state_dc6_c10(self):
        for adapter in dut.adapters.values():
            if etl_tracer.start_etl_tracer() is False:
                ...
                return False
            # Due to stability issues , PC10 is taking ~15 mins
            # Temporary WA - https://jira.devtools.intel.com/browse/VSDI-36917
            log_file = socwatch.run_workload("IDLE", duration=60)
    ...
    def t_13_state_dc6v_c10(self):
        for adapter in dut.adapters.values():
            ...
            # Due to stability issues , PC10 is taking ~15 mins
            # Temporary WA - https://jira.devtools.intel.com/browse/VSDI-36917
            log_file = socwatch.run_workload("VIDEO", duration=60)
