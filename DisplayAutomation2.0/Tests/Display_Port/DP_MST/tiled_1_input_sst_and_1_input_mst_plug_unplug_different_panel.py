################################################################################################################
# @file          tiled_1_input_sst_and_1_input_mst_plug_unplug_different_panel.py
...
class DPMSTTiledOneInputSSTOneInputMSTHotplugUnplugDifferentPanel(DisplayPortMSTBase):
    ...
    def runTest(self):
        ...
        # Slave port_type is being plugged in and panel is DP MST panel
        ...
        # Initialize DP object, parse/send topology and issue HPD to driver with the configuration passed by the user
        # Slave port_type is being plugged in with different DP MST panel
        ...
        if is_tiled_display:
            ...
            logging.error("[Test Issue]: Tiled display not found! Exiting....")
            gdhm.report_bug(
                title="[Interfaces][DP_MST] Verification of tiled display failed",
                problem_classification=gdhm.ProblemClassification.OTHER,
                component=gdhm.Component.Driver.DISPLAY_INTERFACES,
