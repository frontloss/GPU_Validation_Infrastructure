################################################################################################################
# @file          mst_to_sst_to_mst_switching_full_topology.py
# @brief         Verify whether topology switched properly from MST to SST.
...
##
# @brief        This class contains runTest() method that performs full topology switch from MST to SST and back to MST
#               and verifies topology applied
class DPMSTtoSSTtoMSTSwitching(DisplayPortMSTBase):

    ##
    # @brief        This method executes the actual test steps.Test commands are designed such a way that 1st topology
    ...
    #               line and verifies it.After verification SST topology is unplugged and MST topology is plugged back
    #               and verified
    # @return       None
    def runTest(self):
