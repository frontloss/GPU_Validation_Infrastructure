...
# 		        b. After getting the base address, adding each offset from the clone_mmio_offsets.json to the base
...
##
# @brief        Change the last bit of 10h offest to '0', add each offset from the single_mmio_offsets.json to the base
#               address and generate a mmio_dump_commands_nsh.nsh file
...
def add_base_offset_generate_mmio_commands_dump(tenh_offset_file):
    ...
    try:
        with open('clone_mmio_offsets.json', 'r') as offsetsjson:
