########################################################################################################################
# @file         single_pipe_pipe_verification.py
...
#               verification results. The Verification results are dumped into single_Pipe_Verification.log file.
...
logging.basicConfig(
    ...
    filename='single_pipe_pipe_verification.log',
    filemode='w'
    )
...
def to_verify_actual_and_expected_pipe(final_required_json):
    ...
    for ofst in mmio_dump_data:
        ...
        if ofst['MMIO Offset'] in ['0x68180']:
        ...
        elif ofst['MMIO Offset'] in ['0x68174']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x68170']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
        ...
        elif ofst['MMIO Offset'] in ['0x6001C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x70030']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x45270']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
        ...
        elif ofst['MMIO Offset'] in ['0x7003C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x44404']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x70038']:
            if ofst['Expected Output'] is not None:
                logging.info(f'-----Verifying {ofst["Function Name"]} -----')
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
