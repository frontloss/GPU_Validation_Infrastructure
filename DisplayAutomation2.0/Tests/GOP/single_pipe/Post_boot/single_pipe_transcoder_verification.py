########################################################################################################################
# @file         single_pipe_transcoder_verification.py
...
#               verification results. The Verification results are dumped into single_Pipe_Transcoder_Verification.log
#               file.
...
logging.basicConfig(
    ...
    filename='single_transcoder_verification.log',
    filemode='w'
    )
...
def to_verify_actual_and_expected_plane(final_required_json):
    ...
    for ofst in mmio_dump_data:
        ...
        if ofst['MMIO Offset'] in ['0x60400']:
            ...
            if ofst['Expected Output'] is not None:
                ...
                if actual_mmio_value[0] == '1':
                    logging.info(logger_template_pass.format(res="PASS",
                                                             ofst="{} - TRANS_DDI_FUNC_"
                                                                  "CTL".format(ofst['MMIO Offset']),
        ...
        if ofst['MMIO Offset'] in ['0x46140']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x70008']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60040']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
        ...
        if ofst['MMIO Offset'] in ['0x6F040']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        if ofst['MMIO Offset'] in ['0x60044']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        # Verify offset 0x6F044
        if ofst['MMIO Offset'] in ['0x6F044']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        if ofst['MMIO Offset'] in ['0x60000']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6F000']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60004']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6F004']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60008']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        # Verify offset 0x6F008
        if ofst['MMIO Offset'] in ['0x6F008']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6000C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6F00C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60010']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6F010']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60014']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x6F014']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x60540']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x46070']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x46008']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0x46000']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0xC4030']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        if ofst['MMIO Offset'] in ['0xC4000']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
