########################################################################################################################
# @file         single_pipe_plane_verification.py
...
#               verification results. The Verification results are dumped into single_Pipe_Plane_Verification.log file.
...
logging.basicConfig(
    ...
    filename='single_plane_verification.log',
    filemode='w'
    )
...
def to_verify_actual_and_expected_plane(final_required_json):
    ...
    for ofst in mmio_dump_data:
        ...
        if ofst['MMIO Offset'] in ['0x7019C']:
        ...
        elif ofst['MMIO Offset'] in ['0x70240']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70244']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70248']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x7024C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70250']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70254']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70258']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
        ...
        elif ofst['MMIO Offset'] in ['0x70180']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
        ...
        elif ofst['MMIO Offset'] in ['0x70190']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            if ofst['Expected Output'] is not None:
                actual_mmio_value = convert_hex_to_32bit_binary(ofst['Expected Output'])
        ...
        elif ofst['MMIO Offset'] in ['0x7027C']:
            logging.info(f'-----Verifying {ofst["Function Name"]} -----')
            # WM need some extra calculation. So just dumping the value.
            logging.info(logger_template_dump.format(res="DUMP", ofst="{} - {}".format(ofst['MMIO Offset'],
                                                                                       ofst["Function Name"]),
