...
# @brief        Using the generated MMIO_raw_dump.txt and single_mmio_offsets.json files, map the MMIO values with
...
map_mmio_values_and_offsets_into_json('mmio_raw_dump.txt', 'single_mmio_offsets.json')
