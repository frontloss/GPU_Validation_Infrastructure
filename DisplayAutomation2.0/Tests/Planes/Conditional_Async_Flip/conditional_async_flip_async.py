########################################################################################################################
# @file         conditional_async_flip_async.py
# @brief        Conditional async with maximmediateflipline above current scanline
...
##
# @brief    Contains function to check Conditional async with maximmediateflipline above current scanline.
class ConditionalAsyncFlip(ConditionalAsyncBase):
    ...
    def runTest(self):
        ...
        for index in range(0, self.no_of_displays):
            ...
            plane1 = flip.PLANE_INFO(self.source_id[index], plane1_layer, 1, self.pixel_format[0], self.tile_format[0], rect,
                         ...
                         self.color_space[0], ulmax_immediate_flipLine=self.current_mode.VtRes - 50)
...
if __name__ == '__main__':
    ...
    logging.info("Test Purpose: To check Conditional async with maximmediateflipline above current scanline")
