########################################################################################################################
# @file         hw_accuracy_tm_lut_4000_to_1400_tonemap_with_coeffchange.py
...
class Test_HWAccuracy_TMLUT(HDRBase):
    ...
    def runTest(self):
        ...
        if self.perform_flip_hwaccuracy(planes):
            ...
            # 0.625 * 2^9 -->140h
            # 0.125 * 2^9 -->40h
            self.driver_interface_.mmio_write(0x6830C, 0x08050040, 'gfx_0')
            self.driver_interface_.mmio_write(0x68B0C, 0x08050040, 'gfx_0')
