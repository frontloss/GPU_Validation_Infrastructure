########################################################################################################################
# @file         ss_multipipe_singleplane_async_flips.py
# @brief        This script contains test to generate async flips on multiple pipes and check if Smooth Sync is getting
#               enabled or not.
...
##
# @brief  Contains function to generate async flips on multiple pipes and check if Smooth Sync is getting enabled or not
...
if __name__ == '__main__':
    ...
    logging.info('Test purpose: Flips a single async plane on multiple displays and checks for Smooth Sync')
