########################################################################################################################
# @file         mpo_two_planes_scaling_tiling_sst_tiled.py
# @brief        Basic test to flip two planes of specified formats on tiled display and perform plane scaling and tile
...
##
# @brief    Contains function to flip two planes of specified formats on tiled display,perform plane scaling and tile switch
class MPOTwoPlanesScalingTilingSSTTiled(mpo_tiled_sst_base.MPOTiledBaseSST):
