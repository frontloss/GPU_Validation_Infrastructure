########################################################################################################################
# @file         mpo_two_planes_resize_sst_tiled.py
# @brief        Basic test to flip two planes of specified formats on tiled display and perform plane resize. Test
...
##
# @brief    Contains function to flip two planes of specified formats on tiled display and perform plane resize
class MPOTwoPlanesResizeSSTTiled(mpo_tiled_sst_base.MPOTiledBaseSST):
