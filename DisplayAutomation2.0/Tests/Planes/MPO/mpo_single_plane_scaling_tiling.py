########################################################################################################################
# @file         mpo_single_plane_scaling_tiling.py
# @brief        To flip single plane of specified formats on single or multiple displays and perform plane scaling and
#               tile switching. Test verifies plane programming and also checks for underrun.
...
##
# @brief    Contains function to flip single plane of specified formats, perform plane scaling and tile switching
class MPOSinglePlaneScalingTiling(MPOBase):
...
if __name__ == '__main__':
    ...
    logging.info("Test Purpose: To flip single plane of specified formats on single or multiple displays and perform "
                 "plane scaling and tile switching. Test verifies plane programming and also checks for underrun")
