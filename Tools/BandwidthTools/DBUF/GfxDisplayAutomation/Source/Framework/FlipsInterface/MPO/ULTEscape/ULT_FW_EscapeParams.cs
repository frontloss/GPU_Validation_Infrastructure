...
namespace Intel.VPG.Display.FlickerTestSuite
{
    ...
    //Rource management
    // There is 1:1 maping between ULT_PIXELFORMAT and SB_PIXELFORMAT. Any change in SB_PIXELFORMAT should be updated here also.
    public enum ULT_SRC_PIXEL_FORMATS
    {
        ULT_PIXEL_FORMAT_UNINITIALIZED = 0,
        ULT_PIXEL_FORMAT_8BPP_INDEXED,        // for 8bpp
        ULT_PIXEL_FORMAT_B5G6R5X0,            // for 16bpp   
        ULT_PIXEL_FORMAT_B8G8R8X8,            // for 32bpp (default)
        ULT_PIXEL_FORMAT_B8G8R8A8,
        ULT_PIXEL_FORMAT_R8G8B8X8,
        ULT_PIXEL_FORMAT_R8G8B8A8,
        ULT_PIXEL_FORMAT_R10G10B10X2,         // for 32bpp 10bpc
        ULT_PIXEL_FORMAT_R10G10B10A2,         // for 32bpp 10bpc
        ULT_PIXEL_FORMAT_B10G10R10X2,         // for 32bpp 10bpc
        ULT_PIXEL_FORMAT_B10G10R10A2,         // for 32bpp 10bpc
        ULT_PIXEL_FORMAT_R10G10B10A2_XR_BIAS, // for 32bpp 10bpc, XR BIAS format (used by Win7)
        ULT_PIXEL_FORMAT_R16G16B16X16F,       // for 64bpp, 16bit floating
        ULT_PIXEL_FORMAT_R16G16B16A16F,        
        ULT_PIXEL_FORMAT_NV12YUV420,
        ULT_PIXEL_FORMAT_YUV422,
        ULT_PIXEL_FORMAT_MAX_PIXELFORMAT,
    }


    public enum ULT_TILE_FORMATS : uint
    {        
        ULT_TILE_FORMAT_L = 1, //CUSTOM TILE FORMAT TO REPRESENT LINEAR
        ULT_TILE_FORMAT_W = 2,
        ULT_TILE_FORMAT_X = 4,
        ULT_TILE_FORMAT_Y = 8,
        ULT_TILE_FORMAT_Yf = 16,
        ULT_TILE_FORMAT_Ys = 32
    }
    ...
    public class ULT_CREATE_RES_ARGS
    {
        ...
        public ULT_SRC_PIXEL_FORMATS Format; // Surface format
        [MarshalAs(UnmanagedType.I1)]
        public bool AuxSurf;
...
//        public UInt64 pUserVirtualAddress;
    }
    ...
    public struct ULT_MPO_CHECKMPOSUPPORT_PLANE_INFO
    {
        ...
        public ULT_SRC_PIXEL_FORMATS eSBPixelFormat;
        [MarshalAs(UnmanagedType.I1)]
