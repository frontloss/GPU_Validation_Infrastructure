namespace Intel.VPG.Display.Automation
{
    ...
    internal abstract class PlayerBase
    {
        ...
        internal virtual void Play(Process argProcess)
        {
            ...
            argProcess.StartInfo.Arguments = string.Format("{0}\\{1}", this.AppSettings.OverlayPlayersPath, this.OverlayParams.VideoFile);
        ...
        {
            if (!((int)this.OverlayParams.DisplayHierarchy > 1 && this.OverlayParams.CurrentConfig.ConfigType.GetUnifiedConfig() == DisplayUnifiedConfig.Extended))
            {
        ...
        {
            this.CheckVideoFileExists(string.Format("{0}\\{1}", this.AppSettings.OverlayPlayersPath, this.OverlayParams.VideoFile));
        }
