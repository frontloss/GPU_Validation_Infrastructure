namespace Intel.VPG.Display.Automation
{
    ...
    public class DisplayConfig
    {
        ...
        public int ConfigTypeCount { get { return DisplayExtensions.GetDisplaysCount(this.ConfigType); } }
        ...
        public List<DisplayType> PluggableDisplayList { get; set; }
        public List<DisplayType> PluggedDisplayList { get; set; }
        public DisplaySequence displaySequence { get; set; }
