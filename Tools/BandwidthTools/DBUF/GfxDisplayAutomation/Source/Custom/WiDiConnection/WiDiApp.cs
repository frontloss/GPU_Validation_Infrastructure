...
namespace WiDiConnection
{
    class WiDiApp
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (InitializeAdapter(widiParam, handle))
            {
        ...
        private static void convertWiDiReasonCodetoString(int h, out string s)
        {
        ...
        private static void convertWiDiResulttoString(int h, out string s)
        {
        ...
        private static bool InitializeAdapter(WiDiParam widiParam, IntPtr handle)
        {
            try
            {
        ...
        private static void ScanAdapters(WiDiParam widiParam)
        {
            try
            {
        ...
        private static List<string> FilterAdapterList()
        {
        ...
        private static bool Connect(WiDiParam widiParam, string adapter)
        {
        ...
        private static void WriteXMLData(WiDiParam widiParam)
        {
        ...
        {
            Process[] poc = Process.GetProcessesByName("WiDiConnection");
            if (poc.Length > 1)
            {
                Logger.WriteLog("Killing existing process");
                poc[0].Kill();
            }
        }
