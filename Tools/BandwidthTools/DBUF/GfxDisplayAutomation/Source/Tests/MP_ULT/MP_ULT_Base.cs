namespace Intel.VPG.Display.Automation
{
    ...
    public class MP_ULT_Base : TestBase
    {
        ...
        public bool ULT_FW_Check_MPO(SB_MPO_CHECKMPOSUPPORT_PATH_INFO[] sbMpoCheckMpoSupportPathInfo, uint numPaths, uint config, ref bool supported, ref uint failureReason, ref CHECKMPOSUPPORT_RETURN_INFO checkMpoSupportReturnInfo)
        {
        ...
        public bool ULT_FW_Set_Source_Address_MPO(MPO_FLIP_PLANE_INFO[] mpoFlipPlaneInfo, uint numPlanes, ULT_SETVIDPNSOURCEADDRESS_FLAGS Flag, uint sourceId)
        {
