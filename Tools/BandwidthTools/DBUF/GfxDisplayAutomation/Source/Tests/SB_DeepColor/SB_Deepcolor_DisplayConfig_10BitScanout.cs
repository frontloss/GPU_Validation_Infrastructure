namespace Intel.VPG.Display.Automation
{
    ...
    class SB_Deepcolor_DisplayConfig_10BitScanout : SB_DeepColor_Base
    {
        ...
        public void TestStep2()
        {
            foreach (DisplayType display in base.CurrentConfig.DisplayList)
            {
                ...
                CheckDeepColorconditions(dispInfo, pipePlane, DeepColorAppType.N10BitScanOut, true, CurrentConfig, DisplayHierarchy.Display_1);
            }
        }
        ...
        public void TestStep5()
        {
            foreach (DisplayType display in base.CurrentConfig.DisplayList)
            {
                DisplayInfo dispInfo = CurrentConfig.EnumeratedDisplays.Find(dp => dp.DisplayType == display);
                PipePlaneParams pipePlane = GetPipePlane(dispInfo);
                CheckDeepColorconditions(dispInfo, pipePlane, DeepColorAppType.N10BitScanOut, false, CurrentConfig, DisplayHierarchy.Display_1);
            }
        }
        ...
        {
            CloseApp(DeepColorAppType.N10BitScanOut);
        }
    }
}
