...
namespace Intel.VPG.Display.Automation
{
    ...
    class SB_DP_SST_ModeEnum_HotplugUnplug_Different_Panel_During_S3 : SB_DP_SST_Base
    {
        ...
        public void ModeEnum_HotplugUnplug_DifferentPanels_S3_TwoDisplays()
        {
            ...
            base.doHotplug(Secondary,  true, PowerStates.S3, _defaultEDIDMap[Secondary]);
            ...
            // Unplug DFT display1 and plug display2 when System is in S3
            doHotUnPlugPlug(Secondary, _changeEdid[Secondary], true, PowerStates.S3);
        ...
        public virtual void ModeEnum_HotplugUnplug_DifferentPanels_S3_ThreeDisplays()
        {
            ...
            if (base.CurrentConfig.TertiaryDisplay != DisplayType.None)
            {
                ...
                // Hotplug external display (DP/HDMI) and verify DPCD register value for the DP display
                base.doHotplug(TertiaryDisplay,  true, PowerStates.S3, _defaultEDIDMap[TertiaryDisplay]);
                ...
                // Unplug DFT display1 and plug display2 when System is in S3
                doHotUnPlugPlug(TertiaryDisplay, _changeEdid[TertiaryDisplay], true, PowerStates.S3);
