...
{
    /*
     This testcase check whether Displays attached to system remain connected after connected stand by state
     */
    [Test(Type = TestType.HasPlugUnPlug)]
    class SB_DP_SST_CS : SB_DP_SST_Base
    {
        ...
        public void doHotPlug()
        {
            ...
            {
                Log.Message("Current config doesn't contain tertiary display");
            }
        }

        // Put system into connected stand by mode
        ...
        public void verifyDPCD()
        {
            if (base.CurrentConfig.SecondaryDisplay != DisplayType.None)
            {
                ...
                {
                    Log.Message("DP as Secondary Display not connected post CS");
                }
            }
            else
            {
            ...
            if (base.CurrentConfig.TertiaryDisplay != DisplayType.None)
            {
                ...
                {
                    Log.Alert("DP as Tertiary Display not connected post CS");
                }
            }
            else
            {
                Log.Message("Tertiary Display not connected");
            }
        }
        ...
        public void verifyInOSPage()
        {
            ...
            {
                Log.Message("All Displays are connected post CS");
            }
            else
            {
                Log.Fail("all displays before CS are not same as all displays after CS");
            }
        }
    }
}
