...
{
    /*
     Check whether Hotplug unplug functionality is working correctly post CS
    */
    [Test(Type = TestType.HasPlugUnPlug)]
    class SB_DP_SST_Hotplug_Unplug_After_CS : SB_DP_SST_Base
    {
        int delay = 15;
        ...
        public void putInCS()
        {
            ...
            Log.Message("Putting System into CS");
            //Put system into CS state by invoking power event
            base.InvokePowerEvent(_powerParams, PowerStates.CS);
        }
