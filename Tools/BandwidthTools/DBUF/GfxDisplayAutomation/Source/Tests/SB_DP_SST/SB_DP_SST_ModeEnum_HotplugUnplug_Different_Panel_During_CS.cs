...
namespace Intel.VPG.Display.Automation
{
    ...
    class SB_DP_SST_ModeEnum_HotplugUnplug_Different_Panel_During_CS : SB_DP_SST_Base
    {
        ...
        public void ModeEnum_HotplugUnplug_DifferentPanels_CS_TwoDisplays()
        {
            ...
            base.doHotplug(Secondary, true, PowerStates.CS, _defaultEDIDMap[Secondary]);
            ...
            // Unplug DFT display1 and plug display2 when System is in CS   
            doHotUnPlugPlug(Secondary, _changeEdid[Secondary], true, PowerStates.CS);
        ...
        public virtual void ModeEnum_HotplugUnplug_DifferentPanels_CS_ThreeDisplays()
        {
            ...
            if (base.CurrentConfig.TertiaryDisplay != DisplayType.None)
            {
                ...
                // Hotplug external display (DP/HDMI) and verify DPCD register value for the DP display
                base.doHotplug(TertiaryDisplay,  true, PowerStates.CS, _defaultEDIDMap[TertiaryDisplay]);
                ...
                // Unplug DFT display1 and plug display2 when System is in CS   
                doHotUnPlugPlug(TertiaryDisplay, _changeEdid[TertiaryDisplay], true, PowerStates.CS);
