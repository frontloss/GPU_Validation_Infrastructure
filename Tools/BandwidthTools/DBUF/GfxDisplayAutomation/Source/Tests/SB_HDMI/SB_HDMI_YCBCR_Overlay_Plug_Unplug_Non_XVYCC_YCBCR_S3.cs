namespace Intel.VPG.Display.Automation
{
    ...
    class SB_HDMI_YCBCR_Overlay_Plug_Unplug_Non_XVYCC_YCBCR_S3 : SB_HDMI_YCBCR_Overlay_Basic
    {
        protected PowerStates powerState;
        private string edidFileAfterPanelChange = "HDMI_3011_xvycc_Remove_RGB.EDID";
        public SB_HDMI_YCBCR_Overlay_Plug_Unplug_Non_XVYCC_YCBCR_S3() 
            : base()
        {
        ...
        public SB_HDMI_YCBCR_Overlay_Plug_Unplug_Non_XVYCC_YCBCR_S3(PowerStates argPowerState)
            : this()
        {
        ...
        private void ActionAfterEnable()
        {
            ...
            if (displayInfo.ColorInfo.IsYcBcr)
            {
                ...
                Log.Message(true, "Scenario: Plug back the original panel");
                Log.Verbose("Unplug {0} panel on display {0}", _colorType, displayInfo.DisplayType);
