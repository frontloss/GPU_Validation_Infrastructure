namespace Intel.VPG.Display.Automation
{
    ...
    class SB_HDMI_YCBCR_Plug_Unplug_Non_XVYCC_YCBCR_S3 : SB_HDMI_YCBCR_Basic
    {
        private string edidFileAfterPanelChange = "HDMI_3011_xvycc_Remove_RGB.EDID";
        private PowerStates powerState;
        public SB_HDMI_YCBCR_Plug_Unplug_Non_XVYCC_YCBCR_S3()
            : base()
        {
        ...
        public SB_HDMI_YCBCR_Plug_Unplug_Non_XVYCC_YCBCR_S3(PowerStates argPowerState)
            : this()
        {
        ...
        private void ActionAfterEnable()
        {
            ...
            {
                Log.Verbose("Unplug {0} panel on display {0} in Low power state.", _colorType, displayInfo.DisplayType);
