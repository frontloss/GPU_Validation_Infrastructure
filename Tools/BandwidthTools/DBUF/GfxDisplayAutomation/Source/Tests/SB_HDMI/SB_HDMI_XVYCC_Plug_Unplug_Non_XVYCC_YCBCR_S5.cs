namespace Intel.VPG.Display.Automation
{
    ...
    class SB_HDMI_XVYCC_Plug_Unplug_Non_XVYCC_YCBCR_S5 : SB_HDMI_XVYCC_Plug_Unplug_YCBCR_S5
    {
        private new string edidFileAfterS5 = "HDMI_3011_xvycc_Remove_RGB.EDID";
        ...
        public override void TestStep4()
        {
            ...
            foreach (DisplayType display in base.CurrentConfig.DisplayList)
            {
                ...
                if (displayInfo.DvmuPort != DVMU_PORT.None)
                {
                    ...
                    base.RegisterCheck(displayInfo.DisplayType, displayInfo, dh, nonHDMIPanelEvent);
                }
            }
            read.Close();
        }
