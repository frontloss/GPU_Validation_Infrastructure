namespace Intel.VPG.Display.Automation
{
    ...
    class MP_CI_ACPI_HK_DisplaySwitch_Default : TestBase
    {
        ...
        public void TestPostCondition()
        {
            ...
            AccessInterface.SetFeature<bool, DisplayConfig>(Features.Config, Action.SetMethod, displayConfigObj);
        }
        ...
        private void PerformTest(string argPlatform, string argKey)
        {
            ...
            if (this._acpiToggle.ContainsKey(argKey))
            {
                toggleSequence = this._acpiToggle[argKey];
