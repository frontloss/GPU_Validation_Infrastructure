namespace Intel.VPG.Display.Automation
{
    ...
    public class MP_Chronometer_MonitorTurnOn : MP_ChronometerBase
    {
        ...
        public MP_Chronometer_MonitorTurnOn()
        {
            _logfilePath = "EVENT_MONITOR_TURN_ON";
            cParam = new ChronometerParams();
            cParam.eventNameProfiling = EVENT_NAME_PROFILING.EVENT_MONITOR_TURN_ON;
