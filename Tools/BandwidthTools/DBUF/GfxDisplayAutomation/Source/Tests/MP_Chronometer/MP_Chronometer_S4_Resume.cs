namespace Intel.VPG.Display.Automation
{
    ...
    public class MP_Chronometer_S4_Resume: MP_Chronometer_S3_Resume
    {
        ...
        public MP_Chronometer_S4_Resume()
        {
            cParam = new ChronometerParams();
            cParam.eventNameProfiling = EVENT_NAME_PROFILING.EVENT_RESUME_FROM_HIBERNATION;
            IsResumeTimeTest = true;
            _logfilePath = "EVENT_RESUME_FROM_HIBERNATION";
