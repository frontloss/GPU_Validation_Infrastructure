namespace Intel.VPG.Display.Automation
{
    ...
    public class MP_Chronometer_S3_Enter: MP_ChronometerBase
    {
        ...
        public MP_Chronometer_S3_Enter()
        {
            cParam = new ChronometerParams();
            cParam.eventNameProfiling = EVENT_NAME_PROFILING.EVENT_ENTER_SLEEP;
            IsResumeTimeTest = true;
            _logfilePath = "EVENT_ENTER_SLEEP";
