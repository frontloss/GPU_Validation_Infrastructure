namespace Intel.VPG.Display.Automation
{
    ...
    class SB_Modes_DisplayConfiguration_Advanced : SB_Modes_DisplayConfig_Basic
    {
        Dictionary<int, System.Action> _displaySwitch = null;
        public SB_Modes_DisplayConfiguration_Advanced()
        {
        ...
        private void DisplaySwitch_3pipe()
        {
            ...
            _displayConfigSwitchOrder = new List<DisplayConfig>() { dispSwitch2, dispSwitch3, dispSwitch4, dispSwitch5,
        ...
        private void DisplaySwitch_2pipe()
        {
            ...
            _displayConfigSwitchOrder = new List<DisplayConfig>() {dispSwitch1, dispSwitch2, dispSwitch3, dispSwitch4, dispSwitch5,
