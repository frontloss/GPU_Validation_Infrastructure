...
#RGB format. This is to exercise dynamic change of WM/DBUF during resize of planes
#HSD Bugs:           :
#Test Effectiveness  :
#TAGS                : RESIZE;WM;DBUF;2PLANES;
#Platform            : SKL; KBL  
###############################################################################
...
Log.Init("MPO_3DApps_Resize", 5, True, True,  True, True)
Obj = PyTestBase()
...
DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 400)
...
PLANE1 = MPOPlane(Plane1_Rect.Right - Plane1_Rect.Left,Plane1_Rect.Bottom - Plane1_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B10G10R10A2, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 1)
PLANE2 = MPOPlane(Plane2_Rect.Right - Plane2_Rect.Left,Plane2_Rect.Bottom - Plane2_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B10G10R10A2, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 0)
    ...
    for index in range(0, 10):
        ...
        while(Plane1_ResizeIterator.Resize("RIGHT", 3) and Plane1_ResizeIterator.Resize("DOWN", 2)):
            ...
            if(Status == True):
                ...
                if PixelFormat & PixelFormatBitmap.Value != 0x02000000: #RGB
        ...
        while(Plane1_ResizeIterator.Resize("RIGHT", 3) and Plane1_ResizeIterator.Resize("DOWN", 2)):
            ...
            PLANES[0].Attributes.MPOSrcRect = Plane1_ResizeIterator.CurrentRect
            PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
            PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
