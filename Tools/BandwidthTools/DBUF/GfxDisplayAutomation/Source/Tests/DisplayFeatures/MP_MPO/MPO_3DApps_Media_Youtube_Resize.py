###############################################################################
#Test Name           : MPO_3DApps_Media_Youtube_Resize
#Test Author         : IMAHENDR
#Test Owner          : IMAHENDR
#Test Revision       : 1
#Revision History    :
#[1:IMAHENDR] - Script created
#Description         : Test to check for Underruns during resize of plane in 
#YUV422 format. This is to exercise dynamic change of WM/DBUF during resize of planes
#HSD Bugs:           :
#Test Effectiveness  :
#TAGS                : RESIZE;WM;DBUF;4PLANES;YUY2
#Platform            : BXT; APL
###############################################################################
...
Log.Init("MPO_3DApps_Media_Youtube_Resize", 5, True, True,  True, True)
Obj = PyTestBase()
...
DIVA_M_RECT_CLR.Left.SetValue(Plane1_Rect, 10)
DIVA_M_RECT_CLR.Top.SetValue(Plane1_Rect, 10)
DIVA_M_RECT_CLR.Right.SetValue(Plane1_Rect, 500)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 500)

#Plane Dimensions
Plane2_Rect = DIVA_M_RECT_CLR()
DIVA_M_RECT_CLR.Left.SetValue(Plane2_Rect, 510)
DIVA_M_RECT_CLR.Top.SetValue(Plane2_Rect, 10)
DIVA_M_RECT_CLR.Right.SetValue(Plane2_Rect, 1000)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane2_Rect, 1000)
...
DIVA_M_RECT_CLR.Left.SetValue(Plane3_Rect, 10)
DIVA_M_RECT_CLR.Top.SetValue(Plane3_Rect, 10)
DIVA_M_RECT_CLR.Right.SetValue(Plane3_Rect, viewPort.Width-10)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane3_Rect, viewPort.Height-10)

Plane4_Rect = DIVA_M_RECT_CLR()
DIVA_M_RECT_CLR.Left.SetValue(Plane4_Rect, 0)
DIVA_M_RECT_CLR.Top.SetValue(Plane4_Rect, 0)
DIVA_M_RECT_CLR.Right.SetValue(Plane4_Rect, viewPort.Width)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane4_Rect, viewPort.Height)

#Planes Initialization
PLANE1 = MPOPlane(Plane1_Rect.Right - Plane1_Rect.Left,Plane1_Rect.Bottom - Plane1_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_YUV422, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 3)
PLANE2 = MPOPlane(Plane2_Rect.Right - Plane2_Rect.Left,Plane2_Rect.Bottom - Plane2_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_YUV422, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 2)
PLANE3 = MPOPlane(Plane3_Rect.Right - Plane3_Rect.Left,Plane3_Rect.Bottom - Plane3_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B8G8R8A8, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 1)
PLANE4 = MPOPlane(Plane4_Rect.Right - Plane4_Rect.Left,Plane4_Rect.Bottom - Plane4_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B8G8R8A8, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 0)
...
Plane2_ResizeIterator = GenericRectResizeIterator(Plane2_Rect, viewPort)

try:
    while(Plane1_ResizeIterator.Resize("RIGHT", 3) and Plane1_ResizeIterator.Resize("DOWN", 2)):
    ...
    while(Plane2_ResizeIterator.Resize("RIGHT", 3) and Plane2_ResizeIterator.Resize("DOWN", 2)):

        PLANES[1].Attributes.MPODstRect = Plane2_ResizeIterator.CurrentRect
        PLANES[1].Attributes.MPOClipRect = Plane2_ResizeIterator.CurrentRect
