...
Log.Init("MPO_3DApps_SnapMode", 5, True, True,  True, True)
Obj = PyTestBase()
...
PLANE1 = MPOPlane(Plane1_Rect.Right - Plane1_Rect.Left,Plane1_Rect.Bottom - Plane1_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B10G10R10A2, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 2)
