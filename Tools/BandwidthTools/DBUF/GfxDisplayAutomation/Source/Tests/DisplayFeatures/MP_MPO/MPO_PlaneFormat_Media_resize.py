###############################################################################
#Test Name           : MPO_PlaneFormat_Media_Resize
...
#HSD Bugs:           :
#Test Effectiveness  :
#TAGS                : RESIZE;WM;DBUF;2PLANES;YUY2
#Platform            : SKL; KBL 
###############################################################################
...
Log.Init("MPO_PlaneFormat_Media_Resize", 5, True, True,  True, True)
Obj = PyTestBase()
...
DIVA_M_RECT_CLR.Right.SetValue(Plane1_Rect, 1930)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 1090)
...
DIVA_M_RECT_CLR.Left.SetValue(Plane2_Rect, 0)
...
PLANE1 = MPOPlane(Plane1_Rect.Right - Plane1_Rect.Left,Plane1_Rect.Bottom - Plane1_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_YUV422, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 1)
PLANE2 = MPOPlane(Plane2_Rect.Right - Plane2_Rect.Left,Plane2_Rect.Bottom - Plane2_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B8G8R8A8, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 0)
...
try:
    ...
    while(Plane1_ResizeIterator.Resize("LEFT", 3) and Plane1_ResizeIterator.Resize("UP", 2)):
    ...
    PLANE1.Attributes.MPODstRect.Right = viewPort.Width - 10

    while(Plane1_ResizeIterator.Resize("DOWN", 2)):
    ...
    while(Plane1_ResizeIterator.Resize("UP", 2)):
    ...
    PLANE1.Attributes.MPOSrcRect = Plane1_Rect
    PLANE1.Attributes.MPODstRect = Plane1_Rect
    PLANE1.Attributes.MPOClipRect = Plane1_Rect

    #while((PLANE1.GetSourceWidth()/PLANE1.GetDestinationWidth()) < 3 or (PLANE1.GetSourceHeight()/PLANE1.GetDestinationHeight()) < 3): #TODO get Shrink factor for YUY2
    #    Plane1_ResizeIterator.Resize("DIAGONALLY_DOWN", 2)
    #    PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
    #    PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
    ...
    #PLANE1.Attributes.MPOSrcRect = Plane1_ResizeIterator.CurrentRect
    ##TODO Toggle Format to RGB
    #while((PLANE1.GetSourceWidth()/PLANE1.GetDestinationWidth()) < 3 or (PLANE1.GetSourceHeight()/PLANE1.GetDestinationHeight()) < 3): #TODO get Shrink factor for YUY2
    #    Plane1_ResizeIterator.Resize("DIAGONALLY_UP", 2)
    #    PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
    #    PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
    ...
    #PLANE1.Attributes.MPOSrcRect = Plane1_ResizeIterator.CurrentRect
    ##TODO Toggle Format to YUV422 back
    #while((PLANE1.GetSourceWidth()/PLANE1.GetDestinationWidth()) < 3 or (PLANE1.GetSourceHeight()/PLANE1.GetDestinationHeight()) < 3): #TODO get Shrink factor for YUY2
    #    Plane1_ResizeIterator.Resize("DIAGONALLY_DOWN", 2)
    #    PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
    #    PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
    ...
    #        #Verification      
    #        PixelFormat = divaHandler.ReadRegister(PixelFormatOffset.Value)
    #        if PixelFormat & PixelFormatBitmap.Value != 0x00000000: #RGB
    #            Log.Fail("Register Verification failed, PixelFormat:{0}", PixelFormat)
    #            Obj.FailCount += 1
    #        TileFormat = divaHandler.ReadRegister(TiledSurfaceOffset.Value)
    #        if TileFormat & TiledSurfaceBitmap.Value != 0x00001000: #Y-Tile
