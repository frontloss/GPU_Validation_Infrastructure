###############################################################################
#Test Name           : MPO_PlaneFormat_UpDownScaling
...
#Description         : Test to check for scaling on planes with planar and 
#non-planar formats.
#HSD Bugs:           :
#Test Effectiveness  :
#TAGS                : SCALING;
...
Log.Init("MPO_PlaneFormat_UpDownScaling", 5, True, True,  True, True)
Obj = PyTestBase()
...
DIVA_M_RECT_CLR.Right.SetValue(Plane1_Rect, 1920)
DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 1080)
...
try:
    ...
    while(Plane1_ResizeIterator.Resize("RIGHT", 1) or Plane1_ResizeIterator.Resize("DOWN", 1)):
    ...
    while(Plane1_ResizeIterator.Resize("LEFT", 3) or Plane1_ResizeIterator.Resize("UP", 2)):
    ...
    DIVA_M_RECT_CLR.Left.SetValue(Plane1_Rect, 0)
    DIVA_M_RECT_CLR.Top.SetValue(Plane1_Rect, 0)
    DIVA_M_RECT_CLR.Right.SetValue(Plane1_Rect, 3840)
    DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 2160)
    ...
    DIVA_M_RECT_CLR.Left.SetValue(Plane1_Rect, 0)
    DIVA_M_RECT_CLR.Top.SetValue(Plane1_Rect, 0)
    DIVA_M_RECT_CLR.Right.SetValue(Plane1_Rect, 1280)
    DIVA_M_RECT_CLR.Bottom.SetValue(Plane1_Rect, 720)
