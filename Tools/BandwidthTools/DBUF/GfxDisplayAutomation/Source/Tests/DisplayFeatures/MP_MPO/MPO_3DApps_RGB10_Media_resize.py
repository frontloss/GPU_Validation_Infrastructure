###############################################################################
#Test Name           : MPO_3DApps_Media_Resize
...
#HSD Bugs:           :
#Test Effectiveness  :
#TAGS                : RESIZE;WM;DBUF;3PLANES;YUY2
#Platform            : SKL; KBL 
###############################################################################
...
Log.Init("MPO_3DApps_Media_Resize", 5, True, True,  True, True)
Obj = PyTestBase()
...
DIVA_M_RECT_CLR.Left.SetValue(Plane2_Rect, 400)
DIVA_M_RECT_CLR.Top.SetValue(Plane2_Rect, 10)
DIVA_M_RECT_CLR.Right.SetValue(Plane2_Rect, 2320)
...
DIVA_M_RECT_CLR.Top.SetValue(Plane3_Rect, 0)
...
PLANE2 = MPOPlane(Plane2_Rect.Right - Plane2_Rect.Left,Plane2_Rect.Bottom - Plane2_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B10G10R10A2, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 1)
...
try:
    ...
    while(Plane1_ResizeIterator.Resize("DIAGONALLY_UP", 3)):
    ...
    while(Plane1_ResizeIterator.Resize("RIGHT", 3)):
        ...
        while(Plane1_ResizeIterator.Resize("DOWN", 2)):
            ...
            while(Plane1_ResizeIterator.Resize("LEFT", 2)):
                PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
                PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
                ...
                while(Plane1_ResizeIterator.Resize("UP", 1)):
                    PLANES[0].Attributes.MPODstRect = Plane1_ResizeIterator.CurrentRect
                    PLANES[0].Attributes.MPOClipRect = Plane1_ResizeIterator.CurrentRect
    ...
    #TODO toggle PLANE1 & PLANE2 and change the below iteration likewise
    Plane1_ResizeIterator = GenericRectResizeIterator(Plane1_Rect, viewPort)
    Plane2_ResizeIterator = GenericRectResizeIterator(Plane2_Rect, viewPort)

    while(Plane2_ResizeIterator.Resize("DIAGONALLY_UP", 3)):
