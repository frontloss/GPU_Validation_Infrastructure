...
PLANE1 = MPOPlane(Plane1_Rect.Right - Plane1_Rect.Left,Plane1_Rect.Bottom - Plane1_Rect.Top, DIVA_PIXELFORMAT_CLR.DIVA_PIXEL_FORMAT_B8G8R8A8, DIVA_SURFACE_TILEFORMAT_CLR.DIVA_SURFACE_TILEFORMAT_Y, 1)
    ...
    for index in range(0, 10):
        ...
        while(Plane1_ResizeIterator.Resize("RIGHT", 3) and Plane1_ResizeIterator.Resize("DOWN", 2)):
            ...
            if(Status == True):
                ...
                if PixelFormat & PixelFormatBitmap.Value != 0x04000000: #RGB
