...
typedef enum _D3DKMDT_VIDEO_SIGNAL_STANDARD
{
    ...
    // Legacy STV standards                 W  x H{i|p} @ (  VR        /      HR        /        CR         )
    D3DKMDT_VSS_NTSC_M        =  6,    //  720 x 525i   @ (59.94  [Hz] /  15,734.27[Hz] /   3,579,545   [Hz])
    D3DKMDT_VSS_NTSC_J        =  7,    //  720 x 525i   @ (59.94  [Hz] /  15,734.27[Hz] /   3,579,545   [Hz])
    D3DKMDT_VSS_NTSC_443      =  8,    //  720 x 525i   @ (59.94  [Hz] /  15,734.27[Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_B         =  9,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_B1        = 10,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_G         = 11,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_H         = 12,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_I         = 13,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_D         = 14,    //  720 x 525i   @ (59.94  [Hz] /  15,734   [Hz] /   3,575,611.49[Hz])
    D3DKMDT_VSS_PAL_N         = 15,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   4,433,618.75[Hz])
    D3DKMDT_VSS_PAL_NC        = 16,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /   3,582,056.25[Hz])
    D3DKMDT_VSS_SECAM_B       = 17,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_D       = 18,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_G       = 19,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_H       = 20,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_K       = 21,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_K1      = 22,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_L       = 23,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
    D3DKMDT_VSS_SECAM_L1      = 24,    //  720 x 625i   @ (50     [Hz] /  15,625   [Hz] /       <TBD>   [Hz])
...
{
    D3DKMDT_VOT_UNINITIALIZED  =   0,
    D3DKMDT_VOT_HD15           =   1,
    D3DKMDT_VOT_DVI            =   2,
    D3DKMDT_VOT_HDMI           =   3,
    D3DKMDT_VOT_HDMI2          =   4,
    D3DKMDT_VOT_SVIDEO_4PIN    =   5,
    D3DKMDT_VOT_SVIDEO_7PIN    =   6,
    D3DKMDT_VOT_RCA_COMPOSITE  =   7,
    D3DKMDT_VOT_RCA_3COMPONENT =   8,
    D3DKMDT_VOT_BNC            =   9,
    D3DKMDT_VOT_RF             =  10,
    D3DKMDT_VOT_SDTVDONGLE     =  11,
    D3DKMDT_VOT_INTERNAL       =  12,
    D3DKMDT_VOT_OTHER          = 255
}
...
typedef struct _D3DKMDT_FREQUENCY_RANGE
{
    ...
    // Minimum horizontal refresh frequency (in KHz) supported by the monitor.
    D3DDDI_RATIONAL  MinHSyncFreq;

    // Maximum horizontal refresh frequency (in KHz) supported by the monitor.
...
typedef struct _D3DKMDT_GAMMA_RAMP
{
    ...
    // If (Type == D3DDDIGRT_DEFAULT), (DataSize == 0) and (Data.pFormatOther == NULL )
    union
    {
        D3DDDI_GAMMA_RAMP_RGB256x3x16* pRgb256x3x16;  // Type == D3DKMDT_GRT_RGB256x3x16.
        VOID*                          pRaw;
    }
    Data;
}
...
typedef enum _DXGKMDT_OPM_CONNECTOR_TYPE
{
    ...
    DXGKMDT_OPM_CONNECTOR_TYPE_UNKNOWN                      = -1, // TODO - Remove
    DXGKMDT_OPM_CONNECTOR_TYPE_VGA                          = 0,
...
typedef enum _DXGKMDT_OPM_BUS_TYPE_AND_IMPLEMENTATION
{
    ...
    DXGKMDT_OPM_BUS_TYPE_UNKNOWN                                                     = 0x00000000, // TODO - Remove
...
typedef enum _DXGKMDT_OPM_CGMSA
{
    ...
    DXGKMDT_OPM_CGMSA_REDISTRIBUTION_CONTROL_REQUIRED   = 0x08
} DXGKMDT_OPM_CGMSA;
...
typedef enum _DXGKMDT_OPM_PROTECTION_TYPE
{
    ...
    DXGKMDT_OPM_PROTECTION_TYPE_UNKNOWN                     = 0x80000000, // TODO - Remove
...
typedef struct _DXGKMDT_OPM_ACTUAL_OUTPUT_FORMAT
{
    ...
    ULONG dsfSampleInterleaveFormat;
    ULONG d3dFormat;
