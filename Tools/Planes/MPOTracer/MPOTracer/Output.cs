...
namespace PlaneStatus
{
    public class RegisterOutput
    {
        ...
        const uint HFLIPMASK = 0x00000100;
        ...
        public void RegOutput(MPOTracer.MPOOptions Options, StreamWriter outFile)
        {
                ...
                for (plIndex = 0; plIndex < RegisterOffset[piIndex].Length; plIndex++)
                {
                    ...
                    if (RegisterInterface.Instance.ReadWriteRegister(RegisterInterface.RegisterOperation.READ, RegisterOffset[piIndex][plIndex], out RegValue, Options.IsDDRW))
                    {
                        if (IsPlaneEnabled(RegValue))
                        {
                            ...
                            //if (IsPlanarFormat(Options.Platform, RegValue))

                            if (Options.Platform >= MPOOptions.Platforms.SKYLAKE)
                            {
                            ...
                            if (Options.Platform >= MPOOptions.Platforms.CANONLAKE)
                            {
                                Console.Write("HFlip > " + IsHFlipEnabled(RegValue) + "; ");
                                outFile.Write("HFlip > " + IsHFlipEnabled(RegValue) + "; ");
                            }
        ...
        private static string IsHFlipEnabled(uint RegValue)
        {
            if ((RegValue & HFLIPMASK) > 0)
                return "Enabled";
            return "Disabled";
        }
        ...
        private static string GetColorFormat(MPOOptions.Platforms PlatformID, uint RegValue)
        {
            String ColorFormat = "";
            #region SKYLAKE
            if (PlatformID == MPOOptions.Platforms.SKYLAKE || PlatformID == MPOOptions.Platforms.KABYLAKE || PlatformID == MPOOptions.Platforms.COFFEELAKE || PlatformID == MPOOptions.Platforms.BROXTON || PlatformID == MPOOptions.Platforms.GEMINILAKE || PlatformID == MPOOptions.Platforms.CANONLAKE || PlatformID == MPOOptions.Platforms.WHISKEYLAKE || PlatformID == MPOOptions.Platforms.AMBERLAKE || PlatformID == MPOOptions.Platforms.COMETLAKE)
            {
            ...
            #region CHERRYVIEW
            if (PlatformID == MPOOptions.Platforms.CHERRYVIEW)
            {
        ...
        private static uint[][] GetOffSetforPlatform(MPOOptions.Platforms platform)
        {
            uint[][] offset = null;
            switch (platform)
            {   
                case MPOOptions.Platforms.SKYLAKE:
                case MPOOptions.Platforms.KABYLAKE:
                case MPOOptions.Platforms.COFFEELAKE:
                case MPOOptions.Platforms.WHISKEYLAKE:
                case MPOOptions.Platforms.AMBERLAKE:
                case MPOOptions.Platforms.COMETLAKE:
                    offset = new uint[3][] { new uint[] { 0x70180, 0x70280, 0x70380 }, 
                                             new uint[] { 0x71180, 0x71280, 0x71380 }, 
                                             new uint[] { 0x72180, 0x72280, 0x72380 } };
                    break;
                case MPOOptions.Platforms.BROXTON:
                    offset = new uint[3][] { new uint[] { 0x70180, 0x70280, 0x70380, 0x70480 }, 
                                             new uint[] { 0x71180, 0x71280, 0x71380, 0x71480 }, 
                                             new uint[] { 0x72180, 0x72280, 0x72380 } };
                    break;
                case MPOOptions.Platforms.GEMINILAKE:
                case MPOOptions.Platforms.CANONLAKE:
                    offset = new uint[3][] { new uint[] { 0x70180, 0x70280, 0x70380, 0x70480 }, 
                                             new uint[] { 0x71180, 0x71280, 0x71380, 0x71480 }, 
                                             new uint[] { 0x72180, 0x72280, 0x72380, 0x72480 } };
                    break;
                case MPOOptions.Platforms.CHERRYVIEW:
                    ...
                    break;
                case MPOOptions.Platforms.ICELAKE:
                case MPOOptions.Platforms.ICELAKELP:
                    ...
                    break;
                case MPOOptions.Platforms.ICELAKEHP:
        ...
        private static String[][] GetOffSetNameforPlatform(MPOOptions.Platforms platform)
        {
