...
namespace PlaneStatus
{
    public class RegisterInterface
    {
       ...
       [StructLayout(LayoutKind.Sequential)]
        ...
        internal static bool PerformDriverEscape(Object escDataStruct, Object escapeData, bool IsDDRW = false)
        {
        ...
        internal bool ReadWriteRegister(RegisterOperation regOperation, uint offset, out uint value, bool IsDDRW = false)
        {
            ...
            if (PerformDriverEscape(Tool_Esc_mmioArgs, Tool_Esc_EscapeData, IsDDRW))
            {
